...
var file_streamd_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x50, 0x0a, 0x18, 0x52, 0x65, 0x6d, 0x6f, 0x76,
	...
	0x65, 0x6e, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x10, 0x01, 0x32, 0xc8, 0x35, 0x0a, 0x07,
	...
	0x0a, 0x11, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x12, 0x21, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x64, 0x2e, 0x52, 0x65,
	...
	0x2e, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x07, 0x42, 0x61, 0x6e,
	0x55, 0x73, 0x65, 0x72, 0x12, 0x17, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x64, 0x2e, 0x42,
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x11, 0x5a, 0x0f, 0x67, 0x6f, 0x2f, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x64, 0x5f, 0x67, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_streamd_proto_msgTypes = make([]protoimpl.MessageInfo, 181)
var file_streamd_proto_goTypes = []interface{}{
	...
	(*RemoveChatMessageRequest)(nil),                    // 182: streamd.RemoveChatMessageRequest
	(*RemoveChatMessageReply)(nil),                      // 183: streamd.RemoveChatMessageReply
	(*BanUserRequest)(nil),                              // 184: streamd.BanUserRequest
	(*BanUserReply)(nil),                                // 185: streamd.BanUserReply
	(*player_grpc.OpenRequest)(nil),                     // 186: player.OpenRequest
	(*player_grpc.OpenReply)(nil),                       // 187: player.OpenReply
	(*player_grpc.ProcessTitleRequest)(nil),             // 188: player.ProcessTitleRequest
	(*player_grpc.ProcessTitleReply)(nil),               // 189: player.ProcessTitleReply
	(*player_grpc.GetLinkRequest)(nil),                  // 190: player.GetLinkRequest
	(*player_grpc.GetLinkReply)(nil),                    // 191: player.GetLinkReply
	(*player_grpc.EndChanRequest)(nil),                  // 192: player.EndChanRequest
	(*player_grpc.EndChanReply)(nil),                    // 193: player.EndChanReply
	(*player_grpc.IsEndedRequest)(nil),                  // 194: player.IsEndedRequest
	(*player_grpc.IsEndedReply)(nil),                    // 195: player.IsEndedReply
	(*player_grpc.GetPositionRequest)(nil),              // 196: player.GetPositionRequest
	(*player_grpc.GetPositionReply)(nil),                // 197: player.GetPositionReply
	(*player_grpc.GetLengthRequest)(nil),                // 198: player.GetLengthRequest
	(*player_grpc.GetLengthReply)(nil),                  // 199: player.GetLengthReply
	(*player_grpc.SetSpeedRequest)(nil),                 // 200: player.SetSpeedRequest
	(*player_grpc.SetSpeedReply)(nil),                   // 201: player.SetSpeedReply
	(*player_grpc.SetPauseRequest)(nil),                 // 202: player.SetPauseRequest
	(*player_grpc.SetPauseReply)(nil),                   // 203: player.SetPauseReply
	(*player_grpc.StopRequest)(nil),                     // 204: player.StopRequest
	(*player_grpc.StopReply)(nil),                       // 205: player.StopReply
	(*player_grpc.CloseRequest)(nil),                    // 206: player.CloseRequest
	(*player_grpc.CloseReply)(nil),                      // 207: player.CloseReply
}
var file_streamd_proto_depIdxs = []int32{
	...
	186, // 30: streamd.StreamPlayerOpenRequest.request:type_name -> player.OpenRequest
	187, // 31: streamd.StreamPlayerOpenReply.reply:type_name -> player.OpenReply
	188, // 32: streamd.StreamPlayerProcessTitleRequest.request:type_name -> player.ProcessTitleRequest
	189, // 33: streamd.StreamPlayerProcessTitleReply.reply:type_name -> player.ProcessTitleReply
	190, // 34: streamd.StreamPlayerGetLinkRequest.request:type_name -> player.GetLinkRequest
	191, // 35: streamd.StreamPlayerGetLinkReply.reply:type_name -> player.GetLinkReply
	192, // 36: streamd.StreamPlayerEndChanRequest.request:type_name -> player.EndChanRequest
	193, // 37: streamd.StreamPlayerEndChanReply.reply:type_name -> player.EndChanReply
	194, // 38: streamd.StreamPlayerIsEndedRequest.request:type_name -> player.IsEndedRequest
	195, // 39: streamd.StreamPlayerIsEndedReply.reply:type_name -> player.IsEndedReply
	196, // 40: streamd.StreamPlayerGetPositionRequest.request:type_name -> player.GetPositionRequest
	197, // 41: streamd.StreamPlayerGetPositionReply.reply:type_name -> player.GetPositionReply
	198, // 42: streamd.StreamPlayerGetLengthRequest.request:type_name -> player.GetLengthRequest
	199, // 43: streamd.StreamPlayerGetLengthReply.reply:type_name -> player.GetLengthReply
	200, // 44: streamd.StreamPlayerSetSpeedRequest.request:type_name -> player.SetSpeedRequest
	201, // 45: streamd.StreamPlayerSetSpeedReply.reply:type_name -> player.SetSpeedReply
	202, // 46: streamd.StreamPlayerSetPauseRequest.request:type_name -> player.SetPauseRequest
	203, // 47: streamd.StreamPlayerSetPauseReply.reply:type_name -> player.SetPauseReply
	204, // 48: streamd.StreamPlayerStopRequest.request:type_name -> player.StopRequest
	205, // 49: streamd.StreamPlayerStopReply.reply:type_name -> player.StopReply
	206, // 50: streamd.StreamPlayerCloseRequest.request:type_name -> player.CloseRequest
	207, // 51: streamd.StreamPlayerCloseReply.reply:type_name -> player.CloseReply
	...
	182, // 151: streamd.StreamD.RemoveChatMessage:input_type -> streamd.RemoveChatMessageRequest
	184, // 152: streamd.StreamD.BanUser:input_type -> streamd.BanUserRequest
	6,   // 153: streamd.StreamD.Ping:output_type -> streamd.PingReply
	8,   // 154: streamd.StreamD.SetLoggingLevel:output_type -> streamd.SetLoggingLevelReply
	10,  // 155: streamd.StreamD.GetLoggingLevel:output_type -> streamd.GetLoggingLevelReply
	12,  // 156: streamd.StreamD.GetConfig:output_type -> streamd.GetConfigReply
	14,  // 157: streamd.StreamD.SetConfig:output_type -> streamd.SetConfigReply
	16,  // 158: streamd.StreamD.SaveConfig:output_type -> streamd.SaveConfigReply
	137, // 159: streamd.StreamD.SubscribeToConfigChanges:output_type -> streamd.ConfigChange
	18,  // 160: streamd.StreamD.ResetCache:output_type -> streamd.ResetCacheReply
	20,  // 161: streamd.StreamD.InitCache:output_type -> streamd.InitCacheReply
	22,  // 162: streamd.StreamD.StartStream:output_type -> streamd.StartStreamReply
	24,  // 163: streamd.StreamD.EndStream:output_type -> streamd.EndStreamReply
	26,  // 164: streamd.StreamD.GetStreamStatus:output_type -> streamd.GetStreamStatusReply
	30,  // 165: streamd.StreamD.IsBackendEnabled:output_type -> streamd.IsBackendEnabledReply
	28,  // 166: streamd.StreamD.GetBackendInfo:output_type -> streamd.GetBackendInfoReply
	139, // 167: streamd.StreamD.SubscribeToStreamsChanges:output_type -> streamd.StreamsChange
	32,  // 168: streamd.StreamD.Restart:output_type -> streamd.RestartReply
	34,  // 169: streamd.StreamD.SetTitle:output_type -> streamd.SetTitleReply
	36,  // 170: streamd.StreamD.SetDescription:output_type -> streamd.SetDescriptionReply
	38,  // 171: streamd.StreamD.ApplyProfile:output_type -> streamd.ApplyProfileReply
	40,  // 172: streamd.StreamD.UpdateStream:output_type -> streamd.UpdateStreamReply
	52,  // 173: streamd.StreamD.GetVariable:output_type -> streamd.GetVariableReply
	54,  // 174: streamd.StreamD.GetVariableHash:output_type -> streamd.GetVariableHashReply
	56,  // 175: streamd.StreamD.SetVariable:output_type -> streamd.SetVariableReply
	42,  // 176: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:output_type -> streamd.EXPERIMENTAL_ReinitStreamControllersReply
	44,  // 177: streamd.StreamD.OBSOLETE_FetchConfig:output_type -> streamd.OBSOLETE_FetchConfigReply
	46,  // 178: streamd.StreamD.OBSOLETE_GitInfo:output_type -> streamd.OBSOLETE_GetGitInfoReply
	48,  // 179: streamd.StreamD.OBSOLETE_GitRelogin:output_type -> streamd.OBSOLETE_GitReloginReply
	50,  // 180: streamd.StreamD.SubscribeToOAuthRequests:output_type -> streamd.OAuthRequest
	58,  // 181: streamd.StreamD.SubmitOAuthCode:output_type -> streamd.SubmitOAuthCodeReply
	65,  // 182: streamd.StreamD.ListStreamServers:output_type -> streamd.ListStreamServersReply
	67,  // 183: streamd.StreamD.StartStreamServer:output_type -> streamd.StartStreamServerReply
	69,  // 184: streamd.StreamD.StopStreamServer:output_type -> streamd.StopStreamServerReply
	141, // 185: streamd.StreamD.SubscribeToStreamServersChanges:output_type -> streamd.StreamServersChange
	72,  // 186: streamd.StreamD.ListStreamDestinations:output_type -> streamd.ListStreamDestinationsReply
	74,  // 187: streamd.StreamD.AddStreamDestination:output_type -> streamd.AddStreamDestinationReply
	76,  // 188: streamd.StreamD.UpdateStreamDestination:output_type -> streamd.UpdateStreamDestinationReply
	78,  // 189: streamd.StreamD.RemoveStreamDestination:output_type -> streamd.RemoveStreamDestinationReply
	143, // 190: streamd.StreamD.SubscribeToStreamDestinationsChanges:output_type -> streamd.StreamDestinationsChange
	81,  // 191: streamd.StreamD.AddIncomingStream:output_type -> streamd.AddIncomingStreamReply
	83,  // 192: streamd.StreamD.RemoveIncomingStream:output_type -> streamd.RemoveIncomingStreamReply
	85,  // 193: streamd.StreamD.ListIncomingStreams:output_type -> streamd.ListIncomingStreamsReply
	145, // 194: streamd.StreamD.SubscribeToIncomingStreamsChanges:output_type -> streamd.IncomingStreamsChange
	93,  // 195: streamd.StreamD.ListStreamForwards:output_type -> streamd.ListStreamForwardsReply
	95,  // 196: streamd.StreamD.AddStreamForward:output_type -> streamd.AddStreamForwardReply
	97,  // 197: streamd.StreamD.UpdateStreamForward:output_type -> streamd.UpdateStreamForwardReply
	99,  // 198: streamd.StreamD.RemoveStreamForward:output_type -> streamd.RemoveStreamForwardReply
	147, // 199: streamd.StreamD.SubscribeToStreamForwardsChanges:output_type -> streamd.StreamForwardsChange
	101, // 200: streamd.StreamD.WaitForStreamPublisher:output_type -> streamd.StreamPublisher
	105, // 201: streamd.StreamD.AddStreamPlayer:output_type -> streamd.AddStreamPlayerReply
	107, // 202: streamd.StreamD.RemoveStreamPlayer:output_type -> streamd.RemoveStreamPlayerReply
	109, // 203: streamd.StreamD.UpdateStreamPlayer:output_type -> streamd.UpdateStreamPlayerReply
	111, // 204: streamd.StreamD.ListStreamPlayers:output_type -> streamd.ListStreamPlayersReply
	113, // 205: streamd.StreamD.GetStreamPlayer:output_type -> streamd.GetStreamPlayerReply
	149, // 206: streamd.StreamD.SubscribeToStreamPlayersChanges:output_type -> streamd.StreamPlayersChange
	115, // 207: streamd.StreamD.StreamPlayerOpen:output_type -> streamd.StreamPlayerOpenReply
	117, // 208: streamd.StreamD.StreamPlayerProcessTitle:output_type -> streamd.StreamPlayerProcessTitleReply
	119, // 209: streamd.StreamD.StreamPlayerGetLink:output_type -> streamd.StreamPlayerGetLinkReply
	121, // 210: streamd.StreamD.StreamPlayerEndChan:output_type -> streamd.StreamPlayerEndChanReply
	123, // 211: streamd.StreamD.StreamPlayerIsEnded:output_type -> streamd.StreamPlayerIsEndedReply
	125, // 212: streamd.StreamD.StreamPlayerGetPosition:output_type -> streamd.StreamPlayerGetPositionReply
	127, // 213: streamd.StreamD.StreamPlayerGetLength:output_type -> streamd.StreamPlayerGetLengthReply
	129, // 214: streamd.StreamD.StreamPlayerSetSpeed:output_type -> streamd.StreamPlayerSetSpeedReply
	131, // 215: streamd.StreamD.StreamPlayerSetPause:output_type -> streamd.StreamPlayerSetPauseReply
	133, // 216: streamd.StreamD.StreamPlayerStop:output_type -> streamd.StreamPlayerStopReply
	135, // 217: streamd.StreamD.StreamPlayerClose:output_type -> streamd.StreamPlayerCloseReply
	156, // 218: streamd.StreamD.AddTimer:output_type -> streamd.AddTimerReply
	158, // 219: streamd.StreamD.RemoveTimer:output_type -> streamd.RemoveTimerReply
	161, // 220: streamd.StreamD.ListTimers:output_type -> streamd.ListTimersReply
	171, // 221: streamd.StreamD.ListTriggerRules:output_type -> streamd.ListTriggerRulesReply
	173, // 222: streamd.StreamD.AddTriggerRule:output_type -> streamd.AddTriggerRuleReply
	175, // 223: streamd.StreamD.RemoveTriggerRule:output_type -> streamd.RemoveTriggerRuleReply
	177, // 224: streamd.StreamD.UpdateTriggerRule:output_type -> streamd.UpdateTriggerRuleReply
	179, // 225: streamd.StreamD.SubmitEvent:output_type -> streamd.SubmitEventReply
	181, // 226: streamd.StreamD.SubscribeToChatMessages:output_type -> streamd.ChatMessage
	183, // 227: streamd.StreamD.RemoveChatMessage:output_type -> streamd.RemoveChatMessageReply
	185, // 228: streamd.StreamD.BanUser:output_type -> streamd.BanUserReply
	153, // [153:229] is the sub-list for method output_type
	77,  // [77:153] is the sub-list for method input_type
...
func file_streamd_proto_init() {
	...
	file_streamd_proto_msgTypes[179].OneofWrappers = []interface{}{}
	type x struct{}
