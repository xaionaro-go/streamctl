...
const file_streamd_proto_rawDesc = "" +
	...
	"\fviewer_count\x18\x06 \x01(\x04R\vviewerCount*f\n" +
	"\fLoggingLevel\x12\b\n" +
	"\x04none\x10\x00\x12\t\n" +
	...
	"\x15TEXT_FORMAT_TYPE_HTML\x10\x032\xc1<\n" +
	"\aStreamD\x122\n" +
...
var file_streamd_proto_msgTypes = make([]protoimpl.MessageInfo, 231)
var file_streamd_proto_goTypes = []any{
	...
	nil,                                                 // 239: streamd.YouTubeQuotaUsage.PerOperationUsageEntry
	nil,                                                 // 240: streamd.YouTubeQuotaUsage.PerOperationRequestCountEntry
	(*player_grpc.OpenRequest)(nil),                     // 241: player.OpenRequest
	(*player_grpc.OpenReply)(nil),                       // 242: player.OpenReply
	(*player_grpc.ProcessTitleRequest)(nil),             // 243: player.ProcessTitleRequest
	(*player_grpc.ProcessTitleReply)(nil),               // 244: player.ProcessTitleReply
	(*player_grpc.GetLinkRequest)(nil),                  // 245: player.GetLinkRequest
	(*player_grpc.GetLinkReply)(nil),                    // 246: player.GetLinkReply
	(*player_grpc.EndChanRequest)(nil),                  // 247: player.EndChanRequest
	(*player_grpc.EndChanReply)(nil),                    // 248: player.EndChanReply
	(*player_grpc.IsEndedRequest)(nil),                  // 249: player.IsEndedRequest
	(*player_grpc.IsEndedReply)(nil),                    // 250: player.IsEndedReply
	(*player_grpc.GetPositionRequest)(nil),              // 251: player.GetPositionRequest
	(*player_grpc.GetPositionReply)(nil),                // 252: player.GetPositionReply
	(*player_grpc.GetLengthRequest)(nil),                // 253: player.GetLengthRequest
	(*player_grpc.GetLengthReply)(nil),                  // 254: player.GetLengthReply
	(*player_grpc.SetSpeedRequest)(nil),                 // 255: player.SetSpeedRequest
	(*player_grpc.SetSpeedReply)(nil),                   // 256: player.SetSpeedReply
	(*player_grpc.SetPauseRequest)(nil),                 // 257: player.SetPauseRequest
	(*player_grpc.SetPauseReply)(nil),                   // 258: player.SetPauseReply
	(*player_grpc.StopRequest)(nil),                     // 259: player.StopRequest
	(*player_grpc.StopReply)(nil),                       // 260: player.StopReply
	(*player_grpc.CloseRequest)(nil),                    // 261: player.CloseRequest
	(*player_grpc.CloseReply)(nil),                      // 262: player.CloseReply
	(*chatwebhook_grpc.Event)(nil),                      // 263: chatwebhook.Event
}
var file_streamd_proto_depIdxs = []int32{
	...
	241, // 60: streamd.StreamPlayerOpenRequest.request:type_name -> player.OpenRequest
	242, // 61: streamd.StreamPlayerOpenReply.reply:type_name -> player.OpenReply
	243, // 62: streamd.StreamPlayerProcessTitleRequest.request:type_name -> player.ProcessTitleRequest
	244, // 63: streamd.StreamPlayerProcessTitleReply.reply:type_name -> player.ProcessTitleReply
	245, // 64: streamd.StreamPlayerGetLinkRequest.request:type_name -> player.GetLinkRequest
	246, // 65: streamd.StreamPlayerGetLinkReply.reply:type_name -> player.GetLinkReply
	247, // 66: streamd.StreamPlayerEndChanRequest.request:type_name -> player.EndChanRequest
	248, // 67: streamd.StreamPlayerEndChanReply.reply:type_name -> player.EndChanReply
	249, // 68: streamd.StreamPlayerIsEndedRequest.request:type_name -> player.IsEndedRequest
	250, // 69: streamd.StreamPlayerIsEndedReply.reply:type_name -> player.IsEndedReply
	251, // 70: streamd.StreamPlayerGetPositionRequest.request:type_name -> player.GetPositionRequest
	252, // 71: streamd.StreamPlayerGetPositionReply.reply:type_name -> player.GetPositionReply
	253, // 72: streamd.StreamPlayerGetLengthRequest.request:type_name -> player.GetLengthRequest
	254, // 73: streamd.StreamPlayerGetLengthReply.reply:type_name -> player.GetLengthReply
	255, // 74: streamd.StreamPlayerSetSpeedRequest.request:type_name -> player.SetSpeedRequest
	256, // 75: streamd.StreamPlayerSetSpeedReply.reply:type_name -> player.SetSpeedReply
	257, // 76: streamd.StreamPlayerSetPauseRequest.request:type_name -> player.SetPauseRequest
	258, // 77: streamd.StreamPlayerSetPauseReply.reply:type_name -> player.SetPauseReply
	259, // 78: streamd.StreamPlayerStopRequest.request:type_name -> player.StopRequest
	260, // 79: streamd.StreamPlayerStopReply.reply:type_name -> player.StopReply
	261, // 80: streamd.StreamPlayerCloseRequest.request:type_name -> player.CloseRequest
	262, // 81: streamd.StreamPlayerCloseReply.reply:type_name -> player.CloseReply
	...
	263, // 109: streamd.ChatMessage.content:type_name -> chatwebhook.Event
	263, // 110: streamd.InjectPlatformEventRequest.message:type_name -> chatwebhook.Event
	...
	239, // 117: streamd.YouTubeQuotaUsage.per_operation_usage:type_name -> streamd.YouTubeQuotaUsage.PerOperationUsageEntry
	240, // 118: streamd.YouTubeQuotaUsage.per_operation_request_count:type_name -> streamd.YouTubeQuotaUsage.PerOperationRequestCountEntry
	...
	226, // 205: streamd.StreamD.GetPeerIDs:input_type -> streamd.GetPeerIDsRequest
	228, // 206: streamd.StreamD.LLMGenerate:input_type -> streamd.LLMGenerateRequest
	234, // 207: streamd.StreamD.GetYouTubeInfo:input_type -> streamd.GetYouTubeInfoRequest
	11,  // 208: streamd.StreamD.Ping:output_type -> streamd.PingReply
	13,  // 209: streamd.StreamD.SetLoggingLevel:output_type -> streamd.SetLoggingLevelReply
	15,  // 210: streamd.StreamD.GetLoggingLevel:output_type -> streamd.GetLoggingLevelReply
	17,  // 211: streamd.StreamD.GetConfig:output_type -> streamd.GetConfigReply
	19,  // 212: streamd.StreamD.SetConfig:output_type -> streamd.SetConfigReply
	21,  // 213: streamd.StreamD.SaveConfig:output_type -> streamd.SaveConfigReply
	169, // 214: streamd.StreamD.SubscribeToConfigChanges:output_type -> streamd.ConfigChange
	23,  // 215: streamd.StreamD.ResetCache:output_type -> streamd.ResetCacheReply
	25,  // 216: streamd.StreamD.InitCache:output_type -> streamd.InitCacheReply
	27,  // 217: streamd.StreamD.SetStreamActive:output_type -> streamd.SetStreamActiveReply
	29,  // 218: streamd.StreamD.GetStreamStatus:output_type -> streamd.GetStreamStatusReply
	32,  // 219: streamd.StreamD.GetStreams:output_type -> streamd.GetStreamsReply
	50,  // 220: streamd.StreamD.CreateStream:output_type -> streamd.CreateStreamReply
	52,  // 221: streamd.StreamD.DeleteStream:output_type -> streamd.DeleteStreamReply
	34,  // 222: streamd.StreamD.GetAccounts:output_type -> streamd.GetAccountsReply
	42,  // 223: streamd.StreamD.IsBackendEnabled:output_type -> streamd.IsBackendEnabledReply
	40,  // 224: streamd.StreamD.GetBackendInfo:output_type -> streamd.GetBackendInfoReply
	171, // 225: streamd.StreamD.SubscribeToStreamsChanges:output_type -> streamd.StreamsChange
	44,  // 226: streamd.StreamD.Restart:output_type -> streamd.RestartReply
	46,  // 227: streamd.StreamD.SetTitle:output_type -> streamd.SetTitleReply
	48,  // 228: streamd.StreamD.SetDescription:output_type -> streamd.SetDescriptionReply
	54,  // 229: streamd.StreamD.ApplyProfile:output_type -> streamd.ApplyProfileReply
	66,  // 230: streamd.StreamD.GetVariable:output_type -> streamd.GetVariableReply
	68,  // 231: streamd.StreamD.GetVariableHash:output_type -> streamd.GetVariableHashReply
	70,  // 232: streamd.StreamD.SetVariable:output_type -> streamd.SetVariableReply
	75,  // 233: streamd.StreamD.SubscribeToVariable:output_type -> streamd.VariableChange
	36,  // 234: streamd.StreamD.GetActiveStreamIDs:output_type -> streamd.GetActiveStreamIDsReply
	38,  // 235: streamd.StreamD.GetPlatforms:output_type -> streamd.GetPlatformsReply
	56,  // 236: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:output_type -> streamd.EXPERIMENTAL_ReinitStreamControllersReply
	64,  // 237: streamd.StreamD.SubscribeToOAuthRequests:output_type -> streamd.OAuthRequest
	77,  // 238: streamd.StreamD.SubmitOAuthCode:output_type -> streamd.SubmitOAuthCodeReply
	84,  // 239: streamd.StreamD.ListStreamServers:output_type -> streamd.ListStreamServersReply
	86,  // 240: streamd.StreamD.StartStreamServer:output_type -> streamd.StartStreamServerReply
	88,  // 241: streamd.StreamD.StopStreamServer:output_type -> streamd.StopStreamServerReply
	173, // 242: streamd.StreamD.SubscribeToStreamServersChanges:output_type -> streamd.StreamServersChange
	93,  // 243: streamd.StreamD.ListStreamSinks:output_type -> streamd.ListStreamSinksReply
	95,  // 244: streamd.StreamD.AddStreamSink:output_type -> streamd.AddStreamSinkReply
	97,  // 245: streamd.StreamD.UpdateStreamSink:output_type -> streamd.UpdateStreamSinkReply
	233, // 246: streamd.StreamD.GetStreamSinkConfig:output_type -> streamd.GetStreamSinkConfigReply
	99,  // 247: streamd.StreamD.WaitStreamStarted:output_type -> streamd.WaitStreamStartedReply
	101, // 248: streamd.StreamD.RemoveStreamSink:output_type -> streamd.RemoveStreamSinkReply
	175, // 249: streamd.StreamD.SubscribeToStreamSinksChanges:output_type -> streamd.StreamSinksChange
	104, // 250: streamd.StreamD.AddStreamSource:output_type -> streamd.AddStreamSourceReply
	106, // 251: streamd.StreamD.RemoveStreamSource:output_type -> streamd.RemoveStreamSourceReply
	108, // 252: streamd.StreamD.ListStreamSources:output_type -> streamd.ListStreamSourcesReply
	177, // 253: streamd.StreamD.SubscribeToStreamSourcesChanges:output_type -> streamd.StreamSourcesChange
	123, // 254: streamd.StreamD.ListStreamForwards:output_type -> streamd.ListStreamForwardsReply
	125, // 255: streamd.StreamD.AddStreamForward:output_type -> streamd.AddStreamForwardReply
	127, // 256: streamd.StreamD.UpdateStreamForward:output_type -> streamd.UpdateStreamForwardReply
	129, // 257: streamd.StreamD.RemoveStreamForward:output_type -> streamd.RemoveStreamForwardReply
	179, // 258: streamd.StreamD.SubscribeToStreamForwardsChanges:output_type -> streamd.StreamForwardsChange
	131, // 259: streamd.StreamD.WaitForStreamPublisher:output_type -> streamd.StreamPublisher
	135, // 260: streamd.StreamD.AddStreamPlayer:output_type -> streamd.AddStreamPlayerReply
	137, // 261: streamd.StreamD.RemoveStreamPlayer:output_type -> streamd.RemoveStreamPlayerReply
	139, // 262: streamd.StreamD.UpdateStreamPlayer:output_type -> streamd.UpdateStreamPlayerReply
	141, // 263: streamd.StreamD.ListStreamPlayers:output_type -> streamd.ListStreamPlayersReply
	143, // 264: streamd.StreamD.GetStreamPlayer:output_type -> streamd.GetStreamPlayerReply
	181, // 265: streamd.StreamD.SubscribeToStreamPlayersChanges:output_type -> streamd.StreamPlayersChange
	145, // 266: streamd.StreamD.StreamPlayerOpen:output_type -> streamd.StreamPlayerOpenReply
	147, // 267: streamd.StreamD.StreamPlayerProcessTitle:output_type -> streamd.StreamPlayerProcessTitleReply
	149, // 268: streamd.StreamD.StreamPlayerGetLink:output_type -> streamd.StreamPlayerGetLinkReply
	151, // 269: streamd.StreamD.StreamPlayerEndChan:output_type -> streamd.StreamPlayerEndChanReply
	153, // 270: streamd.StreamD.StreamPlayerIsEnded:output_type -> streamd.StreamPlayerIsEndedReply
	155, // 271: streamd.StreamD.StreamPlayerGetPosition:output_type -> streamd.StreamPlayerGetPositionReply
	157, // 272: streamd.StreamD.StreamPlayerGetLength:output_type -> streamd.StreamPlayerGetLengthReply
	159, // 273: streamd.StreamD.StreamPlayerGetLag:output_type -> streamd.StreamPlayerGetLagReply
	161, // 274: streamd.StreamD.StreamPlayerSetSpeed:output_type -> streamd.StreamPlayerSetSpeedReply
	163, // 275: streamd.StreamD.StreamPlayerSetPause:output_type -> streamd.StreamPlayerSetPauseReply
	165, // 276: streamd.StreamD.StreamPlayerStop:output_type -> streamd.StreamPlayerStopReply
	167, // 277: streamd.StreamD.StreamPlayerClose:output_type -> streamd.StreamPlayerCloseReply
	188, // 278: streamd.StreamD.AddTimer:output_type -> streamd.AddTimerReply
	190, // 279: streamd.StreamD.RemoveTimer:output_type -> streamd.RemoveTimerReply
	193, // 280: streamd.StreamD.ListTimers:output_type -> streamd.ListTimersReply
	203, // 281: streamd.StreamD.ListTriggerRules:output_type -> streamd.ListTriggerRulesReply
	205, // 282: streamd.StreamD.AddTriggerRule:output_type -> streamd.AddTriggerRuleReply
	207, // 283: streamd.StreamD.RemoveTriggerRule:output_type -> streamd.RemoveTriggerRuleReply
	209, // 284: streamd.StreamD.UpdateTriggerRule:output_type -> streamd.UpdateTriggerRuleReply
	72,  // 285: streamd.StreamD.ListProfiles:output_type -> streamd.ListProfilesReply
	211, // 286: streamd.StreamD.SubmitEvent:output_type -> streamd.SubmitEventReply
	213, // 287: streamd.StreamD.SubscribeToChatMessages:output_type -> streamd.ChatMessage
	215, // 288: streamd.StreamD.SendChatMessage:output_type -> streamd.SendChatMessageReply
	221, // 289: streamd.StreamD.InjectPlatformEvent:output_type -> streamd.InjectPlatformEventReply
	217, // 290: streamd.StreamD.RemoveChatMessage:output_type -> streamd.RemoveChatMessageReply
	219, // 291: streamd.StreamD.BanUser:output_type -> streamd.BanUserReply
	223, // 292: streamd.StreamD.Shoutout:output_type -> streamd.ShoutoutReply
	225, // 293: streamd.StreamD.RaidTo:output_type -> streamd.RaidToReply
	227, // 294: streamd.StreamD.GetPeerIDs:output_type -> streamd.GetPeerIDsReply
	229, // 295: streamd.StreamD.LLMGenerate:output_type -> streamd.LLMGenerateReply
	235, // 296: streamd.StreamD.GetYouTubeInfo:output_type -> streamd.GetYouTubeInfoReply
