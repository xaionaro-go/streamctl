...
var file_streamd_proto_rawDesc = []byte{
	...
	,
...
var file_streamd_proto_msgTypes = make([]protoimpl.MessageInfo, 150)
var file_streamd_proto_goTypes = []interface{}{
	...
	(*StreamServer)(nil),                                // 58: streamd.StreamServer
	(*StreamServerStatistics)(nil),                      // 59: streamd.StreamServerStatistics
	(*StreamServerWithStatistics)(nil),                  // 60: streamd.StreamServerWithStatistics
	(*ListStreamServersRequest)(nil),                    // 61: streamd.ListStreamServersRequest
	(*ListStreamServersReply)(nil),                      // 62: streamd.ListStreamServersReply
	(*StartStreamServerRequest)(nil),                    // 63: streamd.StartStreamServerRequest
	(*StartStreamServerReply)(nil),                      // 64: streamd.StartStreamServerReply
	(*StopStreamServerRequest)(nil),                     // 65: streamd.StopStreamServerRequest
	(*StopStreamServerReply)(nil),                       // 66: streamd.StopStreamServerReply
	(*StreamDestination)(nil),                           // 67: streamd.StreamDestination
	(*ListStreamDestinationsRequest)(nil),               // 68: streamd.ListStreamDestinationsRequest
	(*ListStreamDestinationsReply)(nil),                 // 69: streamd.ListStreamDestinationsReply
	(*AddStreamDestinationRequest)(nil),                 // 70: streamd.AddStreamDestinationRequest
	(*AddStreamDestinationReply)(nil),                   // 71: streamd.AddStreamDestinationReply
	(*RemoveStreamDestinationRequest)(nil),              // 72: streamd.RemoveStreamDestinationRequest
	(*RemoveStreamDestinationReply)(nil),                // 73: streamd.RemoveStreamDestinationReply
	(*IncomingStream)(nil),                              // 74: streamd.IncomingStream
	(*AddIncomingStreamRequest)(nil),                    // 75: streamd.AddIncomingStreamRequest
	(*AddIncomingStreamReply)(nil),                      // 76: streamd.AddIncomingStreamReply
	(*RemoveIncomingStreamRequest)(nil),                 // 77: streamd.RemoveIncomingStreamRequest
	(*RemoveIncomingStreamReply)(nil),                   // 78: streamd.RemoveIncomingStreamReply
	(*ListIncomingStreamsRequest)(nil),                  // 79: streamd.ListIncomingStreamsRequest
	(*ListIncomingStreamsReply)(nil),                    // 80: streamd.ListIncomingStreamsReply
	(*RestartUntilYoutubeRecognizesStream)(nil),         // 81: streamd.RestartUntilYoutubeRecognizesStream
	(*StartAfterYoutubeRecognizedStream)(nil),           // 82: streamd.StartAfterYoutubeRecognizedStream
	(*StreamForwardQuirks)(nil),                         // 83: streamd.StreamForwardQuirks
	(*StreamForward)(nil),                               // 84: streamd.StreamForward
	(*StreamForwardStatistics)(nil),                     // 85: streamd.StreamForwardStatistics
	(*StreamForwardWithStatistics)(nil),                 // 86: streamd.StreamForwardWithStatistics
	(*ListStreamForwardsRequest)(nil),                   // 87: streamd.ListStreamForwardsRequest
	(*ListStreamForwardsReply)(nil),                     // 88: streamd.ListStreamForwardsReply
	(*AddStreamForwardRequest)(nil),                     // 89: streamd.AddStreamForwardRequest
	(*AddStreamForwardReply)(nil),                       // 90: streamd.AddStreamForwardReply
	(*UpdateStreamForwardRequest)(nil),                  // 91: streamd.UpdateStreamForwardRequest
	(*UpdateStreamForwardReply)(nil),                    // 92: streamd.UpdateStreamForwardReply
	(*RemoveStreamForwardRequest)(nil),                  // 93: streamd.RemoveStreamForwardRequest
	(*RemoveStreamForwardReply)(nil),                    // 94: streamd.RemoveStreamForwardReply
	(*WaitForStreamPublisherRequest)(nil),               // 95: streamd.WaitForStreamPublisherRequest
	(*StreamPublisher)(nil),                             // 96: streamd.StreamPublisher
	(*StreamPlaybackConfig)(nil),                        // 97: streamd.StreamPlaybackConfig
	(*StreamPlayerConfig)(nil),                          // 98: streamd.StreamPlayerConfig
	(*AddStreamPlayerRequest)(nil),                      // 99: streamd.AddStreamPlayerRequest
	(*AddStreamPlayerReply)(nil),                        // 100: streamd.AddStreamPlayerReply
	(*RemoveStreamPlayerRequest)(nil),                   // 101: streamd.RemoveStreamPlayerRequest
	(*RemoveStreamPlayerReply)(nil),                     // 102: streamd.RemoveStreamPlayerReply
	(*UpdateStreamPlayerRequest)(nil),                   // 103: streamd.UpdateStreamPlayerRequest
	(*UpdateStreamPlayerReply)(nil),                     // 104: streamd.UpdateStreamPlayerReply
	(*ListStreamPlayersRequest)(nil),                    // 105: streamd.ListStreamPlayersRequest
	(*ListStreamPlayersReply)(nil),                      // 106: streamd.ListStreamPlayersReply
	(*GetStreamPlayerRequest)(nil),                      // 107: streamd.GetStreamPlayerRequest
	(*GetStreamPlayerReply)(nil),                        // 108: streamd.GetStreamPlayerReply
	(*StreamPlayerOpenRequest)(nil),                     // 109: streamd.StreamPlayerOpenRequest
	(*StreamPlayerOpenReply)(nil),                       // 110: streamd.StreamPlayerOpenReply
	(*StreamPlayerProcessTitleRequest)(nil),             // 111: streamd.StreamPlayerProcessTitleRequest
	(*StreamPlayerProcessTitleReply)(nil),               // 112: streamd.StreamPlayerProcessTitleReply
	(*StreamPlayerGetLinkRequest)(nil),                  // 113: streamd.StreamPlayerGetLinkRequest
	(*StreamPlayerGetLinkReply)(nil),                    // 114: streamd.StreamPlayerGetLinkReply
	(*StreamPlayerEndChanRequest)(nil),                  // 115: streamd.StreamPlayerEndChanRequest
	(*StreamPlayerEndChanReply)(nil),                    // 116: streamd.StreamPlayerEndChanReply
	(*StreamPlayerIsEndedRequest)(nil),                  // 117: streamd.StreamPlayerIsEndedRequest
	(*StreamPlayerIsEndedReply)(nil),                    // 118: streamd.StreamPlayerIsEndedReply
	(*StreamPlayerGetPositionRequest)(nil),              // 119: streamd.StreamPlayerGetPositionRequest
	(*StreamPlayerGetPositionReply)(nil),                // 120: streamd.StreamPlayerGetPositionReply
	(*StreamPlayerGetLengthRequest)(nil),                // 121: streamd.StreamPlayerGetLengthRequest
	(*StreamPlayerGetLengthReply)(nil),                  // 122: streamd.StreamPlayerGetLengthReply
	(*StreamPlayerSetSpeedRequest)(nil),                 // 123: streamd.StreamPlayerSetSpeedRequest
	(*StreamPlayerSetSpeedReply)(nil),                   // 124: streamd.StreamPlayerSetSpeedReply
	(*StreamPlayerSetPauseRequest)(nil),                 // 125: streamd.StreamPlayerSetPauseRequest
	(*StreamPlayerSetPauseReply)(nil),                   // 126: streamd.StreamPlayerSetPauseReply
	(*StreamPlayerStopRequest)(nil),                     // 127: streamd.StreamPlayerStopRequest
	(*StreamPlayerStopReply)(nil),                       // 128: streamd.StreamPlayerStopReply
	(*StreamPlayerCloseRequest)(nil),                    // 129: streamd.StreamPlayerCloseRequest
	(*StreamPlayerCloseReply)(nil),                      // 130: streamd.StreamPlayerCloseReply
	(*SubscribeToConfigChangesRequest)(nil),             // 131: streamd.SubscribeToConfigChangesRequest
	(*ConfigChange)(nil),                                // 132: streamd.ConfigChange
	(*SubscribeToStreamsChangesRequest)(nil),            // 133: streamd.SubscribeToStreamsChangesRequest
	(*StreamsChange)(nil),                               // 134: streamd.StreamsChange
	(*SubscribeToStreamServersChangesRequest)(nil),      // 135: streamd.SubscribeToStreamServersChangesRequest
	(*StreamServersChange)(nil),                         // 136: streamd.StreamServersChange
	(*SubscribeToStreamDestinationsChangesRequest)(nil), // 137: streamd.SubscribeToStreamDestinationsChangesRequest
	(*StreamDestinationsChange)(nil),                    // 138: streamd.StreamDestinationsChange
	(*SubscribeToIncomingStreamsChangesRequest)(nil),    // 139: streamd.SubscribeToIncomingStreamsChangesRequest
	(*IncomingStreamsChange)(nil),                       // 140: streamd.IncomingStreamsChange
	(*SubscribeToStreamForwardsChangesRequest)(nil),     // 141: streamd.SubscribeToStreamForwardsChangesRequest
	(*StreamForwardsChange)(nil),                        // 142: streamd.StreamForwardsChange
	(*SubscribeToStreamPlayersChangesRequest)(nil),      // 143: streamd.SubscribeToStreamPlayersChangesRequest
	(*StreamPlayersChange)(nil),                         // 144: streamd.StreamPlayersChange
	(*NoopRequest)(nil),                                 // 145: streamd.NoopRequest
	(*Action)(nil),                                      // 146: streamd.Action
	(*AddTimerRequest)(nil),                             // 147: streamd.AddTimerRequest
	(*AddTimerReply)(nil),                               // 148: streamd.AddTimerReply
	(*RemoveTimerRequest)(nil),                          // 149: streamd.RemoveTimerRequest
	(*RemoveTimerReply)(nil),                            // 150: streamd.RemoveTimerReply
	(*Timer)(nil),                                       // 151: streamd.Timer
	(*ListTimersRequest)(nil),                           // 152: streamd.ListTimersRequest
	(*ListTimersReply)(nil),                             // 153: streamd.ListTimersReply
	(*player_grpc.OpenRequest)(nil),                     // 154: player.OpenRequest
	(*player_grpc.OpenReply)(nil),                       // 155: player.OpenReply
	(*player_grpc.ProcessTitleRequest)(nil),             // 156: player.ProcessTitleRequest
	(*player_grpc.ProcessTitleReply)(nil),               // 157: player.ProcessTitleReply
	(*player_grpc.GetLinkRequest)(nil),                  // 158: player.GetLinkRequest
	(*player_grpc.GetLinkReply)(nil),                    // 159: player.GetLinkReply
	(*player_grpc.EndChanRequest)(nil),                  // 160: player.EndChanRequest
	(*player_grpc.EndChanReply)(nil),                    // 161: player.EndChanReply
	(*player_grpc.IsEndedRequest)(nil),                  // 162: player.IsEndedRequest
	(*player_grpc.IsEndedReply)(nil),                    // 163: player.IsEndedReply
	(*player_grpc.GetPositionRequest)(nil),              // 164: player.GetPositionRequest
	(*player_grpc.GetPositionReply)(nil),                // 165: player.GetPositionReply
	(*player_grpc.GetLengthRequest)(nil),                // 166: player.GetLengthRequest
	(*player_grpc.GetLengthReply)(nil),                  // 167: player.GetLengthReply
	(*player_grpc.SetSpeedRequest)(nil),                 // 168: player.SetSpeedRequest
	(*player_grpc.SetSpeedReply)(nil),                   // 169: player.SetSpeedReply
	(*player_grpc.SetPauseRequest)(nil),                 // 170: player.SetPauseRequest
	(*player_grpc.SetPauseReply)(nil),                   // 171: player.SetPauseReply
	(*player_grpc.StopRequest)(nil),                     // 172: player.StopRequest
	(*player_grpc.StopReply)(nil),                       // 173: player.StopReply
	(*player_grpc.CloseRequest)(nil),                    // 174: player.CloseRequest
	(*player_grpc.CloseReply)(nil),                      // 175: player.CloseReply
}
var file_streamd_proto_depIdxs = []int32{
	...
	58,  // 5: streamd.StreamServerWithStatistics.config:type_name -> streamd.StreamServer
	59,  // 6: streamd.StreamServerWithStatistics.statistics:type_name -> streamd.StreamServerStatistics
	60,  // 7: streamd.ListStreamServersReply.streamServers:type_name -> streamd.StreamServerWithStatistics
	58,  // 8: streamd.StartStreamServerRequest.config:type_name -> streamd.StreamServer
	67,  // 9: streamd.ListStreamDestinationsReply.streamDestinations:type_name -> streamd.StreamDestination
	67,  // 10: streamd.AddStreamDestinationRequest.config:type_name -> streamd.StreamDestination
	74,  // 11: streamd.ListIncomingStreamsReply.incomingStreams:type_name -> streamd.IncomingStream
	81,  // 12: streamd.StreamForwardQuirks.restartUntilYoutubeRecognizesStream:type_name -> streamd.RestartUntilYoutubeRecognizesStream
	82,  // 13: streamd.StreamForwardQuirks.startAfterYoutubeRecognizedStream:type_name -> streamd.StartAfterYoutubeRecognizedStream
	83,  // 14: streamd.StreamForward.quirks:type_name -> streamd.StreamForwardQuirks
	84,  // 15: streamd.StreamForwardWithStatistics.config:type_name -> streamd.StreamForward
	85,  // 16: streamd.StreamForwardWithStatistics.statistics:type_name -> streamd.StreamForwardStatistics
	86,  // 17: streamd.ListStreamForwardsReply.streamForwards:type_name -> streamd.StreamForwardWithStatistics
	84,  // 18: streamd.AddStreamForwardRequest.config:type_name -> streamd.StreamForward
	84,  // 19: streamd.UpdateStreamForwardRequest.config:type_name -> streamd.StreamForward
	84,  // 20: streamd.RemoveStreamForwardRequest.config:type_name -> streamd.StreamForward
	3,   // 21: streamd.StreamPlayerConfig.playerType:type_name -> streamd.PlayerType
	97,  // 22: streamd.StreamPlayerConfig.streamPlaybackConfig:type_name -> streamd.StreamPlaybackConfig
	98,  // 23: streamd.AddStreamPlayerRequest.config:type_name -> streamd.StreamPlayerConfig
	98,  // 24: streamd.UpdateStreamPlayerRequest.config:type_name -> streamd.StreamPlayerConfig
	98,  // 25: streamd.ListStreamPlayersReply.players:type_name -> streamd.StreamPlayerConfig
	98,  // 26: streamd.GetStreamPlayerReply.config:type_name -> streamd.StreamPlayerConfig
	154, // 27: streamd.StreamPlayerOpenRequest.request:type_name -> player.OpenRequest
	155, // 28: streamd.StreamPlayerOpenReply.reply:type_name -> player.OpenReply
	156, // 29: streamd.StreamPlayerProcessTitleRequest.request:type_name -> player.ProcessTitleRequest
	157, // 30: streamd.StreamPlayerProcessTitleReply.reply:type_name -> player.ProcessTitleReply
	158, // 31: streamd.StreamPlayerGetLinkRequest.request:type_name -> player.GetLinkRequest
	159, // 32: streamd.StreamPlayerGetLinkReply.reply:type_name -> player.GetLinkReply
	160, // 33: streamd.StreamPlayerEndChanRequest.request:type_name -> player.EndChanRequest
	161, // 34: streamd.StreamPlayerEndChanReply.reply:type_name -> player.EndChanReply
	162, // 35: streamd.StreamPlayerIsEndedRequest.request:type_name -> player.IsEndedRequest
	163, // 36: streamd.StreamPlayerIsEndedReply.reply:type_name -> player.IsEndedReply
	164, // 37: streamd.StreamPlayerGetPositionRequest.request:type_name -> player.GetPositionRequest
	165, // 38: streamd.StreamPlayerGetPositionReply.reply:type_name -> player.GetPositionReply
	166, // 39: streamd.StreamPlayerGetLengthRequest.request:type_name -> player.GetLengthRequest
	167, // 40: streamd.StreamPlayerGetLengthReply.reply:type_name -> player.GetLengthReply
	168, // 41: streamd.StreamPlayerSetSpeedRequest.request:type_name -> player.SetSpeedRequest
	169, // 42: streamd.StreamPlayerSetSpeedReply.reply:type_name -> player.SetSpeedReply
	170, // 43: streamd.StreamPlayerSetPauseRequest.request:type_name -> player.SetPauseRequest
	171, // 44: streamd.StreamPlayerSetPauseReply.reply:type_name -> player.SetPauseReply
	172, // 45: streamd.StreamPlayerStopRequest.request:type_name -> player.StopRequest
	173, // 46: streamd.StreamPlayerStopReply.reply:type_name -> player.StopReply
	174, // 47: streamd.StreamPlayerCloseRequest.request:type_name -> player.CloseRequest
	175, // 48: streamd.StreamPlayerCloseReply.reply:type_name -> player.CloseReply
	145, // 49: streamd.Action.noopRequest:type_name -> streamd.NoopRequest
	20,  // 50: streamd.Action.startStreamRequest:type_name -> streamd.StartStreamRequest
	22,  // 51: streamd.Action.endStreamRequest:type_name -> streamd.EndStreamRequest
	146, // 52: streamd.AddTimerRequest.action:type_name -> streamd.Action
	146, // 53: streamd.Timer.action:type_name -> streamd.Action
	151, // 54: streamd.ListTimersReply.timers:type_name -> streamd.Timer
	4,   // 55: streamd.StreamD.Ping:input_type -> streamd.PingRequest
	6,   // 56: streamd.StreamD.SetLoggingLevel:input_type -> streamd.SetLoggingLevelRequest
	8,   // 57: streamd.StreamD.GetLoggingLevel:input_type -> streamd.GetLoggingLevelRequest
	10,  // 58: streamd.StreamD.GetConfig:input_type -> streamd.GetConfigRequest
	12,  // 59: streamd.StreamD.SetConfig:input_type -> streamd.SetConfigRequest
	14,  // 60: streamd.StreamD.SaveConfig:input_type -> streamd.SaveConfigRequest
	131, // 61: streamd.StreamD.SubscribeToConfigChanges:input_type -> streamd.SubscribeToConfigChangesRequest
	16,  // 62: streamd.StreamD.ResetCache:input_type -> streamd.ResetCacheRequest
	18,  // 63: streamd.StreamD.InitCache:input_type -> streamd.InitCacheRequest
	20,  // 64: streamd.StreamD.StartStream:input_type -> streamd.StartStreamRequest
	22,  // 65: streamd.StreamD.EndStream:input_type -> streamd.EndStreamRequest
	24,  // 66: streamd.StreamD.GetStreamStatus:input_type -> streamd.GetStreamStatusRequest
	28,  // 67: streamd.StreamD.IsBackendEnabled:input_type -> streamd.IsBackendEnabledRequest
	26,  // 68: streamd.StreamD.GetBackendInfo:input_type -> streamd.GetBackendInfoRequest
	133, // 69: streamd.StreamD.SubscribeToStreamsChanges:input_type -> streamd.SubscribeToStreamsChangesRequest
	30,  // 70: streamd.StreamD.Restart:input_type -> streamd.RestartRequest
	32,  // 71: streamd.StreamD.SetTitle:input_type -> streamd.SetTitleRequest
	34,  // 72: streamd.StreamD.SetDescription:input_type -> streamd.SetDescriptionRequest
	36,  // 73: streamd.StreamD.ApplyProfile:input_type -> streamd.ApplyProfileRequest
	38,  // 74: streamd.StreamD.UpdateStream:input_type -> streamd.UpdateStreamRequest
	50,  // 75: streamd.StreamD.GetVariable:input_type -> streamd.GetVariableRequest
	52,  // 76: streamd.StreamD.GetVariableHash:input_type -> streamd.GetVariableHashRequest
	54,  // 77: streamd.StreamD.SetVariable:input_type -> streamd.SetVariableRequest
	40,  // 78: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:input_type -> streamd.EXPERIMENTAL_ReinitStreamControllersRequest
	42,  // 79: streamd.StreamD.OBSOLETE_FetchConfig:input_type -> streamd.OBSOLETE_FetchConfigRequest
	44,  // 80: streamd.StreamD.OBSOLETE_GitInfo:input_type -> streamd.OBSOLETE_GetGitInfoRequest
	46,  // 81: streamd.StreamD.OBSOLETE_GitRelogin:input_type -> streamd.OBSOLETE_GitReloginRequest
	48,  // 82: streamd.StreamD.SubscribeToOAuthRequests:input_type -> streamd.SubscribeToOAuthRequestsRequest
	56,  // 83: streamd.StreamD.SubmitOAuthCode:input_type -> streamd.SubmitOAuthCodeRequest
	61,  // 84: streamd.StreamD.ListStreamServers:input_type -> streamd.ListStreamServersRequest
	63,  // 85: streamd.StreamD.StartStreamServer:input_type -> streamd.StartStreamServerRequest
	65,  // 86: streamd.StreamD.StopStreamServer:input_type -> streamd.StopStreamServerRequest
	135, // 87: streamd.StreamD.SubscribeToStreamServersChanges:input_type -> streamd.SubscribeToStreamServersChangesRequest
	68,  // 88: streamd.StreamD.ListStreamDestinations:input_type -> streamd.ListStreamDestinationsRequest
	70,  // 89: streamd.StreamD.AddStreamDestination:input_type -> streamd.AddStreamDestinationRequest
	72,  // 90: streamd.StreamD.RemoveStreamDestination:input_type -> streamd.RemoveStreamDestinationRequest
	137, // 91: streamd.StreamD.SubscribeToStreamDestinationsChanges:input_type -> streamd.SubscribeToStreamDestinationsChangesRequest
	75,  // 92: streamd.StreamD.AddIncomingStream:input_type -> streamd.AddIncomingStreamRequest
	77,  // 93: streamd.StreamD.RemoveIncomingStream:input_type -> streamd.RemoveIncomingStreamRequest
	79,  // 94: streamd.StreamD.ListIncomingStreams:input_type -> streamd.ListIncomingStreamsRequest
	139, // 95: streamd.StreamD.SubscribeToIncomingStreamsChanges:input_type -> streamd.SubscribeToIncomingStreamsChangesRequest
	87,  // 96: streamd.StreamD.ListStreamForwards:input_type -> streamd.ListStreamForwardsRequest
	89,  // 97: streamd.StreamD.AddStreamForward:input_type -> streamd.AddStreamForwardRequest
	91,  // 98: streamd.StreamD.UpdateStreamForward:input_type -> streamd.UpdateStreamForwardRequest
	93,  // 99: streamd.StreamD.RemoveStreamForward:input_type -> streamd.RemoveStreamForwardRequest
	141, // 100: streamd.StreamD.SubscribeToStreamForwardsChanges:input_type -> streamd.SubscribeToStreamForwardsChangesRequest
	95,  // 101: streamd.StreamD.WaitForStreamPublisher:input_type -> streamd.WaitForStreamPublisherRequest
	99,  // 102: streamd.StreamD.AddStreamPlayer:input_type -> streamd.AddStreamPlayerRequest
	101, // 103: streamd.StreamD.RemoveStreamPlayer:input_type -> streamd.RemoveStreamPlayerRequest
	103, // 104: streamd.StreamD.UpdateStreamPlayer:input_type -> streamd.UpdateStreamPlayerRequest
	105, // 105: streamd.StreamD.ListStreamPlayers:input_type -> streamd.ListStreamPlayersRequest
	107, // 106: streamd.StreamD.GetStreamPlayer:input_type -> streamd.GetStreamPlayerRequest
	143, // 107: streamd.StreamD.SubscribeToStreamPlayersChanges:input_type -> streamd.SubscribeToStreamPlayersChangesRequest
	109, // 108: streamd.StreamD.StreamPlayerOpen:input_type -> streamd.StreamPlayerOpenRequest
	111, // 109: streamd.StreamD.StreamPlayerProcessTitle:input_type -> streamd.StreamPlayerProcessTitleRequest
	113, // 110: streamd.StreamD.StreamPlayerGetLink:input_type -> streamd.StreamPlayerGetLinkRequest
	115, // 111: streamd.StreamD.StreamPlayerEndChan:input_type -> streamd.StreamPlayerEndChanRequest
	117, // 112: streamd.StreamD.StreamPlayerIsEnded:input_type -> streamd.StreamPlayerIsEndedRequest
	119, // 113: streamd.StreamD.StreamPlayerGetPosition:input_type -> streamd.StreamPlayerGetPositionRequest
	121, // 114: streamd.StreamD.StreamPlayerGetLength:input_type -> streamd.StreamPlayerGetLengthRequest
	123, // 115: streamd.StreamD.StreamPlayerSetSpeed:input_type -> streamd.StreamPlayerSetSpeedRequest
	125, // 116: streamd.StreamD.StreamPlayerSetPause:input_type -> streamd.StreamPlayerSetPauseRequest
	127, // 117: streamd.StreamD.StreamPlayerStop:input_type -> streamd.StreamPlayerStopRequest
	129, // 118: streamd.StreamD.StreamPlayerClose:input_type -> streamd.StreamPlayerCloseRequest
	147, // 119: streamd.StreamD.AddTimer:input_type -> streamd.AddTimerRequest
	149, // 120: streamd.StreamD.RemoveTimer:input_type -> streamd.RemoveTimerRequest
	152, // 121: streamd.StreamD.ListTimers:input_type -> streamd.ListTimersRequest
	5,   // 122: streamd.StreamD.Ping:output_type -> streamd.PingReply
	7,   // 123: streamd.StreamD.SetLoggingLevel:output_type -> streamd.SetLoggingLevelReply
	9,   // 124: streamd.StreamD.GetLoggingLevel:output_type -> streamd.GetLoggingLevelReply
	11,  // 125: streamd.StreamD.GetConfig:output_type -> streamd.GetConfigReply
	13,  // 126: streamd.StreamD.SetConfig:output_type -> streamd.SetConfigReply
	15,  // 127: streamd.StreamD.SaveConfig:output_type -> streamd.SaveConfigReply
	132, // 128: streamd.StreamD.SubscribeToConfigChanges:output_type -> streamd.ConfigChange
	17,  // 129: streamd.StreamD.ResetCache:output_type -> streamd.ResetCacheReply
	19,  // 130: streamd.StreamD.InitCache:output_type -> streamd.InitCacheReply
	21,  // 131: streamd.StreamD.StartStream:output_type -> streamd.StartStreamReply
	23,  // 132: streamd.StreamD.EndStream:output_type -> streamd.EndStreamReply
	25,  // 133: streamd.StreamD.GetStreamStatus:output_type -> streamd.GetStreamStatusReply
	29,  // 134: streamd.StreamD.IsBackendEnabled:output_type -> streamd.IsBackendEnabledReply
	27,  // 135: streamd.StreamD.GetBackendInfo:output_type -> streamd.GetBackendInfoReply
	134, // 136: streamd.StreamD.SubscribeToStreamsChanges:output_type -> streamd.StreamsChange
	31,  // 137: streamd.StreamD.Restart:output_type -> streamd.RestartReply
	33,  // 138: streamd.StreamD.SetTitle:output_type -> streamd.SetTitleReply
	35,  // 139: streamd.StreamD.SetDescription:output_type -> streamd.SetDescriptionReply
	37,  // 140: streamd.StreamD.ApplyProfile:output_type -> streamd.ApplyProfileReply
	39,  // 141: streamd.StreamD.UpdateStream:output_type -> streamd.UpdateStreamReply
	51,  // 142: streamd.StreamD.GetVariable:output_type -> streamd.GetVariableReply
	53,  // 143: streamd.StreamD.GetVariableHash:output_type -> streamd.GetVariableHashReply
	55,  // 144: streamd.StreamD.SetVariable:output_type -> streamd.SetVariableReply
	41,  // 145: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:output_type -> streamd.EXPERIMENTAL_ReinitStreamControllersReply
	43,  // 146: streamd.StreamD.OBSOLETE_FetchConfig:output_type -> streamd.OBSOLETE_FetchConfigReply
	45,  // 147: streamd.StreamD.OBSOLETE_GitInfo:output_type -> streamd.OBSOLETE_GetGitInfoReply
	47,  // 148: streamd.StreamD.OBSOLETE_GitRelogin:output_type -> streamd.OBSOLETE_GitReloginReply
	49,  // 149: streamd.StreamD.SubscribeToOAuthRequests:output_type -> streamd.OAuthRequest
	57,  // 150: streamd.StreamD.SubmitOAuthCode:output_type -> streamd.SubmitOAuthCodeReply
	62,  // 151: streamd.StreamD.ListStreamServers:output_type -> streamd.ListStreamServersReply
	64,  // 152: streamd.StreamD.StartStreamServer:output_type -> streamd.StartStreamServerReply
	66,  // 153: streamd.StreamD.StopStreamServer:output_type -> streamd.StopStreamServerReply
	136, // 154: streamd.StreamD.SubscribeToStreamServersChanges:output_type -> streamd.StreamServersChange
	69,  // 155: streamd.StreamD.ListStreamDestinations:output_type -> streamd.ListStreamDestinationsReply
	71,  // 156: streamd.StreamD.AddStreamDestination:output_type -> streamd.AddStreamDestinationReply
	73,  // 157: streamd.StreamD.RemoveStreamDestination:output_type -> streamd.RemoveStreamDestinationReply
	138, // 158: streamd.StreamD.SubscribeToStreamDestinationsChanges:output_type -> streamd.StreamDestinationsChange
	76,  // 159: streamd.StreamD.AddIncomingStream:output_type -> streamd.AddIncomingStreamReply
	78,  // 160: streamd.StreamD.RemoveIncomingStream:output_type -> streamd.RemoveIncomingStreamReply
	80,  // 161: streamd.StreamD.ListIncomingStreams:output_type -> streamd.ListIncomingStreamsReply
	140, // 162: streamd.StreamD.SubscribeToIncomingStreamsChanges:output_type -> streamd.IncomingStreamsChange
	88,  // 163: streamd.StreamD.ListStreamForwards:output_type -> streamd.ListStreamForwardsReply
	90,  // 164: streamd.StreamD.AddStreamForward:output_type -> streamd.AddStreamForwardReply
	92,  // 165: streamd.StreamD.UpdateStreamForward:output_type -> streamd.UpdateStreamForwardReply
	94,  // 166: streamd.StreamD.RemoveStreamForward:output_type -> streamd.RemoveStreamForwardReply
	142, // 167: streamd.StreamD.SubscribeToStreamForwardsChanges:output_type -> streamd.StreamForwardsChange
	96,  // 168: streamd.StreamD.WaitForStreamPublisher:output_type -> streamd.StreamPublisher
	100, // 169: streamd.StreamD.AddStreamPlayer:output_type -> streamd.AddStreamPlayerReply
	102, // 170: streamd.StreamD.RemoveStreamPlayer:output_type -> streamd.RemoveStreamPlayerReply
	104, // 171: streamd.StreamD.UpdateStreamPlayer:output_type -> streamd.UpdateStreamPlayerReply
	106, // 172: streamd.StreamD.ListStreamPlayers:output_type -> streamd.ListStreamPlayersReply
	108, // 173: streamd.StreamD.GetStreamPlayer:output_type -> streamd.GetStreamPlayerReply
	144, // 174: streamd.StreamD.SubscribeToStreamPlayersChanges:output_type -> streamd.StreamPlayersChange
	110, // 175: streamd.StreamD.StreamPlayerOpen:output_type -> streamd.StreamPlayerOpenReply
	112, // 176: streamd.StreamD.StreamPlayerProcessTitle:output_type -> streamd.StreamPlayerProcessTitleReply
	114, // 177: streamd.StreamD.StreamPlayerGetLink:output_type -> streamd.StreamPlayerGetLinkReply
	116, // 178: streamd.StreamD.StreamPlayerEndChan:output_type -> streamd.StreamPlayerEndChanReply
	118, // 179: streamd.StreamD.StreamPlayerIsEnded:output_type -> streamd.StreamPlayerIsEndedReply
	120, // 180: streamd.StreamD.StreamPlayerGetPosition:output_type -> streamd.StreamPlayerGetPositionReply
	122, // 181: streamd.StreamD.StreamPlayerGetLength:output_type -> streamd.StreamPlayerGetLengthReply
	124, // 182: streamd.StreamD.StreamPlayerSetSpeed:output_type -> streamd.StreamPlayerSetSpeedReply
	126, // 183: streamd.StreamD.StreamPlayerSetPause:output_type -> streamd.StreamPlayerSetPauseReply
	128, // 184: streamd.StreamD.StreamPlayerStop:output_type -> streamd.StreamPlayerStopReply
	130, // 185: streamd.StreamD.StreamPlayerClose:output_type -> streamd.StreamPlayerCloseReply
	148, // 186: streamd.StreamD.AddTimer:output_type -> streamd.AddTimerReply
	150, // 187: streamd.StreamD.RemoveTimer:output_type -> streamd.RemoveTimerReply
	153, // 188: streamd.StreamD.ListTimers:output_type -> streamd.ListTimersReply
...
func file_streamd_proto_init() {
	...
	file_streamd_proto_msgTypes[142].OneofWrappers = []interface{}{
