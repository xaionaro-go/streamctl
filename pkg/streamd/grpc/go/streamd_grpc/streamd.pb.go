...
type GetYouTubeInfoRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetYouTubeInfoRequest) Reset() {
	*x = GetYouTubeInfoRequest{}
	mi := &file_streamd_proto_msgTypes[224]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetYouTubeInfoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetYouTubeInfoRequest) ProtoMessage() {}

func (x *GetYouTubeInfoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[224]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetYouTubeInfoRequest.ProtoReflect.Descriptor instead.
func (*GetYouTubeInfoRequest) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{224}
}

type GetYouTubeInfoReply struct {
	state              protoimpl.MessageState     `protogen:"open.v1"`
	QuotaUsage         *YouTubeQuotaUsage         `protobuf:"bytes,1,opt,name=quota_usage,json=quotaUsage,proto3" json:"quota_usage,omitempty"`
	ChatListeners      []*YouTubeChatListenerInfo `protobuf:"bytes,2,rep,name=chat_listeners,json=chatListeners,proto3" json:"chat_listeners,omitempty"`
	ActiveBroadcasts   []*YouTubeBroadcastSummary `protobuf:"bytes,3,rep,name=active_broadcasts,json=activeBroadcasts,proto3" json:"active_broadcasts,omitempty"`
	UpcomingBroadcasts []*YouTubeBroadcastSummary `protobuf:"bytes,4,rep,name=upcoming_broadcasts,json=upcomingBroadcasts,proto3" json:"upcoming_broadcasts,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *GetYouTubeInfoReply) Reset() {
	*x = GetYouTubeInfoReply{}
	mi := &file_streamd_proto_msgTypes[225]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetYouTubeInfoReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetYouTubeInfoReply) ProtoMessage() {}

func (x *GetYouTubeInfoReply) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[225]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetYouTubeInfoReply.ProtoReflect.Descriptor instead.
func (*GetYouTubeInfoReply) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{225}
}

func (x *GetYouTubeInfoReply) GetQuotaUsage() *YouTubeQuotaUsage {
	if x != nil {
		return x.QuotaUsage
	}
	return nil
...
func (x *GetYouTubeInfoReply) GetChatListeners() []*YouTubeChatListenerInfo {
	if x != nil {
		return x.ChatListeners
	}
	return nil
}

func (x *GetYouTubeInfoReply) GetActiveBroadcasts() []*YouTubeBroadcastSummary {
	if x != nil {
		return x.ActiveBroadcasts
	}
	return nil
}

func (x *GetYouTubeInfoReply) GetUpcomingBroadcasts() []*YouTubeBroadcastSummary {
	if x != nil {
		return x.UpcomingBroadcasts
	}
	return nil
}

type YouTubeQuotaUsage struct {
	state                    protoimpl.MessageState `protogen:"open.v1"`
	UsedPoints               uint64                 `protobuf:"varint,1,opt,name=used_points,json=usedPoints,proto3" json:"used_points,omitempty"`
	DailyLimit               uint64                 `protobuf:"varint,2,opt,name=daily_limit,json=dailyLimit,proto3" json:"daily_limit,omitempty"`
	ResetTimeUnix            int64                  `protobuf:"varint,3,opt,name=reset_time_unix,json=resetTimeUnix,proto3" json:"reset_time_unix,omitempty"`
	GoogleReportedUsage      *uint64                `protobuf:"varint,4,opt,name=google_reported_usage,json=googleReportedUsage,proto3,oneof" json:"google_reported_usage,omitempty"`
	GoogleReportedLimit      *uint64                `protobuf:"varint,5,opt,name=google_reported_limit,json=googleReportedLimit,proto3,oneof" json:"google_reported_limit,omitempty"`
	GoogleReportedAtUnix     *int64                 `protobuf:"varint,6,opt,name=google_reported_at_unix,json=googleReportedAtUnix,proto3,oneof" json:"google_reported_at_unix,omitempty"`
	PerOperationUsage        map[string]uint64      `protobuf:"bytes,7,rep,name=per_operation_usage,json=perOperationUsage,proto3" json:"per_operation_usage,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	PerOperationRequestCount map[string]uint64      `protobuf:"bytes,8,rep,name=per_operation_request_count,json=perOperationRequestCount,proto3" json:"per_operation_request_count,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}

func (x *YouTubeQuotaUsage) Reset() {
	*x = YouTubeQuotaUsage{}
	mi := &file_streamd_proto_msgTypes[226]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *YouTubeQuotaUsage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*YouTubeQuotaUsage) ProtoMessage() {}

func (x *YouTubeQuotaUsage) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[226]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use YouTubeQuotaUsage.ProtoReflect.Descriptor instead.
func (*YouTubeQuotaUsage) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{226}
}

func (x *YouTubeQuotaUsage) GetUsedPoints() uint64 {
	if x != nil {
		return x.UsedPoints
	}
	return 0
...
func (x *YouTubeQuotaUsage) GetDailyLimit() uint64 {
	if x != nil {
		return x.DailyLimit
	}
	return 0
...
func (x *YouTubeQuotaUsage) GetResetTimeUnix() int64 {
	if x != nil {
		return x.ResetTimeUnix
	}
	return 0
}

func (x *YouTubeQuotaUsage) GetGoogleReportedUsage() uint64 {
	if x != nil && x.GoogleReportedUsage != nil {
		return *x.GoogleReportedUsage
	}
	return 0
}

func (x *YouTubeQuotaUsage) GetGoogleReportedLimit() uint64 {
	if x != nil && x.GoogleReportedLimit != nil {
		return *x.GoogleReportedLimit
	}
	return 0
}

func (x *YouTubeQuotaUsage) GetGoogleReportedAtUnix() int64 {
	if x != nil && x.GoogleReportedAtUnix != nil {
		return *x.GoogleReportedAtUnix
	}
	return 0
}

func (x *YouTubeQuotaUsage) GetPerOperationUsage() map[string]uint64 {
	if x != nil {
		return x.PerOperationUsage
	}
	return nil
}

func (x *YouTubeQuotaUsage) GetPerOperationRequestCount() map[string]uint64 {
	if x != nil {
		return x.PerOperationRequestCount
	}
	return nil
}

type YouTubeChatListenerInfo struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *YouTubeChatListenerInfo) Reset() {
	*x = YouTubeChatListenerInfo{}
	mi := &file_streamd_proto_msgTypes[227]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *YouTubeChatListenerInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*YouTubeChatListenerInfo) ProtoMessage() {}

func (x *YouTubeChatListenerInfo) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[227]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use YouTubeChatListenerInfo.ProtoReflect.Descriptor instead.
func (*YouTubeChatListenerInfo) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{227}
}

func (x *YouTubeChatListenerInfo) GetVideoId() string {
	if x != nil {
		return x.VideoId
	}
	return ""
...
func (x *YouTubeChatListenerInfo) GetChatId() string {
	if x != nil {
		return x.ChatId
	}
	return ""
...
func (x *YouTubeChatListenerInfo) GetIsActive() bool {
	if x != nil {
		return x.IsActive
	}
	return false
...
type YouTubeBroadcastSummary struct {
	state              protoimpl.MessageState `protogen:"open.v1"`
	Id                 string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Title              string                 `protobuf:"bytes,2,opt,name=title,proto3" json:"title,omitempty"`
	Status             string                 `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
	ScheduledStartUnix int64                  `protobuf:"varint,4,opt,name=scheduled_start_unix,json=scheduledStartUnix,proto3" json:"scheduled_start_unix,omitempty"`
	ActualStartUnix    int64                  `protobuf:"varint,5,opt,name=actual_start_unix,json=actualStartUnix,proto3" json:"actual_start_unix,omitempty"`
	ViewerCount        uint64                 `protobuf:"varint,6,opt,name=viewer_count,json=viewerCount,proto3" json:"viewer_count,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}

func (x *YouTubeBroadcastSummary) Reset() {
	*x = YouTubeBroadcastSummary{}
	mi := &file_streamd_proto_msgTypes[228]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *YouTubeBroadcastSummary) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*YouTubeBroadcastSummary) ProtoMessage() {}

func (x *YouTubeBroadcastSummary) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[228]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use YouTubeBroadcastSummary.ProtoReflect.Descriptor instead.
func (*YouTubeBroadcastSummary) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{228}
}

func (x *YouTubeBroadcastSummary) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *YouTubeBroadcastSummary) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *YouTubeBroadcastSummary) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *YouTubeBroadcastSummary) GetScheduledStartUnix() int64 {
	if x != nil {
		return x.ScheduledStartUnix
	}
	return 0
}

func (x *YouTubeBroadcastSummary) GetActualStartUnix() int64 {
	if x != nil {
		return x.ActualStartUnix
	}
	return 0
}

func (x *YouTubeBroadcastSummary) GetViewerCount() uint64 {
	if x != nil {
...
type ResolvePlatformURLRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Url           string                 `protobuf:"bytes,1,opt,name=url,proto3" json:"url,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ResolvePlatformURLRequest) Reset() {
	*x = ResolvePlatformURLRequest{}
	mi := &file_streamd_proto_msgTypes[229]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResolvePlatformURLRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResolvePlatformURLRequest) ProtoMessage() {}

func (x *ResolvePlatformURLRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[229]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResolvePlatformURLRequest.ProtoReflect.Descriptor instead.
func (*ResolvePlatformURLRequest) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{229}
}

func (x *ResolvePlatformURLRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
type ResolvePlatformURLReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PlatID        string                 `protobuf:"bytes,1,opt,name=platID,proto3" json:"platID,omitempty"`
...
func (x *ResolvePlatformURLReply) Reset() {
	*x = ResolvePlatformURLReply{}
	mi := &file_streamd_proto_msgTypes[230]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ResolvePlatformURLReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResolvePlatformURLReply) ProtoMessage() {}

func (x *ResolvePlatformURLReply) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[230]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResolvePlatformURLReply.ProtoReflect.Descriptor instead.
func (*ResolvePlatformURLReply) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{230}
}

func (x *ResolvePlatformURLReply) GetPlatID() string {
	if x != nil {
		return x.PlatID
	}
	return ""
...
func (x *ResolvePlatformURLReply) GetStreamID() string {
	if x != nil {
		return x.StreamID
	}
	return ""
...
type ListenChatOfStreamRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PlatID        string                 `protobuf:"bytes,1,opt,name=platID,proto3" json:"platID,omitempty"`
	StreamID      string                 `protobuf:"bytes,2,opt,name=streamID,proto3" json:"streamID,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ListenChatOfStreamRequest) Reset() {
	*x = ListenChatOfStreamRequest{}
	mi := &file_streamd_proto_msgTypes[231]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListenChatOfStreamRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListenChatOfStreamRequest) ProtoMessage() {}

func (x *ListenChatOfStreamRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[231]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListenChatOfStreamRequest.ProtoReflect.Descriptor instead.
func (*ListenChatOfStreamRequest) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{231}
}

func (x *ListenChatOfStreamRequest) GetPlatID() string {
	if x != nil {
		return x.PlatID
	}
	return ""
...
func (x *ListenChatOfStreamRequest) GetStreamID() string {
	if x != nil {
		return x.StreamID
	}
	return ""
...
type PurgeChatMessagesRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PlatID        *string                `protobuf:"bytes,1,opt,name=platID,proto3,oneof" json:"platID,omitempty"`
	StreamID      *string                `protobuf:"bytes,2,opt,name=streamID,proto3,oneof" json:"streamID,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PurgeChatMessagesRequest) Reset() {
	*x = PurgeChatMessagesRequest{}
	mi := &file_streamd_proto_msgTypes[232]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PurgeChatMessagesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PurgeChatMessagesRequest) ProtoMessage() {}

func (x *PurgeChatMessagesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[232]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PurgeChatMessagesRequest.ProtoReflect.Descriptor instead.
func (*PurgeChatMessagesRequest) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{232}
}

func (x *PurgeChatMessagesRequest) GetPlatID() string {
...
func (x *PurgeChatMessagesRequest) GetStreamID() string {
	if x != nil && x.StreamID != nil {
		return *x.StreamID
	}
	return ""
...
type PurgeChatMessagesReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RemovedCount  uint64                 `protobuf:"varint,1,opt,name=removedCount,proto3" json:"removedCount,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PurgeChatMessagesReply) Reset() {
	*x = PurgeChatMessagesReply{}
	mi := &file_streamd_proto_msgTypes[233]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PurgeChatMessagesReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PurgeChatMessagesReply) ProtoMessage() {}

func (x *PurgeChatMessagesReply) ProtoReflect() protoreflect.Message {
	mi := &file_streamd_proto_msgTypes[233]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PurgeChatMessagesReply.ProtoReflect.Descriptor instead.
func (*PurgeChatMessagesReply) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{233}
}

func (x *PurgeChatMessagesReply) GetRemovedCount() uint64 {
	if x != nil {
...
func (x *SetBuiltinChatListenerEnabledRequest) Reset() {
	*x = SetBuiltinChatListenerEnabledRequest{}
	mi := &file_streamd_proto_msgTypes[234]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetBuiltinChatListenerEnabledRequest) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{234}
}
...
func (x *SetBuiltinChatListenerEnabledReply) Reset() {
	*x = SetBuiltinChatListenerEnabledReply{}
	mi := &file_streamd_proto_msgTypes[235]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetBuiltinChatListenerEnabledReply) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{235}
}
...
func (x *IsBuiltinChatListenerEnabledRequest) Reset() {
	*x = IsBuiltinChatListenerEnabledRequest{}
	mi := &file_streamd_proto_msgTypes[236]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IsBuiltinChatListenerEnabledRequest) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{236}
}
...
func (x *IsBuiltinChatListenerEnabledReply) Reset() {
	*x = IsBuiltinChatListenerEnabledReply{}
	mi := &file_streamd_proto_msgTypes[237]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IsBuiltinChatListenerEnabledReply) Descriptor() ([]byte, []int) {
	return file_streamd_proto_rawDescGZIP(), []int{237}
}
...
const file_streamd_proto_rawDesc = "" +
	...
	"\bstreamID\x18\x03 \x01(\tH\x00R\bstreamID\x88\x01\x01B\v\n" +
	"\t_streamID\"\x87\x01\n" +
	"\vChatMessage\x12\x16\n" +
	"\x06platID\x18\x01 \x01(\tR\x06platID\x12\x16\n" +
	"\x06isLive\x18\x02 \x01(\bR\x06isLive\x12,\n" +
	"\acontent\x18\x03 \x01(\v2\x12.chatwebhook.EventR\acontent\x12\x1a\n" +
	"\bstreamID\x18\x04 \x01(\tR\bstreamID\"J\n" +
	...
	"\x06config\x18\x01 \x01(\v2\x19.streamd.StreamSinkConfigR\x06config\"\x17\n" +
	"\x15GetYouTubeInfoRequest\"\xbd\x02\n" +
	"\x13GetYouTubeInfoReply\x12;\n" +
	"\vquota_usage\x18\x01 \x01(\v2\x1a.streamd.YouTubeQuotaUsageR\n" +
	"quotaUsage\x12G\n" +
	"\x0echat_listeners\x18\x02 \x03(\v2 .streamd.YouTubeChatListenerInfoR\rchatListeners\x12M\n" +
	"\x11active_broadcasts\x18\x03 \x03(\v2 .streamd.YouTubeBroadcastSummaryR\x10activeBroadcasts\x12Q\n" +
	"\x13upcoming_broadcasts\x18\x04 \x03(\v2 .streamd.YouTubeBroadcastSummaryR\x12upcomingBroadcasts\"\xea\x05\n" +
	"\x11YouTubeQuotaUsage\x12\x1f\n" +
	"\vused_points\x18\x01 \x01(\x04R\n" +
	"usedPoints\x12\x1f\n" +
	"\vdaily_limit\x18\x02 \x01(\x04R\n" +
	"dailyLimit\x12&\n" +
	"\x0freset_time_unix\x18\x03 \x01(\x03R\rresetTimeUnix\x127\n" +
	"\x15google_reported_usage\x18\x04 \x01(\x04H\x00R\x13googleReportedUsage\x88\x01\x01\x127\n" +
	"\x15google_reported_limit\x18\x05 \x01(\x04H\x01R\x13googleReportedLimit\x88\x01\x01\x12:\n" +
	"\x17google_reported_at_unix\x18\x06 \x01(\x03H\x02R\x14googleReportedAtUnix\x88\x01\x01\x12a\n" +
	"\x13per_operation_usage\x18\a \x03(\v21.streamd.YouTubeQuotaUsage.PerOperationUsageEntryR\x11perOperationUsage\x12w\n" +
	"\x1bper_operation_request_count\x18\b \x03(\v28.streamd.YouTubeQuotaUsage.PerOperationRequestCountEntryR\x18perOperationRequestCount\x1aD\n" +
	"\x16PerOperationUsageEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x04R\x05value:\x028\x01\x1aK\n" +
	"\x1dPerOperationRequestCountEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x04R\x05value:\x028\x01B\x18\n" +
	"\x16_google_reported_usageB\x18\n" +
	"\x16_google_reported_limitB\x1a\n" +
	"\x18_google_reported_at_unix\"j\n" +
	"\x17YouTubeChatListenerInfo\x12\x19\n" +
	"\bvideo_id\x18\x01 \x01(\tR\avideoId\x12\x17\n" +
	"\achat_id\x18\x02 \x01(\tR\x06chatId\x12\x1b\n" +
	"\tis_active\x18\x03 \x01(\bR\bisActive\"\xd8\x01\n" +
	"\x17YouTubeBroadcastSummary\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12\x16\n" +
	"\x06status\x18\x03 \x01(\tR\x06status\x120\n" +
	"\x14scheduled_start_unix\x18\x04 \x01(\x03R\x12scheduledStartUnix\x12*\n" +
	"\x11actual_start_unix\x18\x05 \x01(\x03R\x0factualStartUnix\x12!\n" +
	"\fviewer_count\x18\x06 \x01(\x04R\vviewerCount\"-\n" +
	"\x19ResolvePlatformURLRequest\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\"M\n" +
	"\x17ResolvePlatformURLReply\x12\x16\n" +
	"\x06platID\x18\x01 \x01(\tR\x06platID\x12\x1a\n" +
	"\bstreamID\x18\x02 \x01(\tR\bstreamID\"O\n" +
	"\x19ListenChatOfStreamRequest\x12\x16\n" +
	"\x06platID\x18\x01 \x01(\tR\x06platID\x12\x1a\n" +
	"\bstreamID\x18\x02 \x01(\tR\bstreamID\"p\n" +
	"\x18PurgeChatMessagesRequest\x12\x1b\n" +
	"\x06platID\x18\x01 \x01(\tH\x00R\x06platID\x88\x01\x01\x12\x1f\n" +
	"\bstreamID\x18\x02 \x01(\tH\x01R\bstreamID\x88\x01\x01B\t\n" +
	"\a_platIDB\v\n" +
	"\t_streamID\"<\n" +
	"\x16PurgeChatMessagesReply\x12\"\n" +
	"\fremovedCount\x18\x01 \x01(\x04R\fremovedCount\"X\n" +
	...
	"\x15TEXT_FORMAT_TYPE_HTML\x10\x032\xc9@\n" +
	"\aStreamD\x122\n" +
	...
	"\x06RaidTo\x12\x16.streamd.RaidToRequest\x1a\x14.streamd.RaidToReply\"\x00\x12\\\n" +
	"\x12ResolvePlatformURL\x12\".streamd.ResolvePlatformURLRequest\x1a .streamd.ResolvePlatformURLReply\"\x00\x12R\n" +
	"\x12ListenChatOfStream\x12\".streamd.ListenChatOfStreamRequest\x1a\x14.streamd.ChatMessage\"\x000\x01\x12Y\n" +
	"\x11PurgeChatMessages\x12!.streamd.PurgeChatMessagesRequest\x1a\x1f.streamd.PurgeChatMessagesReply\"\x00\x12D\n" +
	"\n" +
	"GetPeerIDs\x12\x1a.streamd.GetPeerIDsRequest\x1a\x18.streamd.GetPeerIDsReply\"\x00\x12G\n" +
	"\vLLMGenerate\x12\x1b.streamd.LLMGenerateRequest\x1a\x19.streamd.LLMGenerateReply\"\x00\x12P\n" +
	"\x0eGetYouTubeInfo\x12\x1e.streamd.GetYouTubeInfoRequest\x1a\x1c.streamd.GetYouTubeInfoReply\"\x00B\x11Z\x0fgo/streamd_grpcb\x06proto3"
...
var file_streamd_proto_msgTypes = make([]protoimpl.MessageInfo, 240)
var file_streamd_proto_goTypes = []any{
	...
	(*GetYouTubeInfoRequest)(nil),                       // 234: streamd.GetYouTubeInfoRequest
	(*GetYouTubeInfoReply)(nil),                         // 235: streamd.GetYouTubeInfoReply
	(*YouTubeQuotaUsage)(nil),                           // 236: streamd.YouTubeQuotaUsage
	(*YouTubeChatListenerInfo)(nil),                     // 237: streamd.YouTubeChatListenerInfo
	(*YouTubeBroadcastSummary)(nil),                     // 238: streamd.YouTubeBroadcastSummary
	(*ResolvePlatformURLRequest)(nil),                   // 239: streamd.ResolvePlatformURLRequest
	(*ResolvePlatformURLReply)(nil),                     // 240: streamd.ResolvePlatformURLReply
	(*ListenChatOfStreamRequest)(nil),                   // 241: streamd.ListenChatOfStreamRequest
	(*PurgeChatMessagesRequest)(nil),                    // 242: streamd.PurgeChatMessagesRequest
	(*PurgeChatMessagesReply)(nil),                      // 243: streamd.PurgeChatMessagesReply
	(*SetBuiltinChatListenerEnabledRequest)(nil),        // 244: streamd.SetBuiltinChatListenerEnabledRequest
	(*SetBuiltinChatListenerEnabledReply)(nil),          // 245: streamd.SetBuiltinChatListenerEnabledReply
	(*IsBuiltinChatListenerEnabledRequest)(nil),         // 246: streamd.IsBuiltinChatListenerEnabledRequest
	(*IsBuiltinChatListenerEnabledReply)(nil),           // 247: streamd.IsBuiltinChatListenerEnabledReply
	nil,                                     // 248: streamd.YouTubeQuotaUsage.PerOperationUsageEntry
	nil,                                     // 249: streamd.YouTubeQuotaUsage.PerOperationRequestCountEntry
	(*player_grpc.OpenRequest)(nil),         // 250: player.OpenRequest
	(*player_grpc.OpenReply)(nil),           // 251: player.OpenReply
	(*player_grpc.ProcessTitleRequest)(nil), // 252: player.ProcessTitleRequest
	(*player_grpc.ProcessTitleReply)(nil),   // 253: player.ProcessTitleReply
	(*player_grpc.GetLinkRequest)(nil),      // 254: player.GetLinkRequest
	(*player_grpc.GetLinkReply)(nil),        // 255: player.GetLinkReply
	(*player_grpc.EndChanRequest)(nil),      // 256: player.EndChanRequest
	(*player_grpc.EndChanReply)(nil),        // 257: player.EndChanReply
	(*player_grpc.IsEndedRequest)(nil),      // 258: player.IsEndedRequest
	(*player_grpc.IsEndedReply)(nil),        // 259: player.IsEndedReply
	(*player_grpc.GetPositionRequest)(nil),  // 260: player.GetPositionRequest
	(*player_grpc.GetPositionReply)(nil),    // 261: player.GetPositionReply
	(*player_grpc.GetLengthRequest)(nil),    // 262: player.GetLengthRequest
	(*player_grpc.GetLengthReply)(nil),      // 263: player.GetLengthReply
	(*player_grpc.SetSpeedRequest)(nil),     // 264: player.SetSpeedRequest
	(*player_grpc.SetSpeedReply)(nil),       // 265: player.SetSpeedReply
	(*player_grpc.SetPauseRequest)(nil),     // 266: player.SetPauseRequest
	(*player_grpc.SetPauseReply)(nil),       // 267: player.SetPauseReply
	(*player_grpc.StopRequest)(nil),         // 268: player.StopRequest
	(*player_grpc.StopReply)(nil),           // 269: player.StopReply
	(*player_grpc.CloseRequest)(nil),        // 270: player.CloseRequest
	(*player_grpc.CloseReply)(nil),          // 271: player.CloseReply
	(*chatwebhook_grpc.Event)(nil),          // 272: chatwebhook.Event
}
var file_streamd_proto_depIdxs = []int32{
	...
	250, // 60: streamd.StreamPlayerOpenRequest.request:type_name -> player.OpenRequest
	251, // 61: streamd.StreamPlayerOpenReply.reply:type_name -> player.OpenReply
	252, // 62: streamd.StreamPlayerProcessTitleRequest.request:type_name -> player.ProcessTitleRequest
	253, // 63: streamd.StreamPlayerProcessTitleReply.reply:type_name -> player.ProcessTitleReply
	254, // 64: streamd.StreamPlayerGetLinkRequest.request:type_name -> player.GetLinkRequest
	255, // 65: streamd.StreamPlayerGetLinkReply.reply:type_name -> player.GetLinkReply
	256, // 66: streamd.StreamPlayerEndChanRequest.request:type_name -> player.EndChanRequest
	257, // 67: streamd.StreamPlayerEndChanReply.reply:type_name -> player.EndChanReply
	258, // 68: streamd.StreamPlayerIsEndedRequest.request:type_name -> player.IsEndedRequest
	259, // 69: streamd.StreamPlayerIsEndedReply.reply:type_name -> player.IsEndedReply
	260, // 70: streamd.StreamPlayerGetPositionRequest.request:type_name -> player.GetPositionRequest
	261, // 71: streamd.StreamPlayerGetPositionReply.reply:type_name -> player.GetPositionReply
	262, // 72: streamd.StreamPlayerGetLengthRequest.request:type_name -> player.GetLengthRequest
	263, // 73: streamd.StreamPlayerGetLengthReply.reply:type_name -> player.GetLengthReply
	264, // 74: streamd.StreamPlayerSetSpeedRequest.request:type_name -> player.SetSpeedRequest
	265, // 75: streamd.StreamPlayerSetSpeedReply.reply:type_name -> player.SetSpeedReply
	266, // 76: streamd.StreamPlayerSetPauseRequest.request:type_name -> player.SetPauseRequest
	267, // 77: streamd.StreamPlayerSetPauseReply.reply:type_name -> player.SetPauseReply
	268, // 78: streamd.StreamPlayerStopRequest.request:type_name -> player.StopRequest
	269, // 79: streamd.StreamPlayerStopReply.reply:type_name -> player.StopReply
	270, // 80: streamd.StreamPlayerCloseRequest.request:type_name -> player.CloseRequest
	271, // 81: streamd.StreamPlayerCloseReply.reply:type_name -> player.CloseReply
	...
	272, // 109: streamd.ChatMessage.content:type_name -> chatwebhook.Event
	272, // 110: streamd.InjectPlatformEventRequest.message:type_name -> chatwebhook.Event
	...
	236, // 113: streamd.GetYouTubeInfoReply.quota_usage:type_name -> streamd.YouTubeQuotaUsage
	237, // 114: streamd.GetYouTubeInfoReply.chat_listeners:type_name -> streamd.YouTubeChatListenerInfo
	238, // 115: streamd.GetYouTubeInfoReply.active_broadcasts:type_name -> streamd.YouTubeBroadcastSummary
	238, // 116: streamd.GetYouTubeInfoReply.upcoming_broadcasts:type_name -> streamd.YouTubeBroadcastSummary
	248, // 117: streamd.YouTubeQuotaUsage.per_operation_usage:type_name -> streamd.YouTubeQuotaUsage.PerOperationUsageEntry
	249, // 118: streamd.YouTubeQuotaUsage.per_operation_request_count:type_name -> streamd.YouTubeQuotaUsage.PerOperationRequestCountEntry
	10,  // 119: streamd.StreamD.Ping:input_type -> streamd.PingRequest
	12,  // 120: streamd.StreamD.SetLoggingLevel:input_type -> streamd.SetLoggingLevelRequest
	14,  // 121: streamd.StreamD.GetLoggingLevel:input_type -> streamd.GetLoggingLevelRequest
	16,  // 122: streamd.StreamD.GetConfig:input_type -> streamd.GetConfigRequest
	18,  // 123: streamd.StreamD.SetConfig:input_type -> streamd.SetConfigRequest
	20,  // 124: streamd.StreamD.SaveConfig:input_type -> streamd.SaveConfigRequest
	168, // 125: streamd.StreamD.SubscribeToConfigChanges:input_type -> streamd.SubscribeToConfigChangesRequest
	22,  // 126: streamd.StreamD.ResetCache:input_type -> streamd.ResetCacheRequest
	24,  // 127: streamd.StreamD.InitCache:input_type -> streamd.InitCacheRequest
	26,  // 128: streamd.StreamD.SetStreamActive:input_type -> streamd.SetStreamActiveRequest
	28,  // 129: streamd.StreamD.GetStreamStatus:input_type -> streamd.GetStreamStatusRequest
	30,  // 130: streamd.StreamD.GetStreams:input_type -> streamd.GetStreamsRequest
	49,  // 131: streamd.StreamD.CreateStream:input_type -> streamd.CreateStreamRequest
	51,  // 132: streamd.StreamD.DeleteStream:input_type -> streamd.DeleteStreamRequest
	33,  // 133: streamd.StreamD.GetAccounts:input_type -> streamd.GetAccountsRequest
	41,  // 134: streamd.StreamD.IsBackendEnabled:input_type -> streamd.IsBackendEnabledRequest
	39,  // 135: streamd.StreamD.GetBackendInfo:input_type -> streamd.GetBackendInfoRequest
	170, // 136: streamd.StreamD.SubscribeToStreamsChanges:input_type -> streamd.SubscribeToStreamsChangesRequest
	43,  // 137: streamd.StreamD.Restart:input_type -> streamd.RestartRequest
	45,  // 138: streamd.StreamD.SetTitle:input_type -> streamd.SetTitleRequest
	47,  // 139: streamd.StreamD.SetDescription:input_type -> streamd.SetDescriptionRequest
	53,  // 140: streamd.StreamD.ApplyProfile:input_type -> streamd.ApplyProfileRequest
	65,  // 141: streamd.StreamD.GetVariable:input_type -> streamd.GetVariableRequest
	67,  // 142: streamd.StreamD.GetVariableHash:input_type -> streamd.GetVariableHashRequest
	69,  // 143: streamd.StreamD.SetVariable:input_type -> streamd.SetVariableRequest
	74,  // 144: streamd.StreamD.SubscribeToVariable:input_type -> streamd.SubscribeToVariableRequest
	35,  // 145: streamd.StreamD.GetActiveStreamIDs:input_type -> streamd.GetActiveStreamIDsRequest
	37,  // 146: streamd.StreamD.GetPlatforms:input_type -> streamd.GetPlatformsRequest
	55,  // 147: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:input_type -> streamd.EXPERIMENTAL_ReinitStreamControllersRequest
	63,  // 148: streamd.StreamD.SubscribeToOAuthRequests:input_type -> streamd.SubscribeToOAuthRequestsRequest
	76,  // 149: streamd.StreamD.SubmitOAuthCode:input_type -> streamd.SubmitOAuthCodeRequest
	83,  // 150: streamd.StreamD.ListStreamServers:input_type -> streamd.ListStreamServersRequest
	85,  // 151: streamd.StreamD.StartStreamServer:input_type -> streamd.StartStreamServerRequest
	87,  // 152: streamd.StreamD.StopStreamServer:input_type -> streamd.StopStreamServerRequest
	172, // 153: streamd.StreamD.SubscribeToStreamServersChanges:input_type -> streamd.SubscribeToStreamServersChangesRequest
	92,  // 154: streamd.StreamD.ListStreamSinks:input_type -> streamd.ListStreamSinksRequest
	94,  // 155: streamd.StreamD.AddStreamSink:input_type -> streamd.AddStreamSinkRequest
	96,  // 156: streamd.StreamD.UpdateStreamSink:input_type -> streamd.UpdateStreamSinkRequest
	232, // 157: streamd.StreamD.GetStreamSinkConfig:input_type -> streamd.GetStreamSinkConfigRequest
	98,  // 158: streamd.StreamD.WaitStreamStarted:input_type -> streamd.WaitStreamStartedRequest
	100, // 159: streamd.StreamD.RemoveStreamSink:input_type -> streamd.RemoveStreamSinkRequest
	174, // 160: streamd.StreamD.SubscribeToStreamSinksChanges:input_type -> streamd.SubscribeToStreamSinksChangesRequest
	103, // 161: streamd.StreamD.AddStreamSource:input_type -> streamd.AddStreamSourceRequest
	105, // 162: streamd.StreamD.RemoveStreamSource:input_type -> streamd.RemoveStreamSourceRequest
	107, // 163: streamd.StreamD.ListStreamSources:input_type -> streamd.ListStreamSourcesRequest
	176, // 164: streamd.StreamD.SubscribeToStreamSourcesChanges:input_type -> streamd.SubscribeToStreamSourcesChangesRequest
	122, // 165: streamd.StreamD.ListStreamForwards:input_type -> streamd.ListStreamForwardsRequest
	124, // 166: streamd.StreamD.AddStreamForward:input_type -> streamd.AddStreamForwardRequest
	126, // 167: streamd.StreamD.UpdateStreamForward:input_type -> streamd.UpdateStreamForwardRequest
	128, // 168: streamd.StreamD.RemoveStreamForward:input_type -> streamd.RemoveStreamForwardRequest
	178, // 169: streamd.StreamD.SubscribeToStreamForwardsChanges:input_type -> streamd.SubscribeToStreamForwardsChangesRequest
	130, // 170: streamd.StreamD.WaitForStreamPublisher:input_type -> streamd.WaitForStreamPublisherRequest
	134, // 171: streamd.StreamD.AddStreamPlayer:input_type -> streamd.AddStreamPlayerRequest
	136, // 172: streamd.StreamD.RemoveStreamPlayer:input_type -> streamd.RemoveStreamPlayerRequest
	138, // 173: streamd.StreamD.UpdateStreamPlayer:input_type -> streamd.UpdateStreamPlayerRequest
	140, // 174: streamd.StreamD.ListStreamPlayers:input_type -> streamd.ListStreamPlayersRequest
	142, // 175: streamd.StreamD.GetStreamPlayer:input_type -> streamd.GetStreamPlayerRequest
	180, // 176: streamd.StreamD.SubscribeToStreamPlayersChanges:input_type -> streamd.SubscribeToStreamPlayersChangesRequest
	144, // 177: streamd.StreamD.StreamPlayerOpen:input_type -> streamd.StreamPlayerOpenRequest
	146, // 178: streamd.StreamD.StreamPlayerProcessTitle:input_type -> streamd.StreamPlayerProcessTitleRequest
	148, // 179: streamd.StreamD.StreamPlayerGetLink:input_type -> streamd.StreamPlayerGetLinkRequest
	150, // 180: streamd.StreamD.StreamPlayerEndChan:input_type -> streamd.StreamPlayerEndChanRequest
	152, // 181: streamd.StreamD.StreamPlayerIsEnded:input_type -> streamd.StreamPlayerIsEndedRequest
	154, // 182: streamd.StreamD.StreamPlayerGetPosition:input_type -> streamd.StreamPlayerGetPositionRequest
	156, // 183: streamd.StreamD.StreamPlayerGetLength:input_type -> streamd.StreamPlayerGetLengthRequest
	158, // 184: streamd.StreamD.StreamPlayerGetLag:input_type -> streamd.StreamPlayerGetLagRequest
	160, // 185: streamd.StreamD.StreamPlayerSetSpeed:input_type -> streamd.StreamPlayerSetSpeedRequest
	162, // 186: streamd.StreamD.StreamPlayerSetPause:input_type -> streamd.StreamPlayerSetPauseRequest
	164, // 187: streamd.StreamD.StreamPlayerStop:input_type -> streamd.StreamPlayerStopRequest
	166, // 188: streamd.StreamD.StreamPlayerClose:input_type -> streamd.StreamPlayerCloseRequest
	187, // 189: streamd.StreamD.AddTimer:input_type -> streamd.AddTimerRequest
	189, // 190: streamd.StreamD.RemoveTimer:input_type -> streamd.RemoveTimerRequest
	192, // 191: streamd.StreamD.ListTimers:input_type -> streamd.ListTimersRequest
	202, // 192: streamd.StreamD.ListTriggerRules:input_type -> streamd.ListTriggerRulesRequest
	204, // 193: streamd.StreamD.AddTriggerRule:input_type -> streamd.AddTriggerRuleRequest
	206, // 194: streamd.StreamD.RemoveTriggerRule:input_type -> streamd.RemoveTriggerRuleRequest
	208, // 195: streamd.StreamD.UpdateTriggerRule:input_type -> streamd.UpdateTriggerRuleRequest
	71,  // 196: streamd.StreamD.ListProfiles:input_type -> streamd.ListProfilesRequest
	210, // 197: streamd.StreamD.SubmitEvent:input_type -> streamd.SubmitEventRequest
	212, // 198: streamd.StreamD.SubscribeToChatMessages:input_type -> streamd.SubscribeToChatMessagesRequest
	214, // 199: streamd.StreamD.SendChatMessage:input_type -> streamd.SendChatMessageRequest
	220, // 200: streamd.StreamD.InjectPlatformEvent:input_type -> streamd.InjectPlatformEventRequest
	216, // 201: streamd.StreamD.RemoveChatMessage:input_type -> streamd.RemoveChatMessageRequest
	218, // 202: streamd.StreamD.BanUser:input_type -> streamd.BanUserRequest
	244, // 203: streamd.StreamD.SetBuiltinChatListenerEnabled:input_type -> streamd.SetBuiltinChatListenerEnabledRequest
	246, // 204: streamd.StreamD.IsBuiltinChatListenerEnabled:input_type -> streamd.IsBuiltinChatListenerEnabledRequest
	222, // 205: streamd.StreamD.Shoutout:input_type -> streamd.ShoutoutRequest
	224, // 206: streamd.StreamD.RaidTo:input_type -> streamd.RaidToRequest
	239, // 207: streamd.StreamD.ResolvePlatformURL:input_type -> streamd.ResolvePlatformURLRequest
	241, // 208: streamd.StreamD.ListenChatOfStream:input_type -> streamd.ListenChatOfStreamRequest
	242, // 209: streamd.StreamD.PurgeChatMessages:input_type -> streamd.PurgeChatMessagesRequest
	226, // 210: streamd.StreamD.GetPeerIDs:input_type -> streamd.GetPeerIDsRequest
	228, // 211: streamd.StreamD.LLMGenerate:input_type -> streamd.LLMGenerateRequest
	234, // 212: streamd.StreamD.GetYouTubeInfo:input_type -> streamd.GetYouTubeInfoRequest
	11,  // 213: streamd.StreamD.Ping:output_type -> streamd.PingReply
	13,  // 214: streamd.StreamD.SetLoggingLevel:output_type -> streamd.SetLoggingLevelReply
	15,  // 215: streamd.StreamD.GetLoggingLevel:output_type -> streamd.GetLoggingLevelReply
	17,  // 216: streamd.StreamD.GetConfig:output_type -> streamd.GetConfigReply
	19,  // 217: streamd.StreamD.SetConfig:output_type -> streamd.SetConfigReply
	21,  // 218: streamd.StreamD.SaveConfig:output_type -> streamd.SaveConfigReply
	169, // 219: streamd.StreamD.SubscribeToConfigChanges:output_type -> streamd.ConfigChange
	23,  // 220: streamd.StreamD.ResetCache:output_type -> streamd.ResetCacheReply
	25,  // 221: streamd.StreamD.InitCache:output_type -> streamd.InitCacheReply
	27,  // 222: streamd.StreamD.SetStreamActive:output_type -> streamd.SetStreamActiveReply
	29,  // 223: streamd.StreamD.GetStreamStatus:output_type -> streamd.GetStreamStatusReply
	32,  // 224: streamd.StreamD.GetStreams:output_type -> streamd.GetStreamsReply
	50,  // 225: streamd.StreamD.CreateStream:output_type -> streamd.CreateStreamReply
	52,  // 226: streamd.StreamD.DeleteStream:output_type -> streamd.DeleteStreamReply
	34,  // 227: streamd.StreamD.GetAccounts:output_type -> streamd.GetAccountsReply
	42,  // 228: streamd.StreamD.IsBackendEnabled:output_type -> streamd.IsBackendEnabledReply
	40,  // 229: streamd.StreamD.GetBackendInfo:output_type -> streamd.GetBackendInfoReply
	171, // 230: streamd.StreamD.SubscribeToStreamsChanges:output_type -> streamd.StreamsChange
	44,  // 231: streamd.StreamD.Restart:output_type -> streamd.RestartReply
	46,  // 232: streamd.StreamD.SetTitle:output_type -> streamd.SetTitleReply
	48,  // 233: streamd.StreamD.SetDescription:output_type -> streamd.SetDescriptionReply
	54,  // 234: streamd.StreamD.ApplyProfile:output_type -> streamd.ApplyProfileReply
	66,  // 235: streamd.StreamD.GetVariable:output_type -> streamd.GetVariableReply
	68,  // 236: streamd.StreamD.GetVariableHash:output_type -> streamd.GetVariableHashReply
	70,  // 237: streamd.StreamD.SetVariable:output_type -> streamd.SetVariableReply
	75,  // 238: streamd.StreamD.SubscribeToVariable:output_type -> streamd.VariableChange
	36,  // 239: streamd.StreamD.GetActiveStreamIDs:output_type -> streamd.GetActiveStreamIDsReply
	38,  // 240: streamd.StreamD.GetPlatforms:output_type -> streamd.GetPlatformsReply
	56,  // 241: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:output_type -> streamd.EXPERIMENTAL_ReinitStreamControllersReply
	64,  // 242: streamd.StreamD.SubscribeToOAuthRequests:output_type -> streamd.OAuthRequest
	77,  // 243: streamd.StreamD.SubmitOAuthCode:output_type -> streamd.SubmitOAuthCodeReply
	84,  // 244: streamd.StreamD.ListStreamServers:output_type -> streamd.ListStreamServersReply
	86,  // 245: streamd.StreamD.StartStreamServer:output_type -> streamd.StartStreamServerReply
	88,  // 246: streamd.StreamD.StopStreamServer:output_type -> streamd.StopStreamServerReply
	173, // 247: streamd.StreamD.SubscribeToStreamServersChanges:output_type -> streamd.StreamServersChange
	93,  // 248: streamd.StreamD.ListStreamSinks:output_type -> streamd.ListStreamSinksReply
	95,  // 249: streamd.StreamD.AddStreamSink:output_type -> streamd.AddStreamSinkReply
	97,  // 250: streamd.StreamD.UpdateStreamSink:output_type -> streamd.UpdateStreamSinkReply
	233, // 251: streamd.StreamD.GetStreamSinkConfig:output_type -> streamd.GetStreamSinkConfigReply
	99,  // 252: streamd.StreamD.WaitStreamStarted:output_type -> streamd.WaitStreamStartedReply
	101, // 253: streamd.StreamD.RemoveStreamSink:output_type -> streamd.RemoveStreamSinkReply
	175, // 254: streamd.StreamD.SubscribeToStreamSinksChanges:output_type -> streamd.StreamSinksChange
	104, // 255: streamd.StreamD.AddStreamSource:output_type -> streamd.AddStreamSourceReply
	106, // 256: streamd.StreamD.RemoveStreamSource:output_type -> streamd.RemoveStreamSourceReply
	108, // 257: streamd.StreamD.ListStreamSources:output_type -> streamd.ListStreamSourcesReply
	177, // 258: streamd.StreamD.SubscribeToStreamSourcesChanges:output_type -> streamd.StreamSourcesChange
	123, // 259: streamd.StreamD.ListStreamForwards:output_type -> streamd.ListStreamForwardsReply
	125, // 260: streamd.StreamD.AddStreamForward:output_type -> streamd.AddStreamForwardReply
	127, // 261: streamd.StreamD.UpdateStreamForward:output_type -> streamd.UpdateStreamForwardReply
	129, // 262: streamd.StreamD.RemoveStreamForward:output_type -> streamd.RemoveStreamForwardReply
	179, // 263: streamd.StreamD.SubscribeToStreamForwardsChanges:output_type -> streamd.StreamForwardsChange
	131, // 264: streamd.StreamD.WaitForStreamPublisher:output_type -> streamd.StreamPublisher
	135, // 265: streamd.StreamD.AddStreamPlayer:output_type -> streamd.AddStreamPlayerReply
	137, // 266: streamd.StreamD.RemoveStreamPlayer:output_type -> streamd.RemoveStreamPlayerReply
	139, // 267: streamd.StreamD.UpdateStreamPlayer:output_type -> streamd.UpdateStreamPlayerReply
	141, // 268: streamd.StreamD.ListStreamPlayers:output_type -> streamd.ListStreamPlayersReply
	143, // 269: streamd.StreamD.GetStreamPlayer:output_type -> streamd.GetStreamPlayerReply
	181, // 270: streamd.StreamD.SubscribeToStreamPlayersChanges:output_type -> streamd.StreamPlayersChange
	145, // 271: streamd.StreamD.StreamPlayerOpen:output_type -> streamd.StreamPlayerOpenReply
	147, // 272: streamd.StreamD.StreamPlayerProcessTitle:output_type -> streamd.StreamPlayerProcessTitleReply
	149, // 273: streamd.StreamD.StreamPlayerGetLink:output_type -> streamd.StreamPlayerGetLinkReply
	151, // 274: streamd.StreamD.StreamPlayerEndChan:output_type -> streamd.StreamPlayerEndChanReply
	153, // 275: streamd.StreamD.StreamPlayerIsEnded:output_type -> streamd.StreamPlayerIsEndedReply
	155, // 276: streamd.StreamD.StreamPlayerGetPosition:output_type -> streamd.StreamPlayerGetPositionReply
	157, // 277: streamd.StreamD.StreamPlayerGetLength:output_type -> streamd.StreamPlayerGetLengthReply
	159, // 278: streamd.StreamD.StreamPlayerGetLag:output_type -> streamd.StreamPlayerGetLagReply
	161, // 279: streamd.StreamD.StreamPlayerSetSpeed:output_type -> streamd.StreamPlayerSetSpeedReply
	163, // 280: streamd.StreamD.StreamPlayerSetPause:output_type -> streamd.StreamPlayerSetPauseReply
	165, // 281: streamd.StreamD.StreamPlayerStop:output_type -> streamd.StreamPlayerStopReply
	167, // 282: streamd.StreamD.StreamPlayerClose:output_type -> streamd.StreamPlayerCloseReply
	188, // 283: streamd.StreamD.AddTimer:output_type -> streamd.AddTimerReply
	190, // 284: streamd.StreamD.RemoveTimer:output_type -> streamd.RemoveTimerReply
	193, // 285: streamd.StreamD.ListTimers:output_type -> streamd.ListTimersReply
	203, // 286: streamd.StreamD.ListTriggerRules:output_type -> streamd.ListTriggerRulesReply
	205, // 287: streamd.StreamD.AddTriggerRule:output_type -> streamd.AddTriggerRuleReply
	207, // 288: streamd.StreamD.RemoveTriggerRule:output_type -> streamd.RemoveTriggerRuleReply
	209, // 289: streamd.StreamD.UpdateTriggerRule:output_type -> streamd.UpdateTriggerRuleReply
	72,  // 290: streamd.StreamD.ListProfiles:output_type -> streamd.ListProfilesReply
	211, // 291: streamd.StreamD.SubmitEvent:output_type -> streamd.SubmitEventReply
	213, // 292: streamd.StreamD.SubscribeToChatMessages:output_type -> streamd.ChatMessage
	215, // 293: streamd.StreamD.SendChatMessage:output_type -> streamd.SendChatMessageReply
	221, // 294: streamd.StreamD.InjectPlatformEvent:output_type -> streamd.InjectPlatformEventReply
	217, // 295: streamd.StreamD.RemoveChatMessage:output_type -> streamd.RemoveChatMessageReply
	219, // 296: streamd.StreamD.BanUser:output_type -> streamd.BanUserReply
	245, // 297: streamd.StreamD.SetBuiltinChatListenerEnabled:output_type -> streamd.SetBuiltinChatListenerEnabledReply
	247, // 298: streamd.StreamD.IsBuiltinChatListenerEnabled:output_type -> streamd.IsBuiltinChatListenerEnabledReply
	223, // 299: streamd.StreamD.Shoutout:output_type -> streamd.ShoutoutReply
	225, // 300: streamd.StreamD.RaidTo:output_type -> streamd.RaidToReply
	240, // 301: streamd.StreamD.ResolvePlatformURL:output_type -> streamd.ResolvePlatformURLReply
	213, // 302: streamd.StreamD.ListenChatOfStream:output_type -> streamd.ChatMessage
	243, // 303: streamd.StreamD.PurgeChatMessages:output_type -> streamd.PurgeChatMessagesReply
	227, // 304: streamd.StreamD.GetPeerIDs:output_type -> streamd.GetPeerIDsReply
	229, // 305: streamd.StreamD.LLMGenerate:output_type -> streamd.LLMGenerateReply
	235, // 306: streamd.StreamD.GetYouTubeInfo:output_type -> streamd.GetYouTubeInfoReply
	213, // [213:307] is the sub-list for method output_type
	119, // [119:213] is the sub-list for method input_type
...
func file_streamd_proto_init() {
	...
	file_streamd_proto_msgTypes[202].OneofWrappers = []any{}
	file_streamd_proto_msgTypes[208].OneofWrappers = []any{}
	file_streamd_proto_msgTypes[226].OneofWrappers = []any{}
	file_streamd_proto_msgTypes[232].OneofWrappers = []any{}
	type x struct{}
