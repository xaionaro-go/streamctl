...
const file_streamd_proto_rawDesc = "" +
	...
	"\fremovedCount\x18\x01 \x01(\x04R\fremovedCount*f\n" +
	"\fLoggingLevel\x12\b\n" +
	"\x04none\x10\x00\x12\t\n" +
	...
	"\x15TEXT_FORMAT_TYPE_HTML\x10\x032\xce>\n" +
	"\aStreamD\x122\n" +
...
var file_streamd_proto_msgTypes = make([]protoimpl.MessageInfo, 236)
var file_streamd_proto_goTypes = []any{
	...
	nil,                                                 // 244: streamd.YouTubeQuotaUsage.PerOperationUsageEntry
	nil,                                                 // 245: streamd.YouTubeQuotaUsage.PerOperationRequestCountEntry
	(*player_grpc.OpenRequest)(nil),                     // 246: player.OpenRequest
	(*player_grpc.OpenReply)(nil),                       // 247: player.OpenReply
	(*player_grpc.ProcessTitleRequest)(nil),             // 248: player.ProcessTitleRequest
	(*player_grpc.ProcessTitleReply)(nil),               // 249: player.ProcessTitleReply
	(*player_grpc.GetLinkRequest)(nil),                  // 250: player.GetLinkRequest
	(*player_grpc.GetLinkReply)(nil),                    // 251: player.GetLinkReply
	(*player_grpc.EndChanRequest)(nil),                  // 252: player.EndChanRequest
	(*player_grpc.EndChanReply)(nil),                    // 253: player.EndChanReply
	(*player_grpc.IsEndedRequest)(nil),                  // 254: player.IsEndedRequest
	(*player_grpc.IsEndedReply)(nil),                    // 255: player.IsEndedReply
	(*player_grpc.GetPositionRequest)(nil),              // 256: player.GetPositionRequest
	(*player_grpc.GetPositionReply)(nil),                // 257: player.GetPositionReply
	(*player_grpc.GetLengthRequest)(nil),                // 258: player.GetLengthRequest
	(*player_grpc.GetLengthReply)(nil),                  // 259: player.GetLengthReply
	(*player_grpc.SetSpeedRequest)(nil),                 // 260: player.SetSpeedRequest
	(*player_grpc.SetSpeedReply)(nil),                   // 261: player.SetSpeedReply
	(*player_grpc.SetPauseRequest)(nil),                 // 262: player.SetPauseRequest
	(*player_grpc.SetPauseReply)(nil),                   // 263: player.SetPauseReply
	(*player_grpc.StopRequest)(nil),                     // 264: player.StopRequest
	(*player_grpc.StopReply)(nil),                       // 265: player.StopReply
	(*player_grpc.CloseRequest)(nil),                    // 266: player.CloseRequest
	(*player_grpc.CloseReply)(nil),                      // 267: player.CloseReply
	(*chatwebhook_grpc.Event)(nil),                      // 268: chatwebhook.Event
}
var file_streamd_proto_depIdxs = []int32{
	...
	246, // 60: streamd.StreamPlayerOpenRequest.request:type_name -> player.OpenRequest
	247, // 61: streamd.StreamPlayerOpenReply.reply:type_name -> player.OpenReply
	248, // 62: streamd.StreamPlayerProcessTitleRequest.request:type_name -> player.ProcessTitleRequest
	249, // 63: streamd.StreamPlayerProcessTitleReply.reply:type_name -> player.ProcessTitleReply
	250, // 64: streamd.StreamPlayerGetLinkRequest.request:type_name -> player.GetLinkRequest
	251, // 65: streamd.StreamPlayerGetLinkReply.reply:type_name -> player.GetLinkReply
	252, // 66: streamd.StreamPlayerEndChanRequest.request:type_name -> player.EndChanRequest
	253, // 67: streamd.StreamPlayerEndChanReply.reply:type_name -> player.EndChanReply
	254, // 68: streamd.StreamPlayerIsEndedRequest.request:type_name -> player.IsEndedRequest
	255, // 69: streamd.StreamPlayerIsEndedReply.reply:type_name -> player.IsEndedReply
	256, // 70: streamd.StreamPlayerGetPositionRequest.request:type_name -> player.GetPositionRequest
	257, // 71: streamd.StreamPlayerGetPositionReply.reply:type_name -> player.GetPositionReply
	258, // 72: streamd.StreamPlayerGetLengthRequest.request:type_name -> player.GetLengthRequest
	259, // 73: streamd.StreamPlayerGetLengthReply.reply:type_name -> player.GetLengthReply
	260, // 74: streamd.StreamPlayerSetSpeedRequest.request:type_name -> player.SetSpeedRequest
	261, // 75: streamd.StreamPlayerSetSpeedReply.reply:type_name -> player.SetSpeedReply
	262, // 76: streamd.StreamPlayerSetPauseRequest.request:type_name -> player.SetPauseRequest
	263, // 77: streamd.StreamPlayerSetPauseReply.reply:type_name -> player.SetPauseReply
	264, // 78: streamd.StreamPlayerStopRequest.request:type_name -> player.StopRequest
	265, // 79: streamd.StreamPlayerStopReply.reply:type_name -> player.StopReply
	266, // 80: streamd.StreamPlayerCloseRequest.request:type_name -> player.CloseRequest
	267, // 81: streamd.StreamPlayerCloseReply.reply:type_name -> player.CloseReply
	...
	268, // 109: streamd.ChatMessage.content:type_name -> chatwebhook.Event
	268, // 110: streamd.InjectPlatformEventRequest.message:type_name -> chatwebhook.Event
	...
	244, // 117: streamd.YouTubeQuotaUsage.per_operation_usage:type_name -> streamd.YouTubeQuotaUsage.PerOperationUsageEntry
	245, // 118: streamd.YouTubeQuotaUsage.per_operation_request_count:type_name -> streamd.YouTubeQuotaUsage.PerOperationRequestCountEntry
	...
	222, // 203: streamd.StreamD.Shoutout:input_type -> streamd.ShoutoutRequest
	224, // 204: streamd.StreamD.RaidTo:input_type -> streamd.RaidToRequest
	239, // 205: streamd.StreamD.ResolvePlatformURL:input_type -> streamd.ResolvePlatformURLRequest
	241, // 206: streamd.StreamD.ListenChatOfStream:input_type -> streamd.ListenChatOfStreamRequest
	242, // 207: streamd.StreamD.PurgeChatMessages:input_type -> streamd.PurgeChatMessagesRequest
	226, // 208: streamd.StreamD.GetPeerIDs:input_type -> streamd.GetPeerIDsRequest
	228, // 209: streamd.StreamD.LLMGenerate:input_type -> streamd.LLMGenerateRequest
	234, // 210: streamd.StreamD.GetYouTubeInfo:input_type -> streamd.GetYouTubeInfoRequest
	11,  // 211: streamd.StreamD.Ping:output_type -> streamd.PingReply
	13,  // 212: streamd.StreamD.SetLoggingLevel:output_type -> streamd.SetLoggingLevelReply
	15,  // 213: streamd.StreamD.GetLoggingLevel:output_type -> streamd.GetLoggingLevelReply
	17,  // 214: streamd.StreamD.GetConfig:output_type -> streamd.GetConfigReply
	19,  // 215: streamd.StreamD.SetConfig:output_type -> streamd.SetConfigReply
	21,  // 216: streamd.StreamD.SaveConfig:output_type -> streamd.SaveConfigReply
	169, // 217: streamd.StreamD.SubscribeToConfigChanges:output_type -> streamd.ConfigChange
	23,  // 218: streamd.StreamD.ResetCache:output_type -> streamd.ResetCacheReply
	25,  // 219: streamd.StreamD.InitCache:output_type -> streamd.InitCacheReply
	27,  // 220: streamd.StreamD.SetStreamActive:output_type -> streamd.SetStreamActiveReply
	29,  // 221: streamd.StreamD.GetStreamStatus:output_type -> streamd.GetStreamStatusReply
	32,  // 222: streamd.StreamD.GetStreams:output_type -> streamd.GetStreamsReply
	50,  // 223: streamd.StreamD.CreateStream:output_type -> streamd.CreateStreamReply
	52,  // 224: streamd.StreamD.DeleteStream:output_type -> streamd.DeleteStreamReply
	34,  // 225: streamd.StreamD.GetAccounts:output_type -> streamd.GetAccountsReply
	42,  // 226: streamd.StreamD.IsBackendEnabled:output_type -> streamd.IsBackendEnabledReply
	40,  // 227: streamd.StreamD.GetBackendInfo:output_type -> streamd.GetBackendInfoReply
	171, // 228: streamd.StreamD.SubscribeToStreamsChanges:output_type -> streamd.StreamsChange
	44,  // 229: streamd.StreamD.Restart:output_type -> streamd.RestartReply
	46,  // 230: streamd.StreamD.SetTitle:output_type -> streamd.SetTitleReply
	48,  // 231: streamd.StreamD.SetDescription:output_type -> streamd.SetDescriptionReply
	54,  // 232: streamd.StreamD.ApplyProfile:output_type -> streamd.ApplyProfileReply
	66,  // 233: streamd.StreamD.GetVariable:output_type -> streamd.GetVariableReply
	68,  // 234: streamd.StreamD.GetVariableHash:output_type -> streamd.GetVariableHashReply
	70,  // 235: streamd.StreamD.SetVariable:output_type -> streamd.SetVariableReply
	75,  // 236: streamd.StreamD.SubscribeToVariable:output_type -> streamd.VariableChange
	36,  // 237: streamd.StreamD.GetActiveStreamIDs:output_type -> streamd.GetActiveStreamIDsReply
	38,  // 238: streamd.StreamD.GetPlatforms:output_type -> streamd.GetPlatformsReply
	56,  // 239: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:output_type -> streamd.EXPERIMENTAL_ReinitStreamControllersReply
	64,  // 240: streamd.StreamD.SubscribeToOAuthRequests:output_type -> streamd.OAuthRequest
	77,  // 241: streamd.StreamD.SubmitOAuthCode:output_type -> streamd.SubmitOAuthCodeReply
	84,  // 242: streamd.StreamD.ListStreamServers:output_type -> streamd.ListStreamServersReply
	86,  // 243: streamd.StreamD.StartStreamServer:output_type -> streamd.StartStreamServerReply
	88,  // 244: streamd.StreamD.StopStreamServer:output_type -> streamd.StopStreamServerReply
	173, // 245: streamd.StreamD.SubscribeToStreamServersChanges:output_type -> streamd.StreamServersChange
	93,  // 246: streamd.StreamD.ListStreamSinks:output_type -> streamd.ListStreamSinksReply
	95,  // 247: streamd.StreamD.AddStreamSink:output_type -> streamd.AddStreamSinkReply
	97,  // 248: streamd.StreamD.UpdateStreamSink:output_type -> streamd.UpdateStreamSinkReply
	233, // 249: streamd.StreamD.GetStreamSinkConfig:output_type -> streamd.GetStreamSinkConfigReply
	99,  // 250: streamd.StreamD.WaitStreamStarted:output_type -> streamd.WaitStreamStartedReply
	101, // 251: streamd.StreamD.RemoveStreamSink:output_type -> streamd.RemoveStreamSinkReply
	175, // 252: streamd.StreamD.SubscribeToStreamSinksChanges:output_type -> streamd.StreamSinksChange
	104, // 253: streamd.StreamD.AddStreamSource:output_type -> streamd.AddStreamSourceReply
	106, // 254: streamd.StreamD.RemoveStreamSource:output_type -> streamd.RemoveStreamSourceReply
	108, // 255: streamd.StreamD.ListStreamSources:output_type -> streamd.ListStreamSourcesReply
	177, // 256: streamd.StreamD.SubscribeToStreamSourcesChanges:output_type -> streamd.StreamSourcesChange
	123, // 257: streamd.StreamD.ListStreamForwards:output_type -> streamd.ListStreamForwardsReply
	125, // 258: streamd.StreamD.AddStreamForward:output_type -> streamd.AddStreamForwardReply
	127, // 259: streamd.StreamD.UpdateStreamForward:output_type -> streamd.UpdateStreamForwardReply
	129, // 260: streamd.StreamD.RemoveStreamForward:output_type -> streamd.RemoveStreamForwardReply
	179, // 261: streamd.StreamD.SubscribeToStreamForwardsChanges:output_type -> streamd.StreamForwardsChange
	131, // 262: streamd.StreamD.WaitForStreamPublisher:output_type -> streamd.StreamPublisher
	135, // 263: streamd.StreamD.AddStreamPlayer:output_type -> streamd.AddStreamPlayerReply
	137, // 264: streamd.StreamD.RemoveStreamPlayer:output_type -> streamd.RemoveStreamPlayerReply
	139, // 265: streamd.StreamD.UpdateStreamPlayer:output_type -> streamd.UpdateStreamPlayerReply
	141, // 266: streamd.StreamD.ListStreamPlayers:output_type -> streamd.ListStreamPlayersReply
	143, // 267: streamd.StreamD.GetStreamPlayer:output_type -> streamd.GetStreamPlayerReply
	181, // 268: streamd.StreamD.SubscribeToStreamPlayersChanges:output_type -> streamd.StreamPlayersChange
	145, // 269: streamd.StreamD.StreamPlayerOpen:output_type -> streamd.StreamPlayerOpenReply
	147, // 270: streamd.StreamD.StreamPlayerProcessTitle:output_type -> streamd.StreamPlayerProcessTitleReply
	149, // 271: streamd.StreamD.StreamPlayerGetLink:output_type -> streamd.StreamPlayerGetLinkReply
	151, // 272: streamd.StreamD.StreamPlayerEndChan:output_type -> streamd.StreamPlayerEndChanReply
	153, // 273: streamd.StreamD.StreamPlayerIsEnded:output_type -> streamd.StreamPlayerIsEndedReply
	155, // 274: streamd.StreamD.StreamPlayerGetPosition:output_type -> streamd.StreamPlayerGetPositionReply
	157, // 275: streamd.StreamD.StreamPlayerGetLength:output_type -> streamd.StreamPlayerGetLengthReply
	159, // 276: streamd.StreamD.StreamPlayerGetLag:output_type -> streamd.StreamPlayerGetLagReply
	161, // 277: streamd.StreamD.StreamPlayerSetSpeed:output_type -> streamd.StreamPlayerSetSpeedReply
	163, // 278: streamd.StreamD.StreamPlayerSetPause:output_type -> streamd.StreamPlayerSetPauseReply
	165, // 279: streamd.StreamD.StreamPlayerStop:output_type -> streamd.StreamPlayerStopReply
	167, // 280: streamd.StreamD.StreamPlayerClose:output_type -> streamd.StreamPlayerCloseReply
	188, // 281: streamd.StreamD.AddTimer:output_type -> streamd.AddTimerReply
	190, // 282: streamd.StreamD.RemoveTimer:output_type -> streamd.RemoveTimerReply
	193, // 283: streamd.StreamD.ListTimers:output_type -> streamd.ListTimersReply
	203, // 284: streamd.StreamD.ListTriggerRules:output_type -> streamd.ListTriggerRulesReply
	205, // 285: streamd.StreamD.AddTriggerRule:output_type -> streamd.AddTriggerRuleReply
	207, // 286: streamd.StreamD.RemoveTriggerRule:output_type -> streamd.RemoveTriggerRuleReply
	209, // 287: streamd.StreamD.UpdateTriggerRule:output_type -> streamd.UpdateTriggerRuleReply
	72,  // 288: streamd.StreamD.ListProfiles:output_type -> streamd.ListProfilesReply
	211, // 289: streamd.StreamD.SubmitEvent:output_type -> streamd.SubmitEventReply
	213, // 290: streamd.StreamD.SubscribeToChatMessages:output_type -> streamd.ChatMessage
	215, // 291: streamd.StreamD.SendChatMessage:output_type -> streamd.SendChatMessageReply
	221, // 292: streamd.StreamD.InjectPlatformEvent:output_type -> streamd.InjectPlatformEventReply
	217, // 293: streamd.StreamD.RemoveChatMessage:output_type -> streamd.RemoveChatMessageReply
	219, // 294: streamd.StreamD.BanUser:output_type -> streamd.BanUserReply
	223, // 295: streamd.StreamD.Shoutout:output_type -> streamd.ShoutoutReply
	225, // 296: streamd.StreamD.RaidTo:output_type -> streamd.RaidToReply
	240, // 297: streamd.StreamD.ResolvePlatformURL:output_type -> streamd.ResolvePlatformURLReply
	213, // 298: streamd.StreamD.ListenChatOfStream:output_type -> streamd.ChatMessage
	243, // 299: streamd.StreamD.PurgeChatMessages:output_type -> streamd.PurgeChatMessagesReply
	227, // 300: streamd.StreamD.GetPeerIDs:output_type -> streamd.GetPeerIDsReply
	229, // 301: streamd.StreamD.LLMGenerate:output_type -> streamd.LLMGenerateReply
	235, // 302: streamd.StreamD.GetYouTubeInfo:output_type -> streamd.GetYouTubeInfoReply
	211, // [211:303] is the sub-list for method output_type
	119, // [119:211] is the sub-list for method input_type
