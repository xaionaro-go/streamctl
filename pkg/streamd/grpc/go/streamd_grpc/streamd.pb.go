...
var file_streamd_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x75, 0x0a,
	...
	0x09, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x2a, 0x66, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x4c,
	...
	0x65, 0x6e, 0x65, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x10, 0x01, 0x32, 0xb0, 0x34, 0x0a, 0x07,
	...
	0x68, 0x61, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x00, 0x30, 0x01, 0x42, 0x11,
...
var file_streamd_proto_msgTypes = make([]protoimpl.MessageInfo, 177)
var file_streamd_proto_goTypes = []interface{}{
	...
	(*player_grpc.OpenRequest)(nil),                     // 182: player.OpenRequest
	(*player_grpc.OpenReply)(nil),                       // 183: player.OpenReply
	(*player_grpc.ProcessTitleRequest)(nil),             // 184: player.ProcessTitleRequest
	(*player_grpc.ProcessTitleReply)(nil),               // 185: player.ProcessTitleReply
	(*player_grpc.GetLinkRequest)(nil),                  // 186: player.GetLinkRequest
	(*player_grpc.GetLinkReply)(nil),                    // 187: player.GetLinkReply
	(*player_grpc.EndChanRequest)(nil),                  // 188: player.EndChanRequest
	(*player_grpc.EndChanReply)(nil),                    // 189: player.EndChanReply
	(*player_grpc.IsEndedRequest)(nil),                  // 190: player.IsEndedRequest
	(*player_grpc.IsEndedReply)(nil),                    // 191: player.IsEndedReply
	(*player_grpc.GetPositionRequest)(nil),              // 192: player.GetPositionRequest
	(*player_grpc.GetPositionReply)(nil),                // 193: player.GetPositionReply
	(*player_grpc.GetLengthRequest)(nil),                // 194: player.GetLengthRequest
	(*player_grpc.GetLengthReply)(nil),                  // 195: player.GetLengthReply
	(*player_grpc.SetSpeedRequest)(nil),                 // 196: player.SetSpeedRequest
	(*player_grpc.SetSpeedReply)(nil),                   // 197: player.SetSpeedReply
	(*player_grpc.SetPauseRequest)(nil),                 // 198: player.SetPauseRequest
	(*player_grpc.SetPauseReply)(nil),                   // 199: player.SetPauseReply
	(*player_grpc.StopRequest)(nil),                     // 200: player.StopRequest
	(*player_grpc.StopReply)(nil),                       // 201: player.StopReply
	(*player_grpc.CloseRequest)(nil),                    // 202: player.CloseRequest
	(*player_grpc.CloseReply)(nil),                      // 203: player.CloseReply
}
var file_streamd_proto_depIdxs = []int32{
	...
	182, // 30: streamd.StreamPlayerOpenRequest.request:type_name -> player.OpenRequest
	183, // 31: streamd.StreamPlayerOpenReply.reply:type_name -> player.OpenReply
	184, // 32: streamd.StreamPlayerProcessTitleRequest.request:type_name -> player.ProcessTitleRequest
	185, // 33: streamd.StreamPlayerProcessTitleReply.reply:type_name -> player.ProcessTitleReply
	186, // 34: streamd.StreamPlayerGetLinkRequest.request:type_name -> player.GetLinkRequest
	187, // 35: streamd.StreamPlayerGetLinkReply.reply:type_name -> player.GetLinkReply
	188, // 36: streamd.StreamPlayerEndChanRequest.request:type_name -> player.EndChanRequest
	189, // 37: streamd.StreamPlayerEndChanReply.reply:type_name -> player.EndChanReply
	190, // 38: streamd.StreamPlayerIsEndedRequest.request:type_name -> player.IsEndedRequest
	191, // 39: streamd.StreamPlayerIsEndedReply.reply:type_name -> player.IsEndedReply
	192, // 40: streamd.StreamPlayerGetPositionRequest.request:type_name -> player.GetPositionRequest
	193, // 41: streamd.StreamPlayerGetPositionReply.reply:type_name -> player.GetPositionReply
	194, // 42: streamd.StreamPlayerGetLengthRequest.request:type_name -> player.GetLengthRequest
	195, // 43: streamd.StreamPlayerGetLengthReply.reply:type_name -> player.GetLengthReply
	196, // 44: streamd.StreamPlayerSetSpeedRequest.request:type_name -> player.SetSpeedRequest
	197, // 45: streamd.StreamPlayerSetSpeedReply.reply:type_name -> player.SetSpeedReply
	198, // 46: streamd.StreamPlayerSetPauseRequest.request:type_name -> player.SetPauseRequest
	199, // 47: streamd.StreamPlayerSetPauseReply.reply:type_name -> player.SetPauseReply
	200, // 48: streamd.StreamPlayerStopRequest.request:type_name -> player.StopRequest
	201, // 49: streamd.StreamPlayerStopReply.reply:type_name -> player.StopReply
	202, // 50: streamd.StreamPlayerCloseRequest.request:type_name -> player.CloseRequest
	203, // 51: streamd.StreamPlayerCloseReply.reply:type_name -> player.CloseReply
	...
	6,   // 151: streamd.StreamD.Ping:output_type -> streamd.PingReply
	8,   // 152: streamd.StreamD.SetLoggingLevel:output_type -> streamd.SetLoggingLevelReply
	10,  // 153: streamd.StreamD.GetLoggingLevel:output_type -> streamd.GetLoggingLevelReply
	12,  // 154: streamd.StreamD.GetConfig:output_type -> streamd.GetConfigReply
	14,  // 155: streamd.StreamD.SetConfig:output_type -> streamd.SetConfigReply
	16,  // 156: streamd.StreamD.SaveConfig:output_type -> streamd.SaveConfigReply
	137, // 157: streamd.StreamD.SubscribeToConfigChanges:output_type -> streamd.ConfigChange
	18,  // 158: streamd.StreamD.ResetCache:output_type -> streamd.ResetCacheReply
	20,  // 159: streamd.StreamD.InitCache:output_type -> streamd.InitCacheReply
	22,  // 160: streamd.StreamD.StartStream:output_type -> streamd.StartStreamReply
	24,  // 161: streamd.StreamD.EndStream:output_type -> streamd.EndStreamReply
	26,  // 162: streamd.StreamD.GetStreamStatus:output_type -> streamd.GetStreamStatusReply
	30,  // 163: streamd.StreamD.IsBackendEnabled:output_type -> streamd.IsBackendEnabledReply
	28,  // 164: streamd.StreamD.GetBackendInfo:output_type -> streamd.GetBackendInfoReply
	139, // 165: streamd.StreamD.SubscribeToStreamsChanges:output_type -> streamd.StreamsChange
	32,  // 166: streamd.StreamD.Restart:output_type -> streamd.RestartReply
	34,  // 167: streamd.StreamD.SetTitle:output_type -> streamd.SetTitleReply
	36,  // 168: streamd.StreamD.SetDescription:output_type -> streamd.SetDescriptionReply
	38,  // 169: streamd.StreamD.ApplyProfile:output_type -> streamd.ApplyProfileReply
	40,  // 170: streamd.StreamD.UpdateStream:output_type -> streamd.UpdateStreamReply
	52,  // 171: streamd.StreamD.GetVariable:output_type -> streamd.GetVariableReply
	54,  // 172: streamd.StreamD.GetVariableHash:output_type -> streamd.GetVariableHashReply
	56,  // 173: streamd.StreamD.SetVariable:output_type -> streamd.SetVariableReply
	42,  // 174: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:output_type -> streamd.EXPERIMENTAL_ReinitStreamControllersReply
	44,  // 175: streamd.StreamD.OBSOLETE_FetchConfig:output_type -> streamd.OBSOLETE_FetchConfigReply
	46,  // 176: streamd.StreamD.OBSOLETE_GitInfo:output_type -> streamd.OBSOLETE_GetGitInfoReply
	48,  // 177: streamd.StreamD.OBSOLETE_GitRelogin:output_type -> streamd.OBSOLETE_GitReloginReply
	50,  // 178: streamd.StreamD.SubscribeToOAuthRequests:output_type -> streamd.OAuthRequest
	58,  // 179: streamd.StreamD.SubmitOAuthCode:output_type -> streamd.SubmitOAuthCodeReply
	65,  // 180: streamd.StreamD.ListStreamServers:output_type -> streamd.ListStreamServersReply
	67,  // 181: streamd.StreamD.StartStreamServer:output_type -> streamd.StartStreamServerReply
	69,  // 182: streamd.StreamD.StopStreamServer:output_type -> streamd.StopStreamServerReply
	141, // 183: streamd.StreamD.SubscribeToStreamServersChanges:output_type -> streamd.StreamServersChange
	72,  // 184: streamd.StreamD.ListStreamDestinations:output_type -> streamd.ListStreamDestinationsReply
	74,  // 185: streamd.StreamD.AddStreamDestination:output_type -> streamd.AddStreamDestinationReply
	76,  // 186: streamd.StreamD.UpdateStreamDestination:output_type -> streamd.UpdateStreamDestinationReply
	78,  // 187: streamd.StreamD.RemoveStreamDestination:output_type -> streamd.RemoveStreamDestinationReply
	143, // 188: streamd.StreamD.SubscribeToStreamDestinationsChanges:output_type -> streamd.StreamDestinationsChange
	81,  // 189: streamd.StreamD.AddIncomingStream:output_type -> streamd.AddIncomingStreamReply
	83,  // 190: streamd.StreamD.RemoveIncomingStream:output_type -> streamd.RemoveIncomingStreamReply
	85,  // 191: streamd.StreamD.ListIncomingStreams:output_type -> streamd.ListIncomingStreamsReply
	145, // 192: streamd.StreamD.SubscribeToIncomingStreamsChanges:output_type -> streamd.IncomingStreamsChange
	93,  // 193: streamd.StreamD.ListStreamForwards:output_type -> streamd.ListStreamForwardsReply
	95,  // 194: streamd.StreamD.AddStreamForward:output_type -> streamd.AddStreamForwardReply
	97,  // 195: streamd.StreamD.UpdateStreamForward:output_type -> streamd.UpdateStreamForwardReply
	99,  // 196: streamd.StreamD.RemoveStreamForward:output_type -> streamd.RemoveStreamForwardReply
	147, // 197: streamd.StreamD.SubscribeToStreamForwardsChanges:output_type -> streamd.StreamForwardsChange
	101, // 198: streamd.StreamD.WaitForStreamPublisher:output_type -> streamd.StreamPublisher
	105, // 199: streamd.StreamD.AddStreamPlayer:output_type -> streamd.AddStreamPlayerReply
	107, // 200: streamd.StreamD.RemoveStreamPlayer:output_type -> streamd.RemoveStreamPlayerReply
	109, // 201: streamd.StreamD.UpdateStreamPlayer:output_type -> streamd.UpdateStreamPlayerReply
	111, // 202: streamd.StreamD.ListStreamPlayers:output_type -> streamd.ListStreamPlayersReply
	113, // 203: streamd.StreamD.GetStreamPlayer:output_type -> streamd.GetStreamPlayerReply
	149, // 204: streamd.StreamD.SubscribeToStreamPlayersChanges:output_type -> streamd.StreamPlayersChange
	115, // 205: streamd.StreamD.StreamPlayerOpen:output_type -> streamd.StreamPlayerOpenReply
	117, // 206: streamd.StreamD.StreamPlayerProcessTitle:output_type -> streamd.StreamPlayerProcessTitleReply
	119, // 207: streamd.StreamD.StreamPlayerGetLink:output_type -> streamd.StreamPlayerGetLinkReply
	121, // 208: streamd.StreamD.StreamPlayerEndChan:output_type -> streamd.StreamPlayerEndChanReply
	123, // 209: streamd.StreamD.StreamPlayerIsEnded:output_type -> streamd.StreamPlayerIsEndedReply
	125, // 210: streamd.StreamD.StreamPlayerGetPosition:output_type -> streamd.StreamPlayerGetPositionReply
	127, // 211: streamd.StreamD.StreamPlayerGetLength:output_type -> streamd.StreamPlayerGetLengthReply
	129, // 212: streamd.StreamD.StreamPlayerSetSpeed:output_type -> streamd.StreamPlayerSetSpeedReply
	131, // 213: streamd.StreamD.StreamPlayerSetPause:output_type -> streamd.StreamPlayerSetPauseReply
	133, // 214: streamd.StreamD.StreamPlayerStop:output_type -> streamd.StreamPlayerStopReply
	135, // 215: streamd.StreamD.StreamPlayerClose:output_type -> streamd.StreamPlayerCloseReply
	156, // 216: streamd.StreamD.AddTimer:output_type -> streamd.AddTimerReply
	158, // 217: streamd.StreamD.RemoveTimer:output_type -> streamd.RemoveTimerReply
	161, // 218: streamd.StreamD.ListTimers:output_type -> streamd.ListTimersReply
	171, // 219: streamd.StreamD.ListTriggerRules:output_type -> streamd.ListTriggerRulesReply
	173, // 220: streamd.StreamD.AddTriggerRule:output_type -> streamd.AddTriggerRuleReply
	175, // 221: streamd.StreamD.RemoveTriggerRule:output_type -> streamd.RemoveTriggerRuleReply
	177, // 222: streamd.StreamD.UpdateTriggerRule:output_type -> streamd.UpdateTriggerRuleReply
	179, // 223: streamd.StreamD.SubmitEvent:output_type -> streamd.SubmitEventReply
	181, // 224: streamd.StreamD.SubscribeToChatMessages:output_type -> streamd.ChatMessage
	151, // [151:225] is the sub-list for method output_type
	77,  // [77:151] is the sub-list for method input_type
