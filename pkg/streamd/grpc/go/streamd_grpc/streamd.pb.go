...
const file_streamd_proto_rawDesc = "" +
	"\n" +
	"\rstreamd.proto\x12\astreamd\x1a!streamcontrol/streamcontrol.proto\x1a\x16chat/chatwebhook.proto\x1a\x13player/player.proto\"\x9b\x01\n" +
	"\vPingRequest\x12(\n" +
	...
	"\x14SendChatMessageReply\"\\\n" +
	"\x18InjectChatMessageRequest\x12\x16\n" +
	"\x06platID\x18\x01 \x01(\tR\x06platID\x12(\n" +
	"\x05event\x18\x02 \x01(\v2\x12.chatwebhook.EventR\x05event\"\x18\n" +
	"\x16InjectChatMessageReply\"P\n" +
	...
	"\x15TEXT_FORMAT_TYPE_HTML\x10\x032\xd1;\n" +
	"\aStreamD\x122\n" +
...
var file_streamd_proto_msgTypes = make([]protoimpl.MessageInfo, 212)
var file_streamd_proto_goTypes = []any{
	...
	(*RemoveChatMessageRequest)(nil),                    // 205: streamd.RemoveChatMessageRequest
	(*RemoveChatMessageReply)(nil),                      // 206: streamd.RemoveChatMessageReply
	(*BanUserRequest)(nil),                              // 207: streamd.BanUserRequest
	(*BanUserReply)(nil),                                // 208: streamd.BanUserReply
	(*ShoutoutRequest)(nil),                             // 209: streamd.ShoutoutRequest
	(*ShoutoutReply)(nil),                               // 210: streamd.ShoutoutReply
	(*RaidToRequest)(nil),                               // 211: streamd.RaidToRequest
	(*RaidToReply)(nil),                                 // 212: streamd.RaidToReply
	(*GetPeerIDsRequest)(nil),                           // 213: streamd.GetPeerIDsRequest
	(*GetPeerIDsReply)(nil),                             // 214: streamd.GetPeerIDsReply
	(*LLMGenerateRequest)(nil),                          // 215: streamd.LLMGenerateRequest
	(*LLMGenerateReply)(nil),                            // 216: streamd.LLMGenerateReply
	(*SetBuiltinChatListenerEnabledRequest)(nil),        // 217: streamd.SetBuiltinChatListenerEnabledRequest
	(*SetBuiltinChatListenerEnabledReply)(nil),          // 218: streamd.SetBuiltinChatListenerEnabledReply
	(*IsBuiltinChatListenerEnabledRequest)(nil),         // 219: streamd.IsBuiltinChatListenerEnabledRequest
	(*IsBuiltinChatListenerEnabledReply)(nil),           // 220: streamd.IsBuiltinChatListenerEnabledReply
	(*player_grpc.OpenRequest)(nil),                     // 221: player.OpenRequest
	(*player_grpc.OpenReply)(nil),                       // 222: player.OpenReply
	(*player_grpc.ProcessTitleRequest)(nil),             // 223: player.ProcessTitleRequest
	(*player_grpc.ProcessTitleReply)(nil),               // 224: player.ProcessTitleReply
	(*player_grpc.GetLinkRequest)(nil),                  // 225: player.GetLinkRequest
	(*player_grpc.GetLinkReply)(nil),                    // 226: player.GetLinkReply
	(*player_grpc.EndChanRequest)(nil),                  // 227: player.EndChanRequest
	(*player_grpc.EndChanReply)(nil),                    // 228: player.EndChanReply
	(*player_grpc.IsEndedRequest)(nil),                  // 229: player.IsEndedRequest
	(*player_grpc.IsEndedReply)(nil),                    // 230: player.IsEndedReply
	(*player_grpc.GetPositionRequest)(nil),              // 231: player.GetPositionRequest
	(*player_grpc.GetPositionReply)(nil),                // 232: player.GetPositionReply
	(*player_grpc.GetLengthRequest)(nil),                // 233: player.GetLengthRequest
	(*player_grpc.GetLengthReply)(nil),                  // 234: player.GetLengthReply
	(*player_grpc.SetSpeedRequest)(nil),                 // 235: player.SetSpeedRequest
	(*player_grpc.SetSpeedReply)(nil),                   // 236: player.SetSpeedReply
	(*player_grpc.SetPauseRequest)(nil),                 // 237: player.SetPauseRequest
	(*player_grpc.SetPauseReply)(nil),                   // 238: player.SetPauseReply
	(*player_grpc.StopRequest)(nil),                     // 239: player.StopRequest
	(*player_grpc.StopReply)(nil),                       // 240: player.StopReply
	(*player_grpc.CloseRequest)(nil),                    // 241: player.CloseRequest
	(*player_grpc.CloseReply)(nil),                      // 242: player.CloseReply
	(*chatwebhook_grpc.Event)(nil),                      // 243: chatwebhook.Event
}
var file_streamd_proto_depIdxs = []int32{
	...
	221, // 41: streamd.StreamPlayerOpenRequest.request:type_name -> player.OpenRequest
	222, // 42: streamd.StreamPlayerOpenReply.reply:type_name -> player.OpenReply
	223, // 43: streamd.StreamPlayerProcessTitleRequest.request:type_name -> player.ProcessTitleRequest
	224, // 44: streamd.StreamPlayerProcessTitleReply.reply:type_name -> player.ProcessTitleReply
	225, // 45: streamd.StreamPlayerGetLinkRequest.request:type_name -> player.GetLinkRequest
	226, // 46: streamd.StreamPlayerGetLinkReply.reply:type_name -> player.GetLinkReply
	227, // 47: streamd.StreamPlayerEndChanRequest.request:type_name -> player.EndChanRequest
	228, // 48: streamd.StreamPlayerEndChanReply.reply:type_name -> player.EndChanReply
	229, // 49: streamd.StreamPlayerIsEndedRequest.request:type_name -> player.IsEndedRequest
	230, // 50: streamd.StreamPlayerIsEndedReply.reply:type_name -> player.IsEndedReply
	231, // 51: streamd.StreamPlayerGetPositionRequest.request:type_name -> player.GetPositionRequest
	232, // 52: streamd.StreamPlayerGetPositionReply.reply:type_name -> player.GetPositionReply
	233, // 53: streamd.StreamPlayerGetLengthRequest.request:type_name -> player.GetLengthRequest
	234, // 54: streamd.StreamPlayerGetLengthReply.reply:type_name -> player.GetLengthReply
	235, // 55: streamd.StreamPlayerSetSpeedRequest.request:type_name -> player.SetSpeedRequest
	236, // 56: streamd.StreamPlayerSetSpeedReply.reply:type_name -> player.SetSpeedReply
	237, // 57: streamd.StreamPlayerSetPauseRequest.request:type_name -> player.SetPauseRequest
	238, // 58: streamd.StreamPlayerSetPauseReply.reply:type_name -> player.SetPauseReply
	239, // 59: streamd.StreamPlayerStopRequest.request:type_name -> player.StopRequest
	240, // 60: streamd.StreamPlayerStopReply.reply:type_name -> player.StopReply
	241, // 61: streamd.StreamPlayerCloseRequest.request:type_name -> player.CloseRequest
	242, // 62: streamd.StreamPlayerCloseReply.reply:type_name -> player.CloseReply
	...
	243, // 89: streamd.ChatMessage.content:type_name -> chatwebhook.Event
	243, // 90: streamd.InjectChatMessageRequest.event:type_name -> chatwebhook.Event
	9,   // 91: streamd.StreamD.Ping:input_type -> streamd.PingRequest
	11,  // 92: streamd.StreamD.SetLoggingLevel:input_type -> streamd.SetLoggingLevelRequest
	13,  // 93: streamd.StreamD.GetLoggingLevel:input_type -> streamd.GetLoggingLevelRequest
	15,  // 94: streamd.StreamD.GetConfig:input_type -> streamd.GetConfigRequest
	17,  // 95: streamd.StreamD.SetConfig:input_type -> streamd.SetConfigRequest
	19,  // 96: streamd.StreamD.SaveConfig:input_type -> streamd.SaveConfigRequest
	155, // 97: streamd.StreamD.SubscribeToConfigChanges:input_type -> streamd.SubscribeToConfigChangesRequest
	21,  // 98: streamd.StreamD.ResetCache:input_type -> streamd.ResetCacheRequest
	23,  // 99: streamd.StreamD.InitCache:input_type -> streamd.InitCacheRequest
	25,  // 100: streamd.StreamD.StartStream:input_type -> streamd.StartStreamRequest
	26,  // 101: streamd.StreamD.StartStreamByProfileName:input_type -> streamd.StartStreamByProfileNameRequest
	28,  // 102: streamd.StreamD.EndStream:input_type -> streamd.EndStreamRequest
	30,  // 103: streamd.StreamD.GetStreamStatus:input_type -> streamd.GetStreamStatusRequest
	34,  // 104: streamd.StreamD.IsBackendEnabled:input_type -> streamd.IsBackendEnabledRequest
	32,  // 105: streamd.StreamD.GetBackendInfo:input_type -> streamd.GetBackendInfoRequest
	157, // 106: streamd.StreamD.SubscribeToStreamsChanges:input_type -> streamd.SubscribeToStreamsChangesRequest
	36,  // 107: streamd.StreamD.Restart:input_type -> streamd.RestartRequest
	38,  // 108: streamd.StreamD.SetTitle:input_type -> streamd.SetTitleRequest
	40,  // 109: streamd.StreamD.SetDescription:input_type -> streamd.SetDescriptionRequest
	42,  // 110: streamd.StreamD.ApplyProfile:input_type -> streamd.ApplyProfileRequest
	45,  // 111: streamd.StreamD.ListStreamProfiles:input_type -> streamd.ListStreamProfilesRequest
	47,  // 112: streamd.StreamD.UpdateStream:input_type -> streamd.UpdateStreamRequest
	59,  // 113: streamd.StreamD.GetVariable:input_type -> streamd.GetVariableRequest
	61,  // 114: streamd.StreamD.GetVariableHash:input_type -> streamd.GetVariableHashRequest
	63,  // 115: streamd.StreamD.SetVariable:input_type -> streamd.SetVariableRequest
	65,  // 116: streamd.StreamD.SubscribeToVariable:input_type -> streamd.SubscribeToVariableRequest
	49,  // 117: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:input_type -> streamd.EXPERIMENTAL_ReinitStreamControllersRequest
	57,  // 118: streamd.StreamD.SubscribeToOAuthRequests:input_type -> streamd.SubscribeToOAuthRequestsRequest
	67,  // 119: streamd.StreamD.SubmitOAuthCode:input_type -> streamd.SubmitOAuthCodeRequest
	74,  // 120: streamd.StreamD.ListStreamServers:input_type -> streamd.ListStreamServersRequest
	76,  // 121: streamd.StreamD.StartStreamServer:input_type -> streamd.StartStreamServerRequest
	78,  // 122: streamd.StreamD.StopStreamServer:input_type -> streamd.StopStreamServerRequest
	159, // 123: streamd.StreamD.SubscribeToStreamServersChanges:input_type -> streamd.SubscribeToStreamServersChangesRequest
	81,  // 124: streamd.StreamD.ListStreamDestinations:input_type -> streamd.ListStreamDestinationsRequest
	83,  // 125: streamd.StreamD.AddStreamDestination:input_type -> streamd.AddStreamDestinationRequest
	85,  // 126: streamd.StreamD.UpdateStreamDestination:input_type -> streamd.UpdateStreamDestinationRequest
	87,  // 127: streamd.StreamD.RemoveStreamDestination:input_type -> streamd.RemoveStreamDestinationRequest
	161, // 128: streamd.StreamD.SubscribeToStreamDestinationsChanges:input_type -> streamd.SubscribeToStreamDestinationsChangesRequest
	90,  // 129: streamd.StreamD.AddIncomingStream:input_type -> streamd.AddIncomingStreamRequest
	92,  // 130: streamd.StreamD.RemoveIncomingStream:input_type -> streamd.RemoveIncomingStreamRequest
	94,  // 131: streamd.StreamD.ListIncomingStreams:input_type -> streamd.ListIncomingStreamsRequest
	163, // 132: streamd.StreamD.SubscribeToIncomingStreamsChanges:input_type -> streamd.SubscribeToIncomingStreamsChangesRequest
	109, // 133: streamd.StreamD.ListStreamForwards:input_type -> streamd.ListStreamForwardsRequest
	111, // 134: streamd.StreamD.AddStreamForward:input_type -> streamd.AddStreamForwardRequest
	113, // 135: streamd.StreamD.UpdateStreamForward:input_type -> streamd.UpdateStreamForwardRequest
	115, // 136: streamd.StreamD.RemoveStreamForward:input_type -> streamd.RemoveStreamForwardRequest
	165, // 137: streamd.StreamD.SubscribeToStreamForwardsChanges:input_type -> streamd.SubscribeToStreamForwardsChangesRequest
	117, // 138: streamd.StreamD.WaitForStreamPublisher:input_type -> streamd.WaitForStreamPublisherRequest
	121, // 139: streamd.StreamD.AddStreamPlayer:input_type -> streamd.AddStreamPlayerRequest
	123, // 140: streamd.StreamD.RemoveStreamPlayer:input_type -> streamd.RemoveStreamPlayerRequest
	125, // 141: streamd.StreamD.UpdateStreamPlayer:input_type -> streamd.UpdateStreamPlayerRequest
	127, // 142: streamd.StreamD.ListStreamPlayers:input_type -> streamd.ListStreamPlayersRequest
	129, // 143: streamd.StreamD.GetStreamPlayer:input_type -> streamd.GetStreamPlayerRequest
	167, // 144: streamd.StreamD.SubscribeToStreamPlayersChanges:input_type -> streamd.SubscribeToStreamPlayersChangesRequest
	131, // 145: streamd.StreamD.StreamPlayerOpen:input_type -> streamd.StreamPlayerOpenRequest
	133, // 146: streamd.StreamD.StreamPlayerProcessTitle:input_type -> streamd.StreamPlayerProcessTitleRequest
	135, // 147: streamd.StreamD.StreamPlayerGetLink:input_type -> streamd.StreamPlayerGetLinkRequest
	137, // 148: streamd.StreamD.StreamPlayerEndChan:input_type -> streamd.StreamPlayerEndChanRequest
	139, // 149: streamd.StreamD.StreamPlayerIsEnded:input_type -> streamd.StreamPlayerIsEndedRequest
	141, // 150: streamd.StreamD.StreamPlayerGetPosition:input_type -> streamd.StreamPlayerGetPositionRequest
	143, // 151: streamd.StreamD.StreamPlayerGetLength:input_type -> streamd.StreamPlayerGetLengthRequest
	145, // 152: streamd.StreamD.StreamPlayerGetLag:input_type -> streamd.StreamPlayerGetLagRequest
	147, // 153: streamd.StreamD.StreamPlayerSetSpeed:input_type -> streamd.StreamPlayerSetSpeedRequest
	149, // 154: streamd.StreamD.StreamPlayerSetPause:input_type -> streamd.StreamPlayerSetPauseRequest
	151, // 155: streamd.StreamD.StreamPlayerStop:input_type -> streamd.StreamPlayerStopRequest
	153, // 156: streamd.StreamD.StreamPlayerClose:input_type -> streamd.StreamPlayerCloseRequest
	174, // 157: streamd.StreamD.AddTimer:input_type -> streamd.AddTimerRequest
	176, // 158: streamd.StreamD.RemoveTimer:input_type -> streamd.RemoveTimerRequest
	179, // 159: streamd.StreamD.ListTimers:input_type -> streamd.ListTimersRequest
	189, // 160: streamd.StreamD.ListTriggerRules:input_type -> streamd.ListTriggerRulesRequest
	191, // 161: streamd.StreamD.AddTriggerRule:input_type -> streamd.AddTriggerRuleRequest
	193, // 162: streamd.StreamD.RemoveTriggerRule:input_type -> streamd.RemoveTriggerRuleRequest
	195, // 163: streamd.StreamD.UpdateTriggerRule:input_type -> streamd.UpdateTriggerRuleRequest
	197, // 164: streamd.StreamD.SubmitEvent:input_type -> streamd.SubmitEventRequest
	199, // 165: streamd.StreamD.SubscribeToChatMessages:input_type -> streamd.SubscribeToChatMessagesRequest
	201, // 166: streamd.StreamD.SendChatMessage:input_type -> streamd.SendChatMessageRequest
	203, // 167: streamd.StreamD.InjectChatMessage:input_type -> streamd.InjectChatMessageRequest
	205, // 168: streamd.StreamD.RemoveChatMessage:input_type -> streamd.RemoveChatMessageRequest
	207, // 169: streamd.StreamD.BanUser:input_type -> streamd.BanUserRequest
	217, // 170: streamd.StreamD.SetBuiltinChatListenerEnabled:input_type -> streamd.SetBuiltinChatListenerEnabledRequest
	219, // 171: streamd.StreamD.IsBuiltinChatListenerEnabled:input_type -> streamd.IsBuiltinChatListenerEnabledRequest
	209, // 172: streamd.StreamD.Shoutout:input_type -> streamd.ShoutoutRequest
	211, // 173: streamd.StreamD.RaidTo:input_type -> streamd.RaidToRequest
	213, // 174: streamd.StreamD.GetPeerIDs:input_type -> streamd.GetPeerIDsRequest
	215, // 175: streamd.StreamD.LLMGenerate:input_type -> streamd.LLMGenerateRequest
	10,  // 176: streamd.StreamD.Ping:output_type -> streamd.PingReply
	12,  // 177: streamd.StreamD.SetLoggingLevel:output_type -> streamd.SetLoggingLevelReply
	14,  // 178: streamd.StreamD.GetLoggingLevel:output_type -> streamd.GetLoggingLevelReply
	16,  // 179: streamd.StreamD.GetConfig:output_type -> streamd.GetConfigReply
	18,  // 180: streamd.StreamD.SetConfig:output_type -> streamd.SetConfigReply
	20,  // 181: streamd.StreamD.SaveConfig:output_type -> streamd.SaveConfigReply
	156, // 182: streamd.StreamD.SubscribeToConfigChanges:output_type -> streamd.ConfigChange
	22,  // 183: streamd.StreamD.ResetCache:output_type -> streamd.ResetCacheReply
	24,  // 184: streamd.StreamD.InitCache:output_type -> streamd.InitCacheReply
	27,  // 185: streamd.StreamD.StartStream:output_type -> streamd.StartStreamReply
	27,  // 186: streamd.StreamD.StartStreamByProfileName:output_type -> streamd.StartStreamReply
	29,  // 187: streamd.StreamD.EndStream:output_type -> streamd.EndStreamReply
	31,  // 188: streamd.StreamD.GetStreamStatus:output_type -> streamd.GetStreamStatusReply
	35,  // 189: streamd.StreamD.IsBackendEnabled:output_type -> streamd.IsBackendEnabledReply
	33,  // 190: streamd.StreamD.GetBackendInfo:output_type -> streamd.GetBackendInfoReply
	158, // 191: streamd.StreamD.SubscribeToStreamsChanges:output_type -> streamd.StreamsChange
	37,  // 192: streamd.StreamD.Restart:output_type -> streamd.RestartReply
	39,  // 193: streamd.StreamD.SetTitle:output_type -> streamd.SetTitleReply
	41,  // 194: streamd.StreamD.SetDescription:output_type -> streamd.SetDescriptionReply
	43,  // 195: streamd.StreamD.ApplyProfile:output_type -> streamd.ApplyProfileReply
	46,  // 196: streamd.StreamD.ListStreamProfiles:output_type -> streamd.ListStreamProfilesReply
	48,  // 197: streamd.StreamD.UpdateStream:output_type -> streamd.UpdateStreamReply
	60,  // 198: streamd.StreamD.GetVariable:output_type -> streamd.GetVariableReply
	62,  // 199: streamd.StreamD.GetVariableHash:output_type -> streamd.GetVariableHashReply
	64,  // 200: streamd.StreamD.SetVariable:output_type -> streamd.SetVariableReply
	66,  // 201: streamd.StreamD.SubscribeToVariable:output_type -> streamd.VariableChange
	50,  // 202: streamd.StreamD.EXPERIMENTAL_ReinitStreamControllers:output_type -> streamd.EXPERIMENTAL_ReinitStreamControllersReply
	58,  // 203: streamd.StreamD.SubscribeToOAuthRequests:output_type -> streamd.OAuthRequest
	68,  // 204: streamd.StreamD.SubmitOAuthCode:output_type -> streamd.SubmitOAuthCodeReply
	75,  // 205: streamd.StreamD.ListStreamServers:output_type -> streamd.ListStreamServersReply
	77,  // 206: streamd.StreamD.StartStreamServer:output_type -> streamd.StartStreamServerReply
	79,  // 207: streamd.StreamD.StopStreamServer:output_type -> streamd.StopStreamServerReply
	160, // 208: streamd.StreamD.SubscribeToStreamServersChanges:output_type -> streamd.StreamServersChange
	82,  // 209: streamd.StreamD.ListStreamDestinations:output_type -> streamd.ListStreamDestinationsReply
	84,  // 210: streamd.StreamD.AddStreamDestination:output_type -> streamd.AddStreamDestinationReply
	86,  // 211: streamd.StreamD.UpdateStreamDestination:output_type -> streamd.UpdateStreamDestinationReply
	88,  // 212: streamd.StreamD.RemoveStreamDestination:output_type -> streamd.RemoveStreamDestinationReply
	162, // 213: streamd.StreamD.SubscribeToStreamDestinationsChanges:output_type -> streamd.StreamDestinationsChange
	91,  // 214: streamd.StreamD.AddIncomingStream:output_type -> streamd.AddIncomingStreamReply
	93,  // 215: streamd.StreamD.RemoveIncomingStream:output_type -> streamd.RemoveIncomingStreamReply
	95,  // 216: streamd.StreamD.ListIncomingStreams:output_type -> streamd.ListIncomingStreamsReply
	164, // 217: streamd.StreamD.SubscribeToIncomingStreamsChanges:output_type -> streamd.IncomingStreamsChange
	110, // 218: streamd.StreamD.ListStreamForwards:output_type -> streamd.ListStreamForwardsReply
	112, // 219: streamd.StreamD.AddStreamForward:output_type -> streamd.AddStreamForwardReply
	114, // 220: streamd.StreamD.UpdateStreamForward:output_type -> streamd.UpdateStreamForwardReply
	116, // 221: streamd.StreamD.RemoveStreamForward:output_type -> streamd.RemoveStreamForwardReply
	166, // 222: streamd.StreamD.SubscribeToStreamForwardsChanges:output_type -> streamd.StreamForwardsChange
	118, // 223: streamd.StreamD.WaitForStreamPublisher:output_type -> streamd.StreamPublisher
	122, // 224: streamd.StreamD.AddStreamPlayer:output_type -> streamd.AddStreamPlayerReply
	124, // 225: streamd.StreamD.RemoveStreamPlayer:output_type -> streamd.RemoveStreamPlayerReply
	126, // 226: streamd.StreamD.UpdateStreamPlayer:output_type -> streamd.UpdateStreamPlayerReply
	128, // 227: streamd.StreamD.ListStreamPlayers:output_type -> streamd.ListStreamPlayersReply
	130, // 228: streamd.StreamD.GetStreamPlayer:output_type -> streamd.GetStreamPlayerReply
	168, // 229: streamd.StreamD.SubscribeToStreamPlayersChanges:output_type -> streamd.StreamPlayersChange
	132, // 230: streamd.StreamD.StreamPlayerOpen:output_type -> streamd.StreamPlayerOpenReply
	134, // 231: streamd.StreamD.StreamPlayerProcessTitle:output_type -> streamd.StreamPlayerProcessTitleReply
	136, // 232: streamd.StreamD.StreamPlayerGetLink:output_type -> streamd.StreamPlayerGetLinkReply
	138, // 233: streamd.StreamD.StreamPlayerEndChan:output_type -> streamd.StreamPlayerEndChanReply
	140, // 234: streamd.StreamD.StreamPlayerIsEnded:output_type -> streamd.StreamPlayerIsEndedReply
	142, // 235: streamd.StreamD.StreamPlayerGetPosition:output_type -> streamd.StreamPlayerGetPositionReply
	144, // 236: streamd.StreamD.StreamPlayerGetLength:output_type -> streamd.StreamPlayerGetLengthReply
	146, // 237: streamd.StreamD.StreamPlayerGetLag:output_type -> streamd.StreamPlayerGetLagReply
	148, // 238: streamd.StreamD.StreamPlayerSetSpeed:output_type -> streamd.StreamPlayerSetSpeedReply
	150, // 239: streamd.StreamD.StreamPlayerSetPause:output_type -> streamd.StreamPlayerSetPauseReply
	152, // 240: streamd.StreamD.StreamPlayerStop:output_type -> streamd.StreamPlayerStopReply
	154, // 241: streamd.StreamD.StreamPlayerClose:output_type -> streamd.StreamPlayerCloseReply
	175, // 242: streamd.StreamD.AddTimer:output_type -> streamd.AddTimerReply
	177, // 243: streamd.StreamD.RemoveTimer:output_type -> streamd.RemoveTimerReply
	180, // 244: streamd.StreamD.ListTimers:output_type -> streamd.ListTimersReply
	190, // 245: streamd.StreamD.ListTriggerRules:output_type -> streamd.ListTriggerRulesReply
	192, // 246: streamd.StreamD.AddTriggerRule:output_type -> streamd.AddTriggerRuleReply
	194, // 247: streamd.StreamD.RemoveTriggerRule:output_type -> streamd.RemoveTriggerRuleReply
	196, // 248: streamd.StreamD.UpdateTriggerRule:output_type -> streamd.UpdateTriggerRuleReply
	198, // 249: streamd.StreamD.SubmitEvent:output_type -> streamd.SubmitEventReply
	200, // 250: streamd.StreamD.SubscribeToChatMessages:output_type -> streamd.ChatMessage
	202, // 251: streamd.StreamD.SendChatMessage:output_type -> streamd.SendChatMessageReply
	204, // 252: streamd.StreamD.InjectChatMessage:output_type -> streamd.InjectChatMessageReply
	206, // 253: streamd.StreamD.RemoveChatMessage:output_type -> streamd.RemoveChatMessageReply
	208, // 254: streamd.StreamD.BanUser:output_type -> streamd.BanUserReply
	218, // 255: streamd.StreamD.SetBuiltinChatListenerEnabled:output_type -> streamd.SetBuiltinChatListenerEnabledReply
	220, // 256: streamd.StreamD.IsBuiltinChatListenerEnabled:output_type -> streamd.IsBuiltinChatListenerEnabledReply
	210, // 257: streamd.StreamD.Shoutout:output_type -> streamd.ShoutoutReply
	212, // 258: streamd.StreamD.RaidTo:output_type -> streamd.RaidToReply
	214, // 259: streamd.StreamD.GetPeerIDs:output_type -> streamd.GetPeerIDsReply
	216, // 260: streamd.StreamD.LLMGenerate:output_type -> streamd.LLMGenerateReply
...
func file_streamd_proto_init() {
	...
	file_streamd_proto_msgTypes[198].OneofWrappers = []any{}
	type x struct{}
