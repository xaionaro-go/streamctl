...
const (
	...
	StreamD_ListStreamProfiles_FullMethodName                   = "/streamd.StreamD/ListStreamProfiles"
	...
	StreamD_InjectChatMessage_FullMethodName                    = "/streamd.StreamD/InjectChatMessage"
	StreamD_ReportChatHandlerActivity_FullMethodName            = "/streamd.StreamD/ReportChatHandlerActivity"
	StreamD_ReportTranslatorActivity_FullMethodName             = "/streamd.StreamD/ReportTranslatorActivity"
	...
	StreamD_TranslatorStats_FullMethodName                      = "/streamd.StreamD/TranslatorStats"
	StreamD_TranslatorReload_FullMethodName                     = "/streamd.StreamD/TranslatorReload"
	StreamD_TranslatorEnable_FullMethodName                     = "/streamd.StreamD/TranslatorEnable"
	StreamD_TranslatorDisable_FullMethodName                    = "/streamd.StreamD/TranslatorDisable"
	StreamD_TranslatorRestart_FullMethodName                    = "/streamd.StreamD/TranslatorRestart"
	StreamD_TranslatorClearHistory_FullMethodName               = "/streamd.StreamD/TranslatorClearHistory"
	StreamD_TranslatorTranslate_FullMethodName                  = "/streamd.StreamD/TranslatorTranslate"
	StreamD_TranslatorTranslateViaProvider_FullMethodName       = "/streamd.StreamD/TranslatorTranslateViaProvider"
	StreamD_TranslatorCompileTranslate_FullMethodName           = "/streamd.StreamD/TranslatorCompileTranslate"
	StreamD_TranslatorCompileLanguageDetect_FullMethodName      = "/streamd.StreamD/TranslatorCompileLanguageDetect"
	StreamD_TranslatorQueueList_FullMethodName                  = "/streamd.StreamD/TranslatorQueueList"
	StreamD_TranslatorQueueFlush_FullMethodName                 = "/streamd.StreamD/TranslatorQueueFlush"
)
...
type StreamDClient interface {
	...
	SubscribeToConfigChanges(ctx context.Context, in *SubscribeToConfigChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ConfigChange], error)
	...
	SubscribeToStreamsChanges(ctx context.Context, in *SubscribeToStreamsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamsChange], error)
	...
	ListStreamProfiles(ctx context.Context, in *ListStreamProfilesRequest, opts ...grpc.CallOption) (*ListStreamProfilesReply, error)
	...
	SubscribeToVariable(ctx context.Context, in *SubscribeToVariableRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[VariableChange], error)
	...
	SubscribeToOAuthRequests(ctx context.Context, in *SubscribeToOAuthRequestsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OAuthRequest], error)
	...
	SubscribeToStreamServersChanges(ctx context.Context, in *SubscribeToStreamServersChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamServersChange], error)
	...
	SubscribeToStreamDestinationsChanges(ctx context.Context, in *SubscribeToStreamDestinationsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamDestinationsChange], error)
	...
	SubscribeToIncomingStreamsChanges(ctx context.Context, in *SubscribeToIncomingStreamsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[IncomingStreamsChange], error)
	...
	SubscribeToStreamForwardsChanges(ctx context.Context, in *SubscribeToStreamForwardsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamForwardsChange], error)
	WaitForStreamPublisher(ctx context.Context, in *WaitForStreamPublisherRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamPublisher], error)
	...
	SubscribeToStreamPlayersChanges(ctx context.Context, in *SubscribeToStreamPlayersChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamPlayersChange], error)
	...
	StreamPlayerEndChan(ctx context.Context, in *StreamPlayerEndChanRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamPlayerEndChanReply], error)
	...
	SubscribeToChatMessages(ctx context.Context, in *SubscribeToChatMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error)
	SendChatMessage(ctx context.Context, in *SendChatMessageRequest, opts ...grpc.CallOption) (*SendChatMessageReply, error)
	InjectChatMessage(ctx context.Context, in *InjectChatMessageRequest, opts ...grpc.CallOption) (*InjectChatMessageReply, error)
	ReportChatHandlerActivity(ctx context.Context, in *ReportChatHandlerActivityRequest, opts ...grpc.CallOption) (*ReportChatHandlerActivityReply, error)
	ReportTranslatorActivity(ctx context.Context, in *ReportTranslatorActivityRequest, opts ...grpc.CallOption) (*ReportTranslatorActivityReply, error)
	...
	// Translator* RPCs share a uniform error contract: application-level
	// failures (translation disabled, subprocess not initialised, provider
	// not found, queue empty, etc.) are surfaced via the in-band `error`
	// field on the reply (handler returns (reply, nil)). The gRPC error
	// channel is reserved for transport-layer failures (network drop,
	// codec error, deadline exceeded, server panic). Callers MUST inspect
	// reply.error even when the gRPC error is nil. This mirrors the rule
	// documented on the Translator subprocess service in
	// pkg/translator/grpc/translator.proto.
	TranslatorStats(ctx context.Context, in *TranslatorStatsRequest, opts ...grpc.CallOption) (*TranslatorStatsReply, error)
	TranslatorReload(ctx context.Context, in *TranslatorReloadRequest, opts ...grpc.CallOption) (*TranslatorReloadReply, error)
	TranslatorEnable(ctx context.Context, in *TranslatorEnableRequest, opts ...grpc.CallOption) (*TranslatorEnableReply, error)
	TranslatorDisable(ctx context.Context, in *TranslatorDisableRequest, opts ...grpc.CallOption) (*TranslatorDisableReply, error)
	TranslatorRestart(ctx context.Context, in *TranslatorRestartRequest, opts ...grpc.CallOption) (*TranslatorRestartReply, error)
	TranslatorClearHistory(ctx context.Context, in *TranslatorClearHistoryRequest, opts ...grpc.CallOption) (*TranslatorClearHistoryReply, error)
	TranslatorTranslate(ctx context.Context, in *TranslatorTranslateRequest, opts ...grpc.CallOption) (*TranslatorTranslateReply, error)
	TranslatorTranslateViaProvider(ctx context.Context, in *TranslatorTranslateViaProviderRequest, opts ...grpc.CallOption) (*TranslatorTranslateViaProviderReply, error)
	// TranslatorCompileTranslate proxies the subprocess CompileTranslate RPC:
	// returns the system + user prompts the chain WOULD emit for a Translate
	// call, without invoking any provider. history_snapshot reflects chain
	// history at RPC arrival; consecutive calls may differ as the chain
	// progresses. Errors follow the in-band Translator* rule above.
	TranslatorCompileTranslate(ctx context.Context, in *TranslatorCompileTranslateRequest, opts ...grpc.CallOption) (*TranslatorCompileTranslateReply, error)
	// TranslatorCompileLanguageDetect proxies the subprocess
	// CompileLanguageDetect RPC: returns the system + user prompts the chain
	// WOULD emit for the language-detection step. The system prompt uses the
	// deliberately asymmetric "Recent chat:" label (translate uses "Recent
	// chat for context:") — observable on the wire. Errors follow the
	// in-band Translator* rule above.
	TranslatorCompileLanguageDetect(ctx context.Context, in *TranslatorCompileLanguageDetectRequest, opts ...grpc.CallOption) (*TranslatorCompileLanguageDetectReply, error)
	TranslatorQueueList(ctx context.Context, in *TranslatorQueueListRequest, opts ...grpc.CallOption) (*TranslatorQueueListReply, error)
	TranslatorQueueFlush(ctx context.Context, in *TranslatorQueueFlushRequest, opts ...grpc.CallOption) (*TranslatorQueueFlushReply, error)
}
...
func (c *streamDClient) SubscribeToConfigChanges(ctx context.Context, in *SubscribeToConfigChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ConfigChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[0], StreamD_SubscribeToConfigChanges_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToConfigChangesRequest, ConfigChange]{ClientStream: stream}
...
type StreamD_SubscribeToConfigChangesClient = grpc.ServerStreamingClient[ConfigChange]
...
func (c *streamDClient) SubscribeToStreamsChanges(ctx context.Context, in *SubscribeToStreamsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamsChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[1], StreamD_SubscribeToStreamsChanges_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToStreamsChangesRequest, StreamsChange]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamsChangesClient = grpc.ServerStreamingClient[StreamsChange]
...
func (c *streamDClient) ListStreamProfiles(ctx context.Context, in *ListStreamProfilesRequest, opts ...grpc.CallOption) (*ListStreamProfilesReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListStreamProfilesReply)
	err := c.cc.Invoke(ctx, StreamD_ListStreamProfiles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) SubscribeToVariable(ctx context.Context, in *SubscribeToVariableRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[VariableChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[2], StreamD_SubscribeToVariable_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToVariableRequest, VariableChange]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToVariableClient = grpc.ServerStreamingClient[VariableChange]
...
func (c *streamDClient) SubscribeToOAuthRequests(ctx context.Context, in *SubscribeToOAuthRequestsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OAuthRequest], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[3], StreamD_SubscribeToOAuthRequests_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToOAuthRequestsRequest, OAuthRequest]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToOAuthRequestsClient = grpc.ServerStreamingClient[OAuthRequest]
...
func (c *streamDClient) SubscribeToStreamServersChanges(ctx context.Context, in *SubscribeToStreamServersChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamServersChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[4], StreamD_SubscribeToStreamServersChanges_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToStreamServersChangesRequest, StreamServersChange]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamServersChangesClient = grpc.ServerStreamingClient[StreamServersChange]
...
func (c *streamDClient) SubscribeToStreamDestinationsChanges(ctx context.Context, in *SubscribeToStreamDestinationsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamDestinationsChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[SubscribeToStreamDestinationsChangesRequest, StreamDestinationsChange]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamDestinationsChangesClient = grpc.ServerStreamingClient[StreamDestinationsChange]
...
func (c *streamDClient) SubscribeToIncomingStreamsChanges(ctx context.Context, in *SubscribeToIncomingStreamsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[IncomingStreamsChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[SubscribeToIncomingStreamsChangesRequest, IncomingStreamsChange]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToIncomingStreamsChangesClient = grpc.ServerStreamingClient[IncomingStreamsChange]
...
func (c *streamDClient) SubscribeToStreamForwardsChanges(ctx context.Context, in *SubscribeToStreamForwardsChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamForwardsChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	...
	x := &grpc.GenericClientStream[SubscribeToStreamForwardsChangesRequest, StreamForwardsChange]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamForwardsChangesClient = grpc.ServerStreamingClient[StreamForwardsChange]

func (c *streamDClient) WaitForStreamPublisher(ctx context.Context, in *WaitForStreamPublisherRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamPublisher], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[8], StreamD_WaitForStreamPublisher_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[WaitForStreamPublisherRequest, StreamPublisher]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_WaitForStreamPublisherClient = grpc.ServerStreamingClient[StreamPublisher]
...
func (c *streamDClient) SubscribeToStreamPlayersChanges(ctx context.Context, in *SubscribeToStreamPlayersChangesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamPlayersChange], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[9], StreamD_SubscribeToStreamPlayersChanges_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToStreamPlayersChangesRequest, StreamPlayersChange]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamPlayersChangesClient = grpc.ServerStreamingClient[StreamPlayersChange]
...
func (c *streamDClient) StreamPlayerEndChan(ctx context.Context, in *StreamPlayerEndChanRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[StreamPlayerEndChanReply], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[10], StreamD_StreamPlayerEndChan_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[StreamPlayerEndChanRequest, StreamPlayerEndChanReply]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_StreamPlayerEndChanClient = grpc.ServerStreamingClient[StreamPlayerEndChanReply]
...
func (c *streamDClient) SubscribeToChatMessages(ctx context.Context, in *SubscribeToChatMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChatMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &StreamD_ServiceDesc.Streams[11], StreamD_SubscribeToChatMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubscribeToChatMessagesRequest, ChatMessage]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToChatMessagesClient = grpc.ServerStreamingClient[ChatMessage]
...
func (c *streamDClient) InjectChatMessage(ctx context.Context, in *InjectChatMessageRequest, opts ...grpc.CallOption) (*InjectChatMessageReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InjectChatMessageReply)
	err := c.cc.Invoke(ctx, StreamD_InjectChatMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) ReportChatHandlerActivity(ctx context.Context, in *ReportChatHandlerActivityRequest, opts ...grpc.CallOption) (*ReportChatHandlerActivityReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportChatHandlerActivityReply)
	err := c.cc.Invoke(ctx, StreamD_ReportChatHandlerActivity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) ReportTranslatorActivity(ctx context.Context, in *ReportTranslatorActivityRequest, opts ...grpc.CallOption) (*ReportTranslatorActivityReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportTranslatorActivityReply)
	err := c.cc.Invoke(ctx, StreamD_ReportTranslatorActivity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorStats(ctx context.Context, in *TranslatorStatsRequest, opts ...grpc.CallOption) (*TranslatorStatsReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorStatsReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorReload(ctx context.Context, in *TranslatorReloadRequest, opts ...grpc.CallOption) (*TranslatorReloadReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorReloadReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorReload_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorEnable(ctx context.Context, in *TranslatorEnableRequest, opts ...grpc.CallOption) (*TranslatorEnableReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorEnableReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorEnable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorDisable(ctx context.Context, in *TranslatorDisableRequest, opts ...grpc.CallOption) (*TranslatorDisableReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorDisableReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorDisable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorRestart(ctx context.Context, in *TranslatorRestartRequest, opts ...grpc.CallOption) (*TranslatorRestartReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorRestartReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorRestart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorClearHistory(ctx context.Context, in *TranslatorClearHistoryRequest, opts ...grpc.CallOption) (*TranslatorClearHistoryReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorClearHistoryReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorClearHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorTranslate(ctx context.Context, in *TranslatorTranslateRequest, opts ...grpc.CallOption) (*TranslatorTranslateReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorTranslateReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorTranslate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorTranslateViaProvider(ctx context.Context, in *TranslatorTranslateViaProviderRequest, opts ...grpc.CallOption) (*TranslatorTranslateViaProviderReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorTranslateViaProviderReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorTranslateViaProvider_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorCompileTranslate(ctx context.Context, in *TranslatorCompileTranslateRequest, opts ...grpc.CallOption) (*TranslatorCompileTranslateReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorCompileTranslateReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorCompileTranslate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorCompileLanguageDetect(ctx context.Context, in *TranslatorCompileLanguageDetectRequest, opts ...grpc.CallOption) (*TranslatorCompileLanguageDetectReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorCompileLanguageDetectReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorCompileLanguageDetect_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorQueueList(ctx context.Context, in *TranslatorQueueListRequest, opts ...grpc.CallOption) (*TranslatorQueueListReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorQueueListReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorQueueList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *streamDClient) TranslatorQueueFlush(ctx context.Context, in *TranslatorQueueFlushRequest, opts ...grpc.CallOption) (*TranslatorQueueFlushReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TranslatorQueueFlushReply)
	err := c.cc.Invoke(ctx, StreamD_TranslatorQueueFlush_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StreamDServer interface {
	...
	SubscribeToConfigChanges(*SubscribeToConfigChangesRequest, grpc.ServerStreamingServer[ConfigChange]) error
	...
	SubscribeToStreamsChanges(*SubscribeToStreamsChangesRequest, grpc.ServerStreamingServer[StreamsChange]) error
	...
	ListStreamProfiles(context.Context, *ListStreamProfilesRequest) (*ListStreamProfilesReply, error)
	...
	SubscribeToVariable(*SubscribeToVariableRequest, grpc.ServerStreamingServer[VariableChange]) error
	...
	SubscribeToOAuthRequests(*SubscribeToOAuthRequestsRequest, grpc.ServerStreamingServer[OAuthRequest]) error
	...
	SubscribeToStreamServersChanges(*SubscribeToStreamServersChangesRequest, grpc.ServerStreamingServer[StreamServersChange]) error
	...
	SubscribeToStreamDestinationsChanges(*SubscribeToStreamDestinationsChangesRequest, grpc.ServerStreamingServer[StreamDestinationsChange]) error
	...
	SubscribeToIncomingStreamsChanges(*SubscribeToIncomingStreamsChangesRequest, grpc.ServerStreamingServer[IncomingStreamsChange]) error
	...
	SubscribeToStreamForwardsChanges(*SubscribeToStreamForwardsChangesRequest, grpc.ServerStreamingServer[StreamForwardsChange]) error
	WaitForStreamPublisher(*WaitForStreamPublisherRequest, grpc.ServerStreamingServer[StreamPublisher]) error
	...
	SubscribeToStreamPlayersChanges(*SubscribeToStreamPlayersChangesRequest, grpc.ServerStreamingServer[StreamPlayersChange]) error
	...
	StreamPlayerEndChan(*StreamPlayerEndChanRequest, grpc.ServerStreamingServer[StreamPlayerEndChanReply]) error
	...
	SubscribeToChatMessages(*SubscribeToChatMessagesRequest, grpc.ServerStreamingServer[ChatMessage]) error
	SendChatMessage(context.Context, *SendChatMessageRequest) (*SendChatMessageReply, error)
	InjectChatMessage(context.Context, *InjectChatMessageRequest) (*InjectChatMessageReply, error)
	ReportChatHandlerActivity(context.Context, *ReportChatHandlerActivityRequest) (*ReportChatHandlerActivityReply, error)
	ReportTranslatorActivity(context.Context, *ReportTranslatorActivityRequest) (*ReportTranslatorActivityReply, error)
	...
	// documented on the Translator subprocess service in
	// pkg/translator/grpc/translator.proto.
	TranslatorStats(context.Context, *TranslatorStatsRequest) (*TranslatorStatsReply, error)
	TranslatorReload(context.Context, *TranslatorReloadRequest) (*TranslatorReloadReply, error)
	TranslatorEnable(context.Context, *TranslatorEnableRequest) (*TranslatorEnableReply, error)
	TranslatorDisable(context.Context, *TranslatorDisableRequest) (*TranslatorDisableReply, error)
	TranslatorRestart(context.Context, *TranslatorRestartRequest) (*TranslatorRestartReply, error)
	TranslatorClearHistory(context.Context, *TranslatorClearHistoryRequest) (*TranslatorClearHistoryReply, error)
	TranslatorTranslate(context.Context, *TranslatorTranslateRequest) (*TranslatorTranslateReply, error)
	TranslatorTranslateViaProvider(context.Context, *TranslatorTranslateViaProviderRequest) (*TranslatorTranslateViaProviderReply, error)
	// TranslatorCompileTranslate proxies the subprocess CompileTranslate RPC:
	// returns the system + user prompts the chain WOULD emit for a Translate
	// call, without invoking any provider. history_snapshot reflects chain
	// history at RPC arrival; consecutive calls may differ as the chain
	// progresses. Errors follow the in-band Translator* rule above.
	TranslatorCompileTranslate(context.Context, *TranslatorCompileTranslateRequest) (*TranslatorCompileTranslateReply, error)
	// TranslatorCompileLanguageDetect proxies the subprocess
	// CompileLanguageDetect RPC: returns the system + user prompts the chain
	// WOULD emit for the language-detection step. The system prompt uses the
	// deliberately asymmetric "Recent chat:" label (translate uses "Recent
	// chat for context:") — observable on the wire. Errors follow the
	// in-band Translator* rule above.
	TranslatorCompileLanguageDetect(context.Context, *TranslatorCompileLanguageDetectRequest) (*TranslatorCompileLanguageDetectReply, error)
	TranslatorQueueList(context.Context, *TranslatorQueueListRequest) (*TranslatorQueueListReply, error)
	TranslatorQueueFlush(context.Context, *TranslatorQueueFlushRequest) (*TranslatorQueueFlushReply, error)
...
func (UnimplementedStreamDServer) SubscribeToConfigChanges(*SubscribeToConfigChangesRequest, grpc.ServerStreamingServer[ConfigChange]) error {
...
func (UnimplementedStreamDServer) StartStreamByProfileName(context.Context, *StartStreamByProfileNameRequest) (*StartStreamReply, error) {
	return nil, status.Error(codes.Unimplemented, "method StartStreamByProfileName not implemented")
}
...
func (UnimplementedStreamDServer) SubscribeToStreamsChanges(*SubscribeToStreamsChangesRequest, grpc.ServerStreamingServer[StreamsChange]) error {
...
func (UnimplementedStreamDServer) ListStreamProfiles(context.Context, *ListStreamProfilesRequest) (*ListStreamProfilesReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListStreamProfiles not implemented")
}
...
func (UnimplementedStreamDServer) SubscribeToVariable(*SubscribeToVariableRequest, grpc.ServerStreamingServer[VariableChange]) error {
...
func (UnimplementedStreamDServer) SubscribeToOAuthRequests(*SubscribeToOAuthRequestsRequest, grpc.ServerStreamingServer[OAuthRequest]) error {
...
func (UnimplementedStreamDServer) SubscribeToStreamServersChanges(*SubscribeToStreamServersChangesRequest, grpc.ServerStreamingServer[StreamServersChange]) error {
...
func (UnimplementedStreamDServer) ListStreamDestinations(context.Context, *ListStreamDestinationsRequest) (*ListStreamDestinationsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListStreamDestinations not implemented")
}
func (UnimplementedStreamDServer) AddStreamDestination(context.Context, *AddStreamDestinationRequest) (*AddStreamDestinationReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddStreamDestination not implemented")
}
func (UnimplementedStreamDServer) UpdateStreamDestination(context.Context, *UpdateStreamDestinationRequest) (*UpdateStreamDestinationReply, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateStreamDestination not implemented")
}
func (UnimplementedStreamDServer) RemoveStreamDestination(context.Context, *RemoveStreamDestinationRequest) (*RemoveStreamDestinationReply, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveStreamDestination not implemented")
}
func (UnimplementedStreamDServer) SubscribeToStreamDestinationsChanges(*SubscribeToStreamDestinationsChangesRequest, grpc.ServerStreamingServer[StreamDestinationsChange]) error {
	return status.Error(codes.Unimplemented, "method SubscribeToStreamDestinationsChanges not implemented")
}
func (UnimplementedStreamDServer) AddIncomingStream(context.Context, *AddIncomingStreamRequest) (*AddIncomingStreamReply, error) {
	return nil, status.Error(codes.Unimplemented, "method AddIncomingStream not implemented")
}
func (UnimplementedStreamDServer) RemoveIncomingStream(context.Context, *RemoveIncomingStreamRequest) (*RemoveIncomingStreamReply, error) {
	return nil, status.Error(codes.Unimplemented, "method RemoveIncomingStream not implemented")
}
func (UnimplementedStreamDServer) ListIncomingStreams(context.Context, *ListIncomingStreamsRequest) (*ListIncomingStreamsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ListIncomingStreams not implemented")
}
func (UnimplementedStreamDServer) SubscribeToIncomingStreamsChanges(*SubscribeToIncomingStreamsChangesRequest, grpc.ServerStreamingServer[IncomingStreamsChange]) error {
	return status.Error(codes.Unimplemented, "method SubscribeToIncomingStreamsChanges not implemented")
}
...
func (UnimplementedStreamDServer) SubscribeToStreamForwardsChanges(*SubscribeToStreamForwardsChangesRequest, grpc.ServerStreamingServer[StreamForwardsChange]) error {
	return status.Error(codes.Unimplemented, "method SubscribeToStreamForwardsChanges not implemented")
}
func (UnimplementedStreamDServer) WaitForStreamPublisher(*WaitForStreamPublisherRequest, grpc.ServerStreamingServer[StreamPublisher]) error {
	return status.Error(codes.Unimplemented, "method WaitForStreamPublisher not implemented")
}
...
func (UnimplementedStreamDServer) SubscribeToStreamPlayersChanges(*SubscribeToStreamPlayersChangesRequest, grpc.ServerStreamingServer[StreamPlayersChange]) error {
...
func (UnimplementedStreamDServer) StreamPlayerEndChan(*StreamPlayerEndChanRequest, grpc.ServerStreamingServer[StreamPlayerEndChanReply]) error {
...
func (UnimplementedStreamDServer) SubscribeToChatMessages(*SubscribeToChatMessagesRequest, grpc.ServerStreamingServer[ChatMessage]) error {
...
func (UnimplementedStreamDServer) InjectChatMessage(context.Context, *InjectChatMessageRequest) (*InjectChatMessageReply, error) {
	return nil, status.Error(codes.Unimplemented, "method InjectChatMessage not implemented")
}
func (UnimplementedStreamDServer) ReportChatHandlerActivity(context.Context, *ReportChatHandlerActivityRequest) (*ReportChatHandlerActivityReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportChatHandlerActivity not implemented")
}
func (UnimplementedStreamDServer) ReportTranslatorActivity(context.Context, *ReportTranslatorActivityRequest) (*ReportTranslatorActivityReply, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportTranslatorActivity not implemented")
}
...
func (UnimplementedStreamDServer) TranslatorStats(context.Context, *TranslatorStatsRequest) (*TranslatorStatsReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorStats not implemented")
}
func (UnimplementedStreamDServer) TranslatorReload(context.Context, *TranslatorReloadRequest) (*TranslatorReloadReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorReload not implemented")
}
func (UnimplementedStreamDServer) TranslatorEnable(context.Context, *TranslatorEnableRequest) (*TranslatorEnableReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorEnable not implemented")
}
func (UnimplementedStreamDServer) TranslatorDisable(context.Context, *TranslatorDisableRequest) (*TranslatorDisableReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorDisable not implemented")
}
func (UnimplementedStreamDServer) TranslatorRestart(context.Context, *TranslatorRestartRequest) (*TranslatorRestartReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorRestart not implemented")
}
func (UnimplementedStreamDServer) TranslatorClearHistory(context.Context, *TranslatorClearHistoryRequest) (*TranslatorClearHistoryReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorClearHistory not implemented")
}
func (UnimplementedStreamDServer) TranslatorTranslate(context.Context, *TranslatorTranslateRequest) (*TranslatorTranslateReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorTranslate not implemented")
}
func (UnimplementedStreamDServer) TranslatorTranslateViaProvider(context.Context, *TranslatorTranslateViaProviderRequest) (*TranslatorTranslateViaProviderReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorTranslateViaProvider not implemented")
}
func (UnimplementedStreamDServer) TranslatorCompileTranslate(context.Context, *TranslatorCompileTranslateRequest) (*TranslatorCompileTranslateReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorCompileTranslate not implemented")
}
func (UnimplementedStreamDServer) TranslatorCompileLanguageDetect(context.Context, *TranslatorCompileLanguageDetectRequest) (*TranslatorCompileLanguageDetectReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorCompileLanguageDetect not implemented")
}
func (UnimplementedStreamDServer) TranslatorQueueList(context.Context, *TranslatorQueueListRequest) (*TranslatorQueueListReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorQueueList not implemented")
}
func (UnimplementedStreamDServer) TranslatorQueueFlush(context.Context, *TranslatorQueueFlushRequest) (*TranslatorQueueFlushReply, error) {
	return nil, status.Error(codes.Unimplemented, "method TranslatorQueueFlush not implemented")
}
...
func RegisterStreamDServer(s grpc.ServiceRegistrar, srv StreamDServer) {
	// If the following call panics, it indicates UnimplementedStreamDServer was
...
func _StreamD_SubscribeToConfigChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToConfigChanges(m, &grpc.GenericServerStream[SubscribeToConfigChangesRequest, ConfigChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToConfigChangesServer = grpc.ServerStreamingServer[ConfigChange]
...
func _StreamD_SubscribeToStreamsChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToStreamsChanges(m, &grpc.GenericServerStream[SubscribeToStreamsChangesRequest, StreamsChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamsChangesServer = grpc.ServerStreamingServer[StreamsChange]
...
func _StreamD_ListStreamProfiles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListStreamProfilesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).ListStreamProfiles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_ListStreamProfiles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).ListStreamProfiles(ctx, req.(*ListStreamProfilesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StreamD_SubscribeToVariable_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToVariable(m, &grpc.GenericServerStream[SubscribeToVariableRequest, VariableChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToVariableServer = grpc.ServerStreamingServer[VariableChange]
...
func _StreamD_SubscribeToOAuthRequests_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToOAuthRequests(m, &grpc.GenericServerStream[SubscribeToOAuthRequestsRequest, OAuthRequest]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToOAuthRequestsServer = grpc.ServerStreamingServer[OAuthRequest]
...
func _StreamD_SubscribeToStreamServersChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToStreamServersChanges(m, &grpc.GenericServerStream[SubscribeToStreamServersChangesRequest, StreamServersChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamServersChangesServer = grpc.ServerStreamingServer[StreamServersChange]
...
func _StreamD_SubscribeToStreamDestinationsChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToStreamDestinationsChanges(m, &grpc.GenericServerStream[SubscribeToStreamDestinationsChangesRequest, StreamDestinationsChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamDestinationsChangesServer = grpc.ServerStreamingServer[StreamDestinationsChange]
...
func _StreamD_SubscribeToIncomingStreamsChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToIncomingStreamsChanges(m, &grpc.GenericServerStream[SubscribeToIncomingStreamsChangesRequest, IncomingStreamsChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToIncomingStreamsChangesServer = grpc.ServerStreamingServer[IncomingStreamsChange]
...
func _StreamD_SubscribeToStreamForwardsChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToStreamForwardsChanges(m, &grpc.GenericServerStream[SubscribeToStreamForwardsChangesRequest, StreamForwardsChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamForwardsChangesServer = grpc.ServerStreamingServer[StreamForwardsChange]
...
func _StreamD_WaitForStreamPublisher_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).WaitForStreamPublisher(m, &grpc.GenericServerStream[WaitForStreamPublisherRequest, StreamPublisher]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_WaitForStreamPublisherServer = grpc.ServerStreamingServer[StreamPublisher]
...
func _StreamD_SubscribeToStreamPlayersChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToStreamPlayersChanges(m, &grpc.GenericServerStream[SubscribeToStreamPlayersChangesRequest, StreamPlayersChange]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToStreamPlayersChangesServer = grpc.ServerStreamingServer[StreamPlayersChange]
...
func _StreamD_StreamPlayerEndChan_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).StreamPlayerEndChan(m, &grpc.GenericServerStream[StreamPlayerEndChanRequest, StreamPlayerEndChanReply]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_StreamPlayerEndChanServer = grpc.ServerStreamingServer[StreamPlayerEndChanReply]
...
func _StreamD_SubscribeToChatMessages_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StreamDServer).SubscribeToChatMessages(m, &grpc.GenericServerStream[SubscribeToChatMessagesRequest, ChatMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type StreamD_SubscribeToChatMessagesServer = grpc.ServerStreamingServer[ChatMessage]
...
func _StreamD_InjectChatMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InjectChatMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).InjectChatMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_InjectChatMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).InjectChatMessage(ctx, req.(*InjectChatMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_ReportChatHandlerActivity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportChatHandlerActivityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).ReportChatHandlerActivity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_ReportChatHandlerActivity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).ReportChatHandlerActivity(ctx, req.(*ReportChatHandlerActivityRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_ReportTranslatorActivity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportTranslatorActivityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).ReportTranslatorActivity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_ReportTranslatorActivity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).ReportTranslatorActivity(ctx, req.(*ReportTranslatorActivityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StreamD_TranslatorStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorStatsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorStats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorStats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorStats(ctx, req.(*TranslatorStatsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorReload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorReloadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorReload(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorReload_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorReload(ctx, req.(*TranslatorReloadRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorEnable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorEnableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorEnable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorEnable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorEnable(ctx, req.(*TranslatorEnableRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorDisable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorDisableRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorDisable(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorDisable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorDisable(ctx, req.(*TranslatorDisableRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorRestart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorRestartRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorRestart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorRestart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorRestart(ctx, req.(*TranslatorRestartRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorClearHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorClearHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorClearHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorClearHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorClearHistory(ctx, req.(*TranslatorClearHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorTranslate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorTranslateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorTranslate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorTranslate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorTranslate(ctx, req.(*TranslatorTranslateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorTranslateViaProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorTranslateViaProviderRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorTranslateViaProvider(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorTranslateViaProvider_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorTranslateViaProvider(ctx, req.(*TranslatorTranslateViaProviderRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorCompileTranslate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorCompileTranslateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorCompileTranslate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorCompileTranslate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorCompileTranslate(ctx, req.(*TranslatorCompileTranslateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorCompileLanguageDetect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorCompileLanguageDetectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorCompileLanguageDetect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorCompileLanguageDetect_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorCompileLanguageDetect(ctx, req.(*TranslatorCompileLanguageDetectRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorQueueList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorQueueListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorQueueList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorQueueList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorQueueList(ctx, req.(*TranslatorQueueListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StreamD_TranslatorQueueFlush_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TranslatorQueueFlushRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StreamDServer).TranslatorQueueFlush(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StreamD_TranslatorQueueFlush_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StreamDServer).TranslatorQueueFlush(ctx, req.(*TranslatorQueueFlushRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StreamD_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListStreamProfiles",
			Handler:    _StreamD_ListStreamProfiles_Handler,
		},
		{
		...
		{
			MethodName: "InjectChatMessage",
			Handler:    _StreamD_InjectChatMessage_Handler,
		},
		{
			MethodName: "ReportChatHandlerActivity",
			Handler:    _StreamD_ReportChatHandlerActivity_Handler,
		},
		{
			MethodName: "ReportTranslatorActivity",
			Handler:    _StreamD_ReportTranslatorActivity_Handler,
		},
		{
		...
		{
			MethodName: "TranslatorStats",
			Handler:    _StreamD_TranslatorStats_Handler,
		},
		{
			MethodName: "TranslatorReload",
			Handler:    _StreamD_TranslatorReload_Handler,
		},
		{
			MethodName: "TranslatorEnable",
			Handler:    _StreamD_TranslatorEnable_Handler,
		},
		{
			MethodName: "TranslatorDisable",
			Handler:    _StreamD_TranslatorDisable_Handler,
		},
		{
			MethodName: "TranslatorRestart",
			Handler:    _StreamD_TranslatorRestart_Handler,
		},
		{
			MethodName: "TranslatorClearHistory",
			Handler:    _StreamD_TranslatorClearHistory_Handler,
		},
		{
			MethodName: "TranslatorTranslate",
			Handler:    _StreamD_TranslatorTranslate_Handler,
		},
		{
			MethodName: "TranslatorTranslateViaProvider",
			Handler:    _StreamD_TranslatorTranslateViaProvider_Handler,
		},
		{
			MethodName: "TranslatorCompileTranslate",
			Handler:    _StreamD_TranslatorCompileTranslate_Handler,
		},
		{
			MethodName: "TranslatorCompileLanguageDetect",
			Handler:    _StreamD_TranslatorCompileLanguageDetect_Handler,
		},
		{
			MethodName: "TranslatorQueueList",
			Handler:    _StreamD_TranslatorQueueList_Handler,
		},
		{
			MethodName: "TranslatorQueueFlush",
			Handler:    _StreamD_TranslatorQueueFlush_Handler,
		},
	},
