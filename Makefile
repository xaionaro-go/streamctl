...
3rdparty/amd64/windows/ready:
	...
	sh -c 'cd 3rdparty/amd64/windows/mpv && wget https://github.com/shinchiro/mpv-winbuild-cmake/releases/download/20250525/mpv-x86_64-20250525-git-1d1535f.7z && 7z -y x mpv-x86_64-20250525-git-1d1535f.7z && rm -f mpv-x86_64-20250525-git-1d1535f.7z'
